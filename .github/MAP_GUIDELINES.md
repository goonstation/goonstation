...
- `/obj/cablespawner exists`, it autoconnects to neighbouring cables and cablespawners. It has reinforced and coloured variants and if you want to make it create nodes for terminal connections and whatnot, you can varedit `var/override_centre_connection`. When needing something pretty and/or handcrafted probably use regular cables placed manually, cablespawners are for convenience in places where you don't care.
