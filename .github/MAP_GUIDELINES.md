...
- **Place Directions!** They make new maps a lot easier to navigate, not just for players, but for you as well during the process. Use the wall signs like cogmap 1, for instance. Don't use the nadir/donut/kondaru floor decals though, they're very controversial. The amount of directions you should place should be proportional to map size, hallway size, and mazelikeness.
