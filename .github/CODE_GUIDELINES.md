...
There exists a project to provide an incredibly more advanced real-time profiler for DM, named [goon-byond-tracy](https://github.com/goonstation/goon-byond-tracy), capable of providing incredible resolution.
...
* The second can be trivially compiled from the C source above, downloaded from the releases, or downloaded directly [here](https://goonhub.com/r/goontracy). The .dll just goes in the root folder of the game.
