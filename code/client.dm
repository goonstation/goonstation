...
/client/New()
	...
	SPAWN(3 SECONDS)
		...
		if (src.byond_version >= 516)
			if (alert(src, "Please DOWNGRADE BYOND to version 515.1633! Many things will break otherwise. Would you like to be taken to the download page?", "ALERT", "Yes", "No") == "Yes")
				src << link("http://www.byond.com/download/")
#endif
