...
/atom
	var
		...
		obj/overlay/simple_light/simple_light = null
...
/atom
	var
		list/medium_light_rgbas = null
		list/obj/overlay/simple_light/medium/medium_lights
		static/list/medium_light_dirs = list(0, NORTH, SOUTH, EAST, WEST)
	...
	proc/add_medium_light(var/id, var/list/rgba)
	...
	proc/remove_medium_light(var/id)
		if (!medium_light_rgbas)
			return
	...
	proc/update_medium_light_color()
		var/avg_r = 0
		var/avg_g = 0
		var/avg_b = 0
		var/sum_a = 0
	...
	proc/hide_medium_light()
		for(var/obj/overlay/simple_light/medium/light in src.medium_lights)
			light.invisibility = 101

	proc/destroy_medium_light()
	...
	proc/update_medium_light_visibility()
...
/atom/proc/add_sm_light(id, list/rgba, medium=null)
	// TODO decide cleverly whether medium or simple if medium == null
	if(medium)
