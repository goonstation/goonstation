...
/datum/component/minimap_marker/Initialize(minimaps_to_display_on, marker_icon_state = "pin", marker_icon = 'icons/obj/minimap/minimap_markers.dmi', name)
	. = ..()
...
/datum/component/minimap_marker/proc/create_minimap_markers()
	...
	for_by_tcl(minimap, /datum/minimap)
		if (minimap.minimap_type & minimaps_to_display_on)
			minimap.create_minimap_marker(parent, marker_icon, marker_icon_state, name)
