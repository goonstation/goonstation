/datum/component/tranfer_on_attack
	var/trans_amt = 5

/datum/component/tranfer_on_attack/Initialize(var/trans_amt)
...
/datum/component/tranfer_on_attack/proc/stab_transfer(var/obj/item/I, var/mob/M, var/mob/user, var/damage, var/armor_mod)
