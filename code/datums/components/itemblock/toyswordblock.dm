...
TYPEINFO(/datum/component/itemblock/toyswordblock)
...
/datum/component/itemblock/toyswordblock
...
/datum/component/itemblock/toyswordblock/Initialize(var/can_block_proc, var/block_color_proc)
	. = ..()
	can_block_check = can_block_proc
	get_color_proc = block_color_proc

/datum/component/itemblock/toyswordblock/proc/do_reflect_animation(mob/user)
	var/effect_color
...
/datum/component/itemblock/toyswordblock/on_block_begin(obj/item/I, var/obj/item/grab/block/B)
...
/datum/component/itemblock/toyswordblock/on_block_end(obj/item/I, var/obj/item/grab/block/B)
	. = ..()//always always
