...
/datum/component/barber/proc/do_shave(var/obj/item/thing, mob/living/carbon/human/M as mob, mob/living/carbon/human/user as mob)
	...
	if(iswizard(M))
		...
		M.bioHolder.mobAppearance.customizations[2].style = new /datum/customization_style/none
...
/datum/component/barber/ui_act(var/action, var/params)
	...
	switch(action)
		...
		if("do_hair")
			...
			if(istype(barbee.bioHolder.mobAppearance.customizations[1].style, /datum/customization_style/none) && \
			istype(barbee.bioHolder.mobAppearance.customizations[2].style, /datum/customization_style/none) && \
			istype(barbee.bioHolder.mobAppearance.customizations[3].style, /datum/customization_style/none))
	...
	onEnd()
		...
		switch (degree_of_success)
			if (0) // cut their head up and hair off
				...
				M.bioHolder.mobAppearance.customizations[1].style = new /datum/customization_style/none
				M.bioHolder.mobAppearance.customizations[2].style = new /datum/customization_style/none
				M.bioHolder.mobAppearance.customizations[3].style = new /datum/customization_style/none
