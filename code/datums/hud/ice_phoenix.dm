/datum/hud/critter/ice_phoenix
	New()
		..()
		var/atom/movable/screen/map = src.create_screen("map", "Show Map", 'icons/mob/critter_ui.dmi', "template", "SOUTH,EAST", HUD_LAYER_1)
		map.desc = "Show a map of the space Z level."

		var/atom/movable/screen/hud/phoenix_return_to_station/return_to_stat = src.create_screen("return_to_station", "Return to Station Z Level", 'icons/mob/critter_ui.dmi', \
			"template", "SOUTH+1,EAST", HUD_LAYER_1)
