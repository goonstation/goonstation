/datum/hud/wraith/poltergeist
	...
	New(M)
		...
		well_dist = create_screen("well_dist","Well Distance", 'icons/mob/wraith_ui.dmi', "poltergeist_cd", "EAST, NORTH-2", HUD_LAYER, tooltipTheme = "well_dist")
		leave_master = create_screen("leave_master","Leave Master", 'icons/mob/wraith_ui.dmi', "make_poltergeist", "EAST, NORTH-3", HUD_LAYER, tooltipTheme = "well_dist")
