...
/datum/targetable/dancing
	...
	castcheck(atom/target)
		...
		if(AH.lead.getStatusDuration("weakened") || AH.lead.getStatusDuration("stunned") || AH.lead.getStatusDuration("unconscious") || AH.lead.lying)
			. = FALSE
		if(AH.follow && (AH.follow.getStatusDuration("weakened") || AH.follow.getStatusDuration("stunned") || AH.follow.getStatusDuration("unconscious") || AH.follow.lying))
			. = FALSE
		else
