...
/datum/targetable/critter/vomit_ore
	...
	cast(atom/T)
		...
		switch(pickgem)
			if(1) created = /obj/item/material/gemstone
			if(2) created = /obj/item/material/uqill
			if(3) created = /obj/item/material/fibrilith
		var/obj/item/material/ammo = new created(C.loc)
