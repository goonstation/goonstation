...
/datum/targetable/wrestler
	...
	castcheck()
		...
		if (fake && !(istype(get_turf(M), /turf/simulated/floor/specialroom/gym) || istype(get_turf(M), /turf/unsimulated/floor/specialroom/gym))) //DO NOT MERGE until unsimmed version is handled too
