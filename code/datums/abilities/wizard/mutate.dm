/datum/targetable/spell/mutate
	...
	cast()
		...
		APPLY_ATOM_PROPERTY(holder.owner, PROP_PASSIVE_WRESTLE, "empower")
		APPLY_ATOM_PROPERTY(holder.owner, PROP_STAMINA_REGEN_BONUS, "empower", 5)
		var/SPtime = 150
		...
		SPAWN(SPtime)
			if (!QDELETED(holder.owner))
				...
				REMOVE_ATOM_PROPERTY(holder.owner, PROP_PASSIVE_WRESTLE, "empower")
				REMOVE_ATOM_PROPERTY(holder.owner, PROP_STAMINA_REGEN_BONUS, "empower")
