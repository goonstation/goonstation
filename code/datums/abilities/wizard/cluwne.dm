...
/datum/action/bar/icon/cluwne_spell
	...
	onEnd()
		...
		if (T.job != "Cluwne")
			...
			playsound(T, pick("sound/voice/cluwnelaugh1.ogg","sound/voice/cluwnelaugh2.ogg","sound/voice/cluwnelaugh3.ogg"), 35, 0, 0, clamp(1.4, 0.7, 1.0 + (30 - T.bioHolder.age)/50))
