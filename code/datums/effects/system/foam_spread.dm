/datum/effects/system/foam_spread
	...
	var/temperature = T0C
	var/list/banned_reagents = list("nitroglycerin", "smokepowder", "propellant", "thalmerite", "fluorosurfactant", "salt", "poor_concrete", "okay_concrete", "good_concrete", "perfect_concrete")
