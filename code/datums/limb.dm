...
/datum/limb/bear
	...
	harm(mob/target, var/mob/living/user, var/no_logs = 0)
		...
		msgs.base_attack_message = SPAN_ALERT("<b>[user] [action]s [target] with their [src.holder]!</b>")
...
/datum/limb/hot //because
	...
	harm(mob/target, var/mob/living/user, var/no_logs = 0)
		...
		msgs.base_attack_message = SPAN_ALERT("<b>[user] melts [target] with their clutch!</b>")
...
/datum/limb/leg_hand
	...
	harm(mob/target, var/mob/living/user, var/no_logs = 0)
		...
		msgs.base_attack_message = SPAN_ALERT("<b>[user] [action]s [target]!</b>")
...
/datum/limb/small_critter
	...
	harm(mob/target, var/mob/living/user, var/no_logs = 0)
		...
		user.attack_effects(target, user.zone_sel?.selecting)
		msgs.base_attack_message = src.custom_msg ? src.custom_msg : SPAN_ALERT("<b>[user] [pick(src.actions)] [target]!</b>")
		if (src.sound_attack)
			msgs.played_sound = src.sound_attack
...
/datum/limb/sword
	...
	harm(mob/target, var/mob/living/user, var/no_logs = 0)
		...
		msgs.base_attack_message = SPAN_ALERT("<b>[user] [action]s [target] with a blade!</b>")
