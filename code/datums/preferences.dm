...
<div style="float: right;">
	...
	<table class='jobtable'>
		...
		if (jobban_isbanned(user, "Syndicate"))
			...
			<a href="byond://?src=\ref[src];preferences=1;b_energy_vampire=1" class="[src.be_energy_vampire ? "yup" : "nope"]">[crap_checkbox(src.be_energy_vampire)] Energy Vampire</a>
...
//pod wars only special jobs
	...
	proc/process_link(mob/user, list/link_tags)
		...
		if (link_tags["b_energy_vampire"])
			src.be_energy_vampire = !( src.be_energy_vampire)
			src.SetChoices(user)
			return
