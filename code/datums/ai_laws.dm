...
/* Initializers */
//
INIT_TYPE(/datum/ai_laws/asimov)
	..()
...
INIT_TYPE(/datum/ai_laws/corporate)
	..()
...
INIT_TYPE(/datum/ai_laws/malfunction)
	..()
	src.add_default_law("ERROR ER0RR $R0RRO$!R41.%%!!(%$^^__+")

INIT_TYPE(/datum/ai_laws/syndicate_override)
	..()
