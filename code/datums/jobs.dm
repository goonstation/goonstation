/datum/job/
	...
	var/list/slot_head = null
	var/list/slot_mask = null
	var/list/slot_ears = list(/obj/item/device/radio/headset) // cogwerks experiment - removing default headsets
	var/list/slot_eyes = null
	var/list/slot_suit = null
	var/list/slot_jump = null
	var/slot_card = /obj/item/card/id
	var/spawn_id = 1 // will override slot_card if 1
	var/list/slot_glov = null
	var/list/slot_foot = null
	var/list/slot_back = list(/obj/item/storage/backpack)
	var/list/slot_belt = list(/obj/item/device/pda2)
	var/list/slot_poc1 = null // Pay attention to size. Not everything is small enough to fit in jumpsuit pockets.
	var/list/slot_poc2 = null
	var/list/slot_lhan = null
	var/list/slot_rhan = null
