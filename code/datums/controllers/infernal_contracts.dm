var/datum/infernal_contracts_controller/contract_controls

ABSTRACT_TYPE(/datum/infernal_contracts_controller)
...
/datum/infernal_contracts_controller/proc/souladjust(var/total_souls as num, var/mob/badguy as mob)
	if (total_souls <= 0)
		return 0
...
/datum/infernal_contracts_controller/proc/spawncontract(var/mob/badguy as mob, var/strong = 0, var/pen = 0)
