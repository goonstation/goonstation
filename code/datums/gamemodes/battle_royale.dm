...
proc/hide_weapons_everywhere(var/total_battlers = 1)
	...
	for(var/datum/syndicate_buylist/D in syndi_buylist_cache)
		if(D.item)
			if(!(D.can_buy & UPLINK_BATTLEROYALE))
				continue
			message_admins("Can buy? [D.can_buy] adding [D]")
	...
	chest_supplies.Add(/obj/item/gun/kinetic/smg)
	chest_supplies.Add(/obj/item/gun/kinetic/spes)
	chest_supplies.Add(/obj/item/gun/kinetic/pistol)
	chest_supplies.Add(/obj/item/gun/kinetic/clock_188)
	chest_supplies.Add(/obj/item/gun/kinetic/revolver)
	...
	chest_supplies.Add(/obj/item/gun/kinetic/grenade_launcher)
	chest_supplies.Add(/obj/item/gun/kinetic/gyrojet)
	...
	chest_supplies.Add(/obj/item/gun/energy/blaster_pistol)
	...
	chest_supplies.Add(/obj/item/kitchen/utensil/knife/cleaver)
