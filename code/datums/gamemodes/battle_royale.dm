...
proc/hide_weapons_everywhere(var/total_battlers = 1)
	...
	weapon_supplies.Add(/obj/item/firearm/kinetic/smg)
	weapon_supplies.Add(/obj/item/firearm/kinetic/spes/engineer)
	weapon_supplies.Add(/obj/item/firearm/kinetic/pistol)
	weapon_supplies.Add(/obj/item/firearm/kinetic/silenced_22)
	weapon_supplies.Add(/obj/item/firearm/kinetic/clock_188)
	weapon_supplies.Add(/obj/item/firearm/kinetic/revolver)
	weapon_supplies.Add(/obj/item/firearm/kinetic/detectiverevolver)
	weapon_supplies.Add(/obj/item/firearm/kinetic/single_action/colt_saa)
	weapon_supplies.Add(/obj/item/firearm/kinetic/pumpweapon/riotgun)
	weapon_supplies.Add(/obj/item/firearm/kinetic/airzooka)
	weapon_supplies.Add(/obj/item/firearm/kinetic/grenade_launcher)
	weapon_supplies.Add(/obj/item/firearm/kinetic/gyrojet)
	weapon_supplies.Add(/obj/item/firearm/kinetic/makarov)
	weapon_supplies.Add(/obj/item/firearm/kinetic/webley)
	weapon_supplies.Add(/obj/item/firearm/kinetic/american180)
	weapon_supplies.Add(/obj/item/firearm/kinetic/draco)
	weapon_supplies.Add(/obj/item/firearm/kinetic/greasegun)
	weapon_supplies.Add(/obj/item/firearm/kinetic/uzi)
	weapon_supplies.Add(/obj/item/firearm/kinetic/striker)
	weapon_supplies.Add(/obj/item/firearm/kinetic/pumpweapon/ks23)
	weapon_supplies.Add(/obj/item/firearm/kinetic/m16)
	weapon_supplies.Add(/obj/item/firearm/energy/lasergat)
	weapon_supplies.Add(/obj/item/storage/backpack/satchel/flintlock_pistol_satchel)
	weapon_supplies.Add(/obj/item/firearm/energy/lasershotgun)
	weapon_supplies.Add(/obj/item/firearm/energy/phaser_small)
	weapon_supplies.Add(/obj/item/firearm/energy/phaser_huge)
	weapon_supplies.Add(/obj/item/firearm/energy/phaser_gun)
	weapon_supplies.Add(/obj/item/firearm/energy/alastor)
	weapon_supplies.Add(/obj/item/firearm/energy/heavyion)
	weapon_supplies.Add(/obj/item/firearm/energy/resonator)
	weapon_supplies.Add(/obj/item/bat)
	weapon_supplies.Add(/obj/item/ratstick)
	weapon_supplies.Add(/obj/item/saw)
	weapon_supplies.Add(/obj/item/melee/baton/windup)
	weapon_supplies.Add(/obj/item/melee/sword/discount)
	weapon_supplies.Add(/obj/item/nunchucks)
	weapon_supplies.Add(/obj/item/quarterstaff)
	weapon_supplies.Add(/obj/item/fireaxe)
	weapon_supplies.Add(/obj/item/melee/swords/fragile_sword)
	weapon_supplies.Add(/obj/item/melee/swords_sheaths/katana/reverse)
	weapon_supplies.Add(/obj/item/melee/swords_sheaths/captain)
	weapon_supplies.Add(/obj/item/melee/swords_sheaths/nukeop)
	weapon_supplies.Add(/obj/item/melee/sword/discount)
