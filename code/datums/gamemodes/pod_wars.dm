...
proc/setup_pw_crate_lists()
	...
	pw_rewards_tier3 = list(/obj/item/firearm/energy/crossbow = 1, /obj/item/device/chameleon = 1,
		/obj/item/firearm/flamethrower/backtank/napalm = 3, /obj/item/ammo/power_cell/self_charging/pod_wars_high = 2,
