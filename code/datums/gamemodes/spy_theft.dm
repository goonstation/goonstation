...
/datum/game_mode/spy_theft/proc/build_bounty_list()
	...
	if (!station_bounties.len)
		...
		// Misc items - Valuable
		station_bounties += list(list(/obj/item/stamp/rd, 2))
		station_bounties += list(list(/obj/item/stamp/md, 2))
		station_bounties += list(list(/obj/item/stamp/ce, 2))
		station_bounties += list(list(/obj/item/stamp/hop, 2))
		...
		station_bounties += list(list(/obj/item/stamp/cap, 3))
		// Clothing
		...
		//
		station_bounties += list(list(/obj/item/remote/porter/port_a_medbay, 2))
		station_bounties += list(list(/obj/item/remote/porter/port_a_nanomed, 2))
		station_bounties += list(list(/obj/item/remote/porter/port_a_sci, 2))
	...
	if (!big_station_bounties.len)
		// All machinery should be available on station
		// Do not include belts/launcher/loader or unique irreplacable machinery
		...
		big_station_bounties += list(list(/obj/machinery/photocopier, 1))
		big_station_bounties += list(list(/obj/machinery/microwave, 1))
		big_station_bounties += list(list(/obj/storage/cart/hotdog , 1))
		big_station_bounties += list(list(/obj/submachine/slot_machine, 1))
		big_station_bounties += list(list(/obj/submachine/ice_cream_dispenser, 1))
		big_station_bounties += list(list(, 1))
		// Valuable
		big_station_bounties += list(list(/obj/reagent_dispensers, 2))
		big_station_bounties += list(list(/obj/machinery/shipalert, 2))
