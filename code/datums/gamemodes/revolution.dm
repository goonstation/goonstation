...
/datum/game_mode/revolution
	...
	var/const/TrackerTime_min = 27 MINUTES //upper bound on time before intercept arrives (in tenths of seconds)
	var/const/TrackerTime_max = 30 MINUTES //lower bound on time before intercept arrives (in tenths of seconds)
...
/datum/game_mode/revolution/proc/send_tracker()
	command_alert("Foreign mutiny located [station_or_ship()]wide, a program to track revolutionary leaders has been sent to all crew member pda's.", "Central Command Security Alert", 'sound/misc/announcement_1.ogg', alert_origin = "Watchful Eye Sensor Array Update")
	command_alert("Relevant biometric signatures of Command has been identified. To aid with the ongoing revolution, station command can now be tracked through the transmitted pda program.", "Unregistered Signal Insertion", alert_origin = "Egeria Providence Array Broadcast")
...
/datum/game_mode/revolution/proc/start_gibwave()
	...
	command_alert("Revolutionary head signatures have been confirmed. Please stand by for hostile employee termination.", "Emergency Riot Update")
