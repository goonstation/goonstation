...
/datum/game_mode/revolution/process()
	if(TIME >= round_limit) // this has got to end soon
	...
	if(TIME >= round_limit + 10 MINUTES) // 10 minutes to clean up shop
	...
	if(TIME >= round_limit + 15 MINUTES) // 5 minutes until everyone dies
