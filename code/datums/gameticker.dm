...
/datum/controller/gameticker/proc/setup()
	...
	switch(master_mode)
		...
		if("intrigue") src.mode = config.pick_mode(pick(prob(300);"mixed_rp", prob(150); "traitor","changeling","vampire", prob(50); "conspiracy", "spy_theft","arcfiend", prob(50); "extended"))
