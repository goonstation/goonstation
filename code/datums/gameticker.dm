...
/datum/controller/gameticker/proc/setup()
	...
	switch(master_mode)
		...
		if("pod_war") src.mode = config.pick_mode("pod_war")
...
/datum/controller/gameticker/proc/declare_completion()
	...
	if (istype(mode, /datum/game_mode/blob) || istype(mode, /datum/game_mode/nuclear) || istype(mode, /datum/game_mode/revolution) || istype(mode, /datum/game_mode/pod_war))
		escape_possible = 0
