...
/datum/trait/eyepatch
	name = "Monophthalmic"
	icon_state = "eyepatch"
	desc = "Start the shift with an eyepatch. You hate not being able to see through it, but your too scared to just make a hole in it with a screwdriver in order to fix that issue. Its still probably valuable you know!"
	id = "eyepatch"
	points = -1 
	category = list("trinkets")
