...
/obj/deployable_turret/syndicate
	...
	is_friend(var/mob/living/C)
		return istype(C.get_id(), /obj/item/card/id/syndicate) || istype(C, /mob/living/critter/robotic/gunbot/syndicate) || istype(C, /mob/living/critter/robotic/sawfly) //dumb lazy
