...
/obj/item/assembly/detonator/proc/detonate()
	...
	logTheThing("bombing", null, "A canister bomb detonates at [epicenter.loc.name] ([log_loc(epicenter)])")
...
/obj/item/assembly/detonator/proc/failsafe_engage()
	...
	logTheThing("bombing", usr, "primes a canister bomb at [get_area(src.master)] ([log_loc(src.master)])")
