	...
	surgery(var/obj/item/tool)
		...
		switch(remove_stage)
			if(0)
				...
				logTheThing("combat", tool.the_mob, "staples [constructTarget(holder,"combat")]'s [src.name] back on.")
				logTheThing("diary", tool.the_mob, "staples [constructTarget(holder,"diary")]'s [src.name] back on.", "combat")
			if(1)
			...
			if(3)
				...
				logTheThing("combat", tool.the_mob, "removes [constructTarget(holder,"combat")]'s [src.name].")
				logTheThing("diary", tool.the_mob, "removes [constructTarget(holder,"diary")]'s [src.name]", "combat")
				src.remove(0)
