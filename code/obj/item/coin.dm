...
/obj/item/coin/proc/antflip()
	if(prob(1))
		src.visible_message(SPAN_NOTICE("The coin lands on its side. Antstounding."))
	else if(prob(50))
		src.visible_message(SPAN_NOTICE("The coin comes up Ants (heads)."))
	else
		src.visible_message(SPAN_NOTICE("The coin comes up Eggs (tails)."))
	return
