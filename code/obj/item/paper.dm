...
<li>Circulator efficiency will suffer if the pressure of the outlet exceeds the inlet*. The circulator is equipped with a blower to help overcome that pressure differential. Power required is proportional to the pressure differential to overcome. This issue may also be mitigated by cycling gas from outlet near via auxilary ports or draining line pressure depending on loop configuration.<BR>
<b>*Failure to provide sufficient pressure will inhibit energy production until the problem can be rectified. Ensure ample power is provided by SMES system.</b><BR>
...
<b>*Failure to provide ample lubricant may void your engine warranty but is unlikely to cause fire, explosion or death.</b><BR>
