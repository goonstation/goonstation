...
/obj/item/paper/ui_data(mob/user)
	...
	var/stamp_assets = list(
		"stamp-sprite-clown" = "stamp-clown.png",
		"stamp-sprite-deny" = "stamp-deny.png",
		"stamp-sprite-ok" = "stamp-ok.png",
		"stamp-sprite-hop" = "stamp-hop.png",
		"stamp-sprite-md" = "stamp-md.png",
		...
		"stamp-sprite-mime" = "stamp-mime.png",
		"stamp-sprite-centcom" = "stamp-centcom.png",
		"stamp-sprite-syndicate" = "stamp-syndicate.png",
		"stamp-sprite-void" = "stamp-void.png",
		"stamp-text-time" =  T,
