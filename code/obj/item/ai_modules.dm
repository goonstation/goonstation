...
/obj/item/aiModule/freeform
	...
	attack_self(var/mob/user)
		input_law_info(user, "Freeform", "Please enter anything you want the AI to do. Anything. Serious.", (lawTarget ? lawTarget : "Make a funny beeping noise over the radio every few minutes"))
		if(src.lawTarget && src.lawTarget != "Make a funny beeping noise over the radio every few minutes")
