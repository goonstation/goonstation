...
/datum/chameleon_gloves_pattern
	...
	boxing
		name = "boxing gloves"
		desc = "Big soft gloves used in professional boxing. Specifically designed to stop your fists from inflicting permanent injuries, so your punches will knock people down without hurting them as much."
