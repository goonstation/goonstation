...
/obj/item/clothing/under/gimmick/yukata/plain
	...
	random
		New()
			...
			wear_state = "yukata_plain[yukata_index]"
			..()
...
/obj/item/clothing/under/gimmick/yukata/floral
	...
	random
		New()
			...
			wear_state = "yukata_floral[yukata_index]"
			..()
