// baseball uniforms. not giving them any special behavior, but if someone else wants to? go nuts - waffle

ABSTRACT_TYPE(/obj/item/clothing/under/baseball)
/obj/item/clothing/under/baseball
	...
	cargo
		name = "baseball uniform"
		icon_state = "item_baseball_cargo"
	...
	off
		name = "baseball uniform"
		icon_state = "item_baseball_off"
		item_state = "baseball_off"
		desc = "A pure monochrome baseball uniform. There's no team logo on it. It seems kind of off..."
