...
/obj/item/clothing/suit/hoodie
	...
	New()
		...
		src.wear_state = "hoodie[src.hcolor ? "-[hcolor]" : null]"
...
/obj/item/clothing/suit/space/captain
	...
	blue
		...
		wear_state = "spacecap-blue"

	red
		icon_state = "spacecap-red"
		item_state = "spacecap-red"
		wear_state = "spacecap-red"
...
/obj/item/clothing/suit/space/syndicate
	...
	commissar_greatcoat
		...
		wear_state = "commissar_greatcoat"
	...
	specialist
		...
		medic
			...
			wear_state = "syndie_specialist-medic"
		...
		engineer
			...
			wear_state = "syndie_specialist-engineer"
			setupProperties()
				..()
				setProperty("radprot", 50)
...
/obj/item/clothing/suit/space/industrial/syndicate
	...
	specialist
		...
		wear_state = "syndie_specialist-heavy"
...
/obj/item/clothing/suit/wintercoat/robotics
	...
	wear_state = "wintercoat-robotics"
...
/obj/item/clothing/suit/wintercoat/genetics
	...
	wear_state = "wintercoat-genetics"
	...
	random
		...
		New()
			...
			if(!style)
				...
				src.wear_state = "torncape_[style]"
	...
	random
		...
		New()
			...
			if(!style)
				...
				src.wear_state = "scarfcape_[style]"
