...
/obj/item/organ/stomach
	...
	icon = 'icons/obj/organs/stomach.dmi'
	icon_state = "stomach"
...
/obj/item/organ/intestines
	...
	icon = 'icons/obj/organs/intestines.dmi'
	icon_state = "intestines"

/obj/item/organ/spleen
	name = "spleen"
	icon = 'icons/obj/organs/spleen.dmi'
	icon_state = "spleen"

/obj/item/organ/pancreas
	name = "pancreas"
	icon = 'icons/obj/organs/pancreas.dmi'
	icon_state = "pancreas"

/obj/item/organ/appendix
	name = "appendix"
	icon = 'icons/obj/organs/appendix.dmi'
	icon_state = "appendix"
