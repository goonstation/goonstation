...
/obj/item/device/pda2
	...
	var/reserved_mailgroups = list("command","security","science","ai","sillicon","medresearch","medbay","cargo","janitor","chaplain","engineer","mining","kitchen","mechanic","botany",MGD_STATIONREPAIR) //Job-specific mailgroups that cannot be joined or left
