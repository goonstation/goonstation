...
/datum/computer/file/pda_program/emergency_alert
	...
	proc/send_alert(var/mailgroupNum=0)
		...
		if(isliving(usr))
			...
			usr.visible_message("<span class='alert'>[usr] presses a red button on the side of their [src.master].</span>", "<span class='notice'>You press the \"Alert\" button on the side of your [src.master].</span>", "<span class='alert'>You see [usr] press a button on the side of their [src.master].</span>")
