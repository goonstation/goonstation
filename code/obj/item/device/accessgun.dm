...
/obj/item/device/accessgun
	...
	var/list/research_access_list = list(access_tox, access_tox_storage, access_research, access_chemistry, access_researchfoyer, access_artlab, access_telesci, access_robotdepot, access_computer_core)
