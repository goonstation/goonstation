...
#undef MODE_PLAYING
	...
	infiltrator_log
		...
		New(newloc)
			...
			audiolog_speakers += "Knocking"
			src.audiolog_messages += "THUNK THUNK"
			audiolog_speakers += "Male #1"
