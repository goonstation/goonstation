...
/obj/item/device/ocular_implanter
	...
	proc/start_replace_eye(var/target, var/mob/living/carbon/human/H)
		...
		SPAWN(1 SECOND)
			...
			SETUP_GENERIC_ACTIONBAR(H, src, 10 SECONDS, TYPE_PROC_REF(/obj/item/device/ocular_implanter, end_replace_eye), list(target, H), src.icon, src.icon_state,"[src] finishes replacing your eye.", null)
