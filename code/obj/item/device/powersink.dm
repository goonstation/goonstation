...
TYPEINFO(/obj/item/device/powersink)
	mats = list(/datum/manufacturing_requirement/metal/dense=20, /datum/manufacturing_requirement/conductive/high=20, /datum/manufacturing_requirement/crystal=10)
