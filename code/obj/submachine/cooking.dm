...
.icon {
	...
	New()
		...
		if (!src.recipes.len)
			...
			src.recipes += new /datum/cookingrecipe/cereal_box(src)
			src.recipes += new /datum/cookingrecipe/cereal_honey(src)
			src.recipes += new /datum/cookingrecipe/cereal_tanhony(src)
			src.recipes += new /datum/cookingrecipe/cereal_roach(src)
			src.recipes += new /datum/cookingrecipe/cereal_syndie(src)
			src.recipes += new /datum/cookingrecipe/cereal_cirrial(src)
