...
table#cooktime a#start {
	...
	//        more complicated one and pissing off the chef by giving something different than what he wanted!
		...
		if (!src.recipes.len)
			...
			src.recipes += new /datum/cookingrecipe/robobuttburger(src)
			src.recipes += new /datum/cookingrecipe/buttburger(src)
			src.recipes += new /datum/cookingrecipe/synthheartburger(src)
			src.recipes += new /datum/cookingrecipe/roboheartburger(src)
			...
			src.recipes += new /datum/cookingrecipe/robobrainburger(src)
