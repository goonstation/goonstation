	...
	//        more complicated one and pissing off the chef by giving something different than what he wanted!
		...
		if (!src.recipes.len)
			...
			*/
			...
			src.recipes += new /datum/cookingrecipe/rainbow_brownie(src)
			src.recipes += new /datum/cookingrecipe/death_brownie(src)
			src.recipes += new /datum/cookingrecipe/life_brownie(src)
			src.recipes += new /datum/cookingrecipe/cannabis_brownie(src)
			src.recipes += new /datum/cookingrecipe/brownie(src)
