...
/datum/artifact/container
	...
	/datum/artifact_trigger/radiation,/datum/artifact_trigger/carbon_touch,/datum/artifact_trigger/silicon_touch, /datum/artifact_trigger/langauge)
	...
	effect_touch(var/obj/O,var/mob/living/user)
		...
		for(var/mob/N in viewers(O, null))
			...
			if(N.client)
				shake_camera(N, 6, 16)
		O.visible_message(SPAN_ALERT("<b>With a blinding light [O] vanishes, leaving its contents behind.</b>"))
