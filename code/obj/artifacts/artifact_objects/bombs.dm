		...
		switch(artitype.name)
			if("wizard") // magical stuff
				material = pick(
					...
					50;/datum/material/metal/soulsteel,
					50;/datum/material/fabric/hauntium,
					50;/datum/material/organic/ectoplasm,
			...
			if("eldritch") // fuck you
				material = pick(
					...
					100;/datum/material/crystal/telecrystal,
					50;/datum/material/crystal/erebite)
			if("martian") // organic stuff
				material = pick(
					...
					20;/datum/material/organic/pizza,
					5;/datum/material/fabric/jean,
			...
			if("ancient") // industrial type stuff
				material = pick(
					...
					50;/datum/material/metal/cerenkite,
					...
					20;/datum/material/metal/neutronium)
			if("precursor") // uh, the rest
				material = pick(
					100;/datum/material/metal/rock,
					100;/datum/material/metal/slag,
					100;/datum/material/crystal/ice,  // no possible way this ends poorly
					15;/datum/material/metal/spacelag,
					15;/datum/material/organic/cardboard,
					15;/datum/material/organic/frozenfart,
					15;/datum/material/metal/negativematter)
