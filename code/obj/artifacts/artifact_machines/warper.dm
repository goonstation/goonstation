...
/datum/artifact/warper
	...
	effect_process(var/obj/O)
		...
		if (teleports == max_teleports)
			...
			var/loc = ((wormholer && src.z == Z_LEVEL_STATION) ? pick(random_floor_turfs) : get_offset_target_turf(T, rand(-teleport_range, teleport_range), rand(-teleport_range, teleport_range)) )
