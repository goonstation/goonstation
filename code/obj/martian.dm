...
/obj/crevice/attack_hand(var/mob/user as mob)
	...
	if(id)
		...
		var/itemtype = pick(/obj/item/strange_candle,/obj/critter/cat,/obj/item/skull,/obj/item/gnomechompski,/obj/item/bat,/obj/critter/meatslinky,/obj/item/paint_can,/obj/item/mine/stun)
