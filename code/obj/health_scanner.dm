...
/obj/health_scanner/floor
	...
	proc/crit_alert(var/mob/living/carbon/human/H)
		...
		new_signal.data = list("command"="text_message", "sender_name"="HEALTH-MAILBOT", "tag" = PDA_MEDICAL_ALERT_TAG, "sender"="00000000", "address_1"="00000000", "group"=MGD_MEDBAY, "message"="CRIT ALERT: [H] in [get_area(src)].")
