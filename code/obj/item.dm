...
/obj/item/proc/equipped(var/mob/user, var/slot)
	...
	if (src.hasProperty("meleeprot_all"))
		APPLY_MOB_PROPERTY(user, PROP_MELEEPROT_BODY, src.type, src.getProperty("meleeprot_all"))
		APPLY_MOB_PROPERTY(user, PROP_MELEEPROT_HEAD, src.type, src.getProperty("meleeprot_all"))
...
/obj/item/proc/unequipped(var/mob/user)
	...
	if (src.hasProperty("meleeprot_all"))
		APPLY_MOB_PROPERTY(user, PROP_MELEEPROT_BODY, src.type)
		APPLY_MOB_PROPERTY(user, PROP_MELEEPROT_HEAD, src.type)
	if (src.hasProperty("rangedprot"))
		REMOVE_MOB_PROPERTY(user, PROP_RANGEDPROT, src.type)
	if (src.hasProperty("radprot"))
		REMOVE_MOB_PROPERTY(user, PROP_RADPROT, src.type)
	if (src.hasProperty("heatprot"))
