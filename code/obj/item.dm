...
/obj/item/mouse_drop(atom/over_object, src_location, over_location, over_control, params) // for clickdragging our item to over_object
	..()
...
/obj/item/disposing()
	...
	if(istype(src.loc, /obj/item/storage))
		SEND_SIGNAL(src.loc, COMSIG_STORAGE_TRANSFER_ITEM, src, get_turf(src)) // remove item from storage and its hud
