/obj/item
	...
	proc/buildTooltipContent()
		...
		if (src.stamina_cost)
			. += "<div><img src='[resource("images/tooltips/stamina.png")]' alt='' class='icon' /><span>Stamina: [src.stamina_damage ? src.stamina_damage : "0"] dmg, [stamina_cost] consumed per attack</span></div>"
