...
/obj/machinery/computer/hologram_comp/proc/show_console(var/mob/user as mob)
	...
	if (src.temp)
		...
		dat = text("<B>Hologram Status:</B><HR><br>Power: <A href='byond://?src=\ref[];power=1'>[]</A><HR><br><B>Hologram Control:</B><BR><br>Color Luminosity: []/220 <A href='byond://?src=\ref[];reset=1'>\[Reset\]</A><BR><br>Lighten: <A href='byond://?src=\ref[];light=1'>1</A> <A href='byond://?src=\ref[];light=10'>10</A><BR><br>Darken: <A href='byond://?src=\ref[];light=-1'>1</A> <A href='byond://?src=\ref[];light=-10'>10</A><BR><br><BR><br>Hair Color: ([],[],[]) <A href='byond://?src=\ref[];h_reset=1'>\[Reset\]</A><BR><br>Red (0-255): <A href='byond://?src=\ref[];h_r=-300'>\[0\]</A> <A href='byond://?src=\ref[];h_r=-10'>-10</A> <A href='byond://?src=\ref[];h_r=-1'>-1</A> [] <A href='byond://?src=\ref[];h_r=1'>1</A> <A href='byond://?src=\ref[];h_r=10'>10</A> <A href='byond://?src=\ref[];h_r=300'>\[255\]</A><BR><br>Green (0-255): <A href='byond://?src=\ref[];h_g=-300'>\[0\]</A> <A href='byond://?src=\ref[];h_g=-10'>-10</A> <A href='byond://?src=\ref[];h_g=-1'>-1</A> [] <A href='byond://?src=\ref[];h_g=1'>1</A> <A href='byond://?src=\ref[];h_g=10'>10</A> <A href='byond://?src=\ref[];h_g=300'>\[255\]</A><BR><br>Blue (0-255): <A href='byond://?src=\ref[];h_b=-300'>\[0\]</A> <A href='byond://?src=\ref[];h_b=-10'>-10</A> <A href='byond://?src=\ref[];h_b=-1'>-1</A> [] <A href='byond://?src=\ref[];h_b=1'>1</A> <A href='byond://?src=\ref[];h_b=10'>10</A> <A href='byond://?src=\ref[];h_b=300'>\[255\]</A><BR>", src, (src.projector.projection ? "On" : "Off"),  -src.lumens + 35, src, src, src, src, src, src.h_r, src.h_g, src.h_b, src, src, src, src, src.h_r, src, src, src, src, src, src, src.h_g, src, src, src, src, src, src, src.h_b, src, src, src)
