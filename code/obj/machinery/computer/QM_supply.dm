...
/datum/cdc_contact_controller
	...
	proc/receive_pathogen_samples(obj/storage/crate/biohazard/cdc/sell_crate)
		...
		pdaSignal.data = list("address_1"="00000000", "command"="text_message", "sender_name"="CARGO-MAILBOT", "tag" = PDA_CARGO_ALERT_TAG, "group"=MGD_CARGO, "sender"="00000000", "message"="Notification: Pathogen sample crate delivered to the CDC.")
