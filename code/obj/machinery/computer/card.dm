/obj/machinery/computer/card
	...
	var/list/engineering_access_list = list(access_construction, access_engineering, access_engineering_storage, access_engineering_power, access_engineering_engine, access_engineering_mechanic, access_engineering_atmos, access_engineering_control)
...
/obj/machinery/computer/card/department/engineering
	...
	engineering_access_list = list(access_construction, access_engineering, access_engineering_storage, access_engineering_power, access_engineering_engine, access_engineering_mechanic, access_engineering_atmos, access_engineering_control)
