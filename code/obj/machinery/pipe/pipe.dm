...
/obj/machinery/circulator/update_icon()
...
/obj/machinery/oneway/pipepump/update_icon()
...
/obj/machinery/inlet/filter/update_icon()
	/*
	if(status & NOPOWER)
...
/obj/machinery/vent/filter/update_icon()
	/*
	if(status & NOPOWER)
