...
/obj/machinery/atmospherics/binary/nuclear_reactor
	...
	setMaterial(var/datum/material/mat1, var/appearance = TRUE, var/setname = TRUE, var/mutable = FALSE, var/use_descriptors = FALSE)
		if(istype(mat1, /datum/material/fabric/jean))
			return
		. = ..()
...
/obj/machinery/atmospherics/binary/nuclear_reactor/prefilled/normal
	New()
		src.component_grid[3][1] = new /obj/item/reactor_component/gas_channel(/datum/material/metal/steel)
		src.component_grid[3][3] = new /obj/item/reactor_component/gas_channel(/datum/material/metal/steel)
		src.component_grid[3][5] = new /obj/item/reactor_component/gas_channel(/datum/material/metal/steel)
		src.component_grid[3][7] = new /obj/item/reactor_component/gas_channel(/datum/material/metal/steel)
		src.component_grid[5][1] = new /obj/item/reactor_component/gas_channel(/datum/material/metal/steel)
		src.component_grid[5][3] = new /obj/item/reactor_component/gas_channel(/datum/material/metal/steel)
		src.component_grid[5][5] = new /obj/item/reactor_component/gas_channel(/datum/material/metal/steel)
		src.component_grid[5][7] = new /obj/item/reactor_component/gas_channel(/datum/material/metal/steel)

		src.component_grid[3][2] = new /obj/item/reactor_component/heat_exchanger(/datum/material/metal/steel)
		src.component_grid[3][4] = new /obj/item/reactor_component/heat_exchanger(/datum/material/metal/steel)
		src.component_grid[3][6] = new /obj/item/reactor_component/heat_exchanger(/datum/material/metal/steel)
		src.component_grid[5][2] = new /obj/item/reactor_component/heat_exchanger(/datum/material/metal/steel)
		src.component_grid[5][4] = new /obj/item/reactor_component/heat_exchanger(/datum/material/metal/steel)
		src.component_grid[5][6] = new /obj/item/reactor_component/heat_exchanger(/datum/material/metal/steel)

		src.component_grid[4][1] = new /obj/item/reactor_component/heat_exchanger(/datum/material/metal/steel)
		src.component_grid[4][7] = new /obj/item/reactor_component/heat_exchanger(/datum/material/metal/steel)

		src.component_grid[4][3] = new /obj/item/reactor_component/control_rod(/datum/material/metal/bohrum)
		src.component_grid[4][5] = new /obj/item/reactor_component/control_rod(/datum/material/metal/bohrum)

		//enable for faster debugging
		if(src._debug_mode)
			src.component_grid[4][2] = new /obj/item/reactor_component/fuel_rod(/datum/material/metal/cerenkite)
			src.component_grid[4][4] = new /obj/item/reactor_component/fuel_rod(/datum/material/metal/cerenkite)
			src.component_grid[4][6] = new /obj/item/reactor_component/fuel_rod(/datum/material/metal/cerenkite)
