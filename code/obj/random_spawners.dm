...
/obj/random_item_spawner/records
	name = "random record spawner"
	min_amt2spawn = 1
	max_amt2spawn = 1
	amt2spawn = 1
	items2spawn = list(/obj/item/record/clown_collection/honk, //I'm sorry
...
/obj/random_item_spawner/gold_bullion
	name = "random gold bullion amount spawner"
	min_amt2spawn = 1
	max_amt2spawn = 1
	amt2spawn = 1
	items2spawn = list(/obj/item/material_piece/gold)

	two_to_four
		min_amt2spawn = 2
		max_amt2spawn = 4

/obj/random_item_spawner/bee_junk
	name = "random bee junk spawner"
	min_amt2spawn = 1
	max_amt2spawn = 1
	amt2spawn = 1
	items2spawn = list(/obj/item/reagent_containers/food/snacks/ingredient/egg/bee,
