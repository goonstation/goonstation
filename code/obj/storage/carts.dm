...
/obj/storage/cart/mechcart/breach
	...
	spawn_contents = list(
		...
		/obj/item/explosive/old_grenade/oxygen{pixel_x=-9; pixel_y=-2} = 1,
		/obj/item/explosive/old_grenade/oxygen{pixel_x=-6; pixel_y=-2} = 1,
		/obj/item/explosive/old_grenade/oxygen{pixel_x=-3; pixel_y=-2} = 1,
