		...
		if (src.active)
			...
			if (src.target_name)
				for(var/obj/item/raw_material/O in orange(1,src))
					...
					PCEL.use(2)
					global.cargo_pad_manager.transport(null, O, src.target_name)
				for(var/obj/item/scrap/S in orange(1,src))
					PCEL.use(2)
					global.cargo_pad_manager.transport(null, S, src.target_name)
				for(var/obj/decal/cleanable/machine_debris/D in orange(1,src))
					PCEL.use(2)
					global.cargo_pad_manager.transport(null, D, src.target_name)
				for(var/obj/decal/cleanable/robot_debris/R in orange(1,src))
					PCEL.use(2)
					global.cargo_pad_manager.transport(null, R, src.target_name)
