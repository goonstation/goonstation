...
TYPEINFO(/obj/item/mining_tool/powered/hedron_beam)
	mats = list(/datum/manufacturing_requirement/metal/dense=15, /datum/manufacturing_requirement/conductive=8, "claretine"=10, /datum/manufacturing_requirement/koshmarite=2 )
