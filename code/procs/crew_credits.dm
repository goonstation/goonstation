...
/chui/window/crew_credits
	...
	GetBody()
		if(crew_creds)
			logTheThing("debug", null, "Zamujasa/CREWCREDITS: [world.timeofday] returning already-generated crew credits")

			return crew_creds

		logTheThing("debug", null, "Zamujasa/CREWCREDITS: [world.timeofday] starting crew credits generation")
		...
		logTheThing("debug", null, "Zamujasa/CREWCREDITS: [world.timeofday] processing all minds...")
		...
		logTheThing("debug", null, "Zamujasa/CREWCREDITS: [world.timeofday] done processing minds. info: A [round_antags.len] C [round_captains.len] S [round_security.len] M [round_medical.len] R [round_science.len] E [round_engineering.len] Cv [round_civilian.len] X [round_other.len]")

		logTheThing("debug", null, "Zamujasa/CREWCREDITS: [world.timeofday] generating crew list")
		...
		logTheThing("debug", null, "Zamujasa/CREWCREDITS: [world.timeofday] done antags")
		...
		logTheThing("debug", null, "Zamujasa/CREWCREDITS: [world.timeofday] done captains")
		...
		logTheThing("debug", null, "Zamujasa/CREWCREDITS: [world.timeofday] done security")
		...
		logTheThing("debug", null, "Zamujasa/CREWCREDITS: [world.timeofday] done medical")
		...
		logTheThing("debug", null, "Zamujasa/CREWCREDITS: [world.timeofday] done science")
		...
		logTheThing("debug", null, "Zamujasa/CREWCREDITS: [world.timeofday] done engineering")
		...
		logTheThing("debug", null, "Zamujasa/CREWCREDITS: [world.timeofday] done civilian")
		...
		logTheThing("debug", null, "Zamujasa/CREWCREDITS: [world.timeofday] done other - all finished")
		return crew_creds
