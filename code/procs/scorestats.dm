...
/mob/proc/showtickets()
	...
	if (!score_tracker.tickets_text)
		logTheThing("debug", null, "Zamujasa/SHOWTICKETS: [world.timeofday] generating showtickets text")
		...
		logTheThing("debug", null, "Zamujasa/SHOWTICKETS: [world.timeofday] done")
