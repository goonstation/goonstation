...
/mob/living/carbon/human/proc/Equip_Job_Slots(var/datum/job/JOB)
	...
	if (src.traitHolder && src.traitHolder.hasTrait("pawnstar"))
		...
		var/picked = pick(childrentypesof(/obj/item/clothing/head) - (typesof(/obj/item/clothing/head/headband/antennae)) - (typesof(/obj/item/clothing/head/headband/giraffe)) - (typesof(/obj/item/clothing/head/headband/nyan/leopard)) - (typesof(/obj/item/clothing/head/headband/nyan/snowleopard)) - (typesof(/obj/item/clothing/head/headband/nyan/tiger)) - (typesof(/obj/item/clothing/head/bighat)) - (typesof(/obj/item/clothing/head/helmet/space/syndicate))) //IM A MONSTER DONT LOOK AT ME. NOOOOOOOOOOO
