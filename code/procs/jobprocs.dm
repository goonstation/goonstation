...
/mob/living/carbon/human/proc/equip_sensory_items() //could probably use varibles in the proc to determine what needs to be equipped and in what slot but im lazy as hell
