...
<<<<<<< HEAD
		if("Security Trainee")
			return list(access_security, access_carrypermit, access_contrabandpermit, access_brig, access_maint_tunnels, access_medical, access_hydro, access_bar, access_kitchen)
=======
		if("Vice Officer")
...
>>>>>>> 9af9b4500feaf50f577c203de2fcf604141411b4
