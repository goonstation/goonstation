...
/proc/event_iomoon_blowout()
	...
	if (!iomoon_areas.len)
		iomoon_blowout_state = -1
		logTheThing("debug", null, "IOMOON: Unable to locate areas for event_iomoon_blowout.")
		return
...
/proc/end_iomoon_blowout()
	...
	if (!iomoon_areas.len)
		iomoon_blowout_state = -1
		logTheThing("debug", null, "IOMOON: Unable to locate areas for end_iomoon_blowout. Welp!")
		return
