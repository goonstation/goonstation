		...
		if(prob(40))
			...
			SPAWN(0.5 SECONDS)
				...
				for(var/turf/T in landmarks[LANDMARK_EVIL_CHEF_CORPSE])
					ghost.set_loc(T)
					var/obj/item/reagent_containers/food/snacks/ingredient/meat/humanmeat/meat = new /obj/item/reagent_containers/food/snacks/ingredient/meat/humanmeat(T,target)
