...
/mob/proc/get_stun_resist_mod()
	return min(GET_ATOM_PROPERTY(src, PROP_STUN_RESIST), clamp(GET_ATOM_PROPERTY(src, PROP_STUN_RESIST_MAX), 80, 100)) + 0
...
/mob/proc/get_disorient_protection()
	return min(GET_ATOM_PROPERTY(src, PROP_DISORIENT_RESIST_BODY), clamp(GET_ATOM_PROPERTY(src, PROP_DISORIENT_RESIST_BODY_MAX), 90, 100)) + 0

/mob/proc/get_disorient_protection_eye()
	return min(GET_ATOM_PROPERTY(src, PROP_DISORIENT_RESIST_EYE), clamp(GET_ATOM_PROPERTY(src, PROP_DISORIENT_RESIST_EYE_MAX), 90, 100)) + 0

/mob/proc/get_disorient_protection_ear()
	return min(GET_ATOM_PROPERTY(src, PROP_DISORIENT_RESIST_EAR), clamp(GET_ATOM_PROPERTY(src, PROP_DISORIENT_RESIST_EAR_MAX), 90, 100)) + 0
