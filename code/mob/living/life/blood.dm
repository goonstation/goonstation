...
/datum/lifeprocess/blood
	process(var/datum/gas_mixture/environment)
		...
		else if (current_blood_amt <= 300) // very low (70/50)
		...
		if (current_blood_amt <= owner.hypertension_threshold) // normal (120/80)
		...
		if (current_blood_amt <= 666) // high (140/90)
			if (prob(2))
		...
		else if (current_blood_amt <= 750) // very high (160/100)
			if (prob(2))
