...
// ------ IF ADDING NEW CORE FRAMES PLEASE DEFINE WHICH OPEN OVERLAY TO USE HERE ------ //
	...
	switch(src.fireloss)
		...
		if(25 to 49)
			src.UpdateOverlays(SafeGetOverlayImage("burn", 'icons/mob/ai.dmi', "dmg_burn-25", src.layer+0.4), "burn")
		if(50 to 74)
			src.UpdateOverlays(SafeGetOverlayImage("burn", 'icons/mob/ai.dmi', "dmg_burn-50", src.layer+0.4), "burn")
		if(75 to INFINITY)
			src.UpdateOverlays(SafeGetOverlayImage("burn", 'icons/mob/ai.dmi', "dmg_burn-75", src.layer+0.4), "burn")
	switch(src.bruteloss)
		if (-INFINITY to 24)
			src.UpdateOverlays(null, "brute")
		if(25 to 49)
			src.UpdateOverlays(SafeGetOverlayImage("brute", 'icons/mob/ai.dmi', "dmg_brute-25", src.layer+0.4), "brute")
		if(50 to 74)
			src.UpdateOverlays(SafeGetOverlayImage("brute", 'icons/mob/ai.dmi', "dmg_brute-50", src.layer+0.4), "brute")
		if(75 to INFINITY)
			src.UpdateOverlays(SafeGetOverlayImage("brute", 'icons/mob/ai.dmi', "dmg_brute-75", src.layer+0.4), "brute")
