...
/mob/living/silicon/ai
	...
	start_speech_prefixes = list(SPEECH_PREFIX_RADIO, SPEECH_PREFIX_AI_RADIO_1, SPEECH_PREFIX_AI_RADIO_2, SPEECH_PREFIX_AI_RADIO_3)
...
/mob/living/silicon/ai/proc/eye_view()
	...
	if (!src.eyecam)
		...
		src.ensure_say_tree().migrate_speech_tree(src.eyecam, src, TRUE)
...
/mob/living/silicon/ai/proc/return_to(var/mob/user)
	if (user.mind)
		src.eyecam.ensure_say_tree().migrate_speech_tree(src, src, FALSE)
