...
/mob/living/critter/flock/do_disorient(stamina_damage, knockdown, stunned, paralysis, disorient, remove_stamina_below_zero, target_type, stack_stuns)
	src.changeStatus("slowed", max(knockdown, stunned, paralysis, disorient))
