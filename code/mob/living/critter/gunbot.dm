TYPEINFO(/mob/living/critter/robotic/gunbot)
	mats = list(/datum/manufacturing_requirement/metal/dense = 12, /datum/manufacturing_requirement/conductive/high = 12, /datum/manufacturing_requirement/dense = 6)
...
TYPEINFO(/mob/living/critter/robotic/gunbot/mrl)
	mats = list(/datum/manufacturing_requirement/metal/dense = 16, /datum/manufacturing_requirement/conductive/high = 12, /datum/manufacturing_requirement/dense/super = 6, /datum/manufacturing_requirement/energy=4)
...
TYPEINFO(/mob/living/critter/robotic/gunbot/flame)
	mats = list(/datum/manufacturing_requirement/metal/dense = 12, /datum/manufacturing_requirement/conductive/high = 12, /datum/manufacturing_requirement/dense = 6, /datum/manufacturing_requirement/energy/high=4)
...
TYPEINFO(/mob/living/critter/robotic/gunbot/cannon)
	mats = list(/datum/manufacturing_requirement/metal/superdense = 12, /datum/manufacturing_requirement/conductive/high = 12, /datum/manufacturing_requirement/dense = 6, /datum/manufacturing_requirement/energy=4)
...
TYPEINFO(/mob/living/critter/robotic/gunbot/minigun)
	mats = list(/datum/manufacturing_requirement/metal/dense = 18, /datum/manufacturing_requirement/conductive/high = 12, /datum/manufacturing_requirement/dense = 6, /datum/manufacturing_requirement/energy=4)
