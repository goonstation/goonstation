...
//I have no clue if this is going to work or not
	New()
		...
		SPAWN_DBG(1 SECOND)
			abilityHolder.updateButtons()
//much of this is copied from jester
			src.equip_new_if_possible(/obj/item/clothing/under/gimmick/birdman, src.slot_w_uniform)
			src.equip_new_if_possible(/obj/item/clothing/shoes/sandal, src.slot_shoes)
			src.equip_new_if_possible(/obj/item/storage/backpack/bpangel, src.slot_back)
			src.equip_new_if_possible(/obj/item/clothing/mask/gas/plague, slot_wear_mask)
			src.equip_new_if_possible(/obj/item/device/radio/headset, slot_ears)
			src.equip_new_if_possible(/obj/item/clothing/gloves/latex, slot_gloves)
			src.equip_new_if_possible(/obj/item/clothing/head/crown, slot_head)
			src.equip_new_if_possible(/obj/item/clothing/suit/space/ntso, slot_wear_suit)
			src.equip_new_if_possible(/obj/item/gun/kinetic/riotgun, src.slot_belt)
			src.put_in_hand_or_drop(new /obj/item/card/id/syndicate)
			src.put_in_hand_or_drop(new /obj/item/storage/pouch/shotgun)


	initializeBioholder()

		bioHolder.mobAppearance.customization_first_color = "#1f0910"
		bioHolder.mobAppearance.customization_second_color = "#1f0910"
		bioHolder.mobAppearance.customization_first = new /datum/customization_style/hair/long/bluntbangs_s
		bioHolder.mobAppearance.customization_second = new /datum/customization_style/hair/short/combedbob_s
		bioHolder.age = 45
		...
		. = ..()
	//sanitize_null_values(angel)// just to stabilize a few things (HOPEFULLY)
/mob/living/carbon/human/funtimecat
	New()
		..()
		SPAWN_DBG(0)
			src.real_name = "Donk Co Super Duper Happy Funtime Friendly Cat Mascot"
			src.equip_new_if_possible(/obj/item/clothing/under/color/pink, src.slot_w_uniform)
			src.equip_new_if_possible(/obj/item/clothing/shoes/fuzzy, src.slot_shoes)
			src.equip_new_if_possible(/obj/item/storage/backpack, src.slot_back)
			src.equip_new_if_possible(/obj/item/device/radio/headset, slot_ears)
			src.equip_new_if_possible(/obj/item/clothing/gloves/latex/pink, slot_gloves)
			src.equip_new_if_possible(/obj/item/clothing/head/genki, slot_head)
			src.equip_new_if_possible(/obj/item/clothing/suit/bedsheet/cape/pink, slot_wear_suit)
			src.equip_new_if_possible(/obj/item/storage/belt/pistol, src.slot_belt)
			src.put_in_hand_or_drop(new /obj/item/card/id/catman)
			src.put_in_hand_or_drop(new /obj/item/fireaxe)
