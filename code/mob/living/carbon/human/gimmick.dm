...
/mob/living/carbon/human/satan/gimmick
	...
	initializeBioholder()
		bioHolder.age = 400
		bioHolder.mobAppearance.customizations["hair_top"].style = new /datum/customization_style/hair/short/pomp
		bioHolder.mobAppearance.customizations["hair_top"].color = "#000000"
...
/mob/living/carbon/human/biker
	...
	*/
	...
	initializeBioholder()
		. = ..()
		bioHolder.mobAppearance.customizations["hair_top"].color = "#292929"
		bioHolder.mobAppearance.customizations["hair_middle"].color = "#292929"
		bioHolder.mobAppearance.customizations["hair_top"].style = new /datum/customization_style/hair/gimmick/shitty_hair
...
/mob/living/carbon/human/don_glab
	...
	initializeBioholder()
		...
		bioHolder.mobAppearance.customizations["hair_top"].style = new /datum/customization_style/hair/short/pomp
		bioHolder.mobAppearance.customizations["hair_top"].color = "#F6D646"
		bioHolder.mobAppearance.gender = "male"
		bioHolder.mobAppearance.underwear = "boxers"
...
/mob/living/carbon/human/tommy
	...
	initializeBioholder()
		...
		src.gender = "male"
		bioHolder.mobAppearance.customizations["hair_top"].style = new /datum/customization_style/hair/long/dreads
		bioHolder.mobAppearance.gender = "male"
...
/mob/living/carbon/human/big_yank
	...
	initializeBioholder()
		. = ..()
		bioHolder.age = 49
		bioHolder.mobAppearance.customizations["hair_top"].style = new /datum/customization_style/beard/fullbeard
