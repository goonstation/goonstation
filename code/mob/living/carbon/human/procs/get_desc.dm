...
*/
	...
	if ((isdead(src)) || changeling_fakedeath || (src.reagents.has_reagent("capulettium") && src.getStatusDuration("paralysis")) || (src.reagents.has_reagent("capulettium_plus") && src.hasStatus("resting")) || (src.reagents.has_reagent("namium") && src.hasStatus("weakened")))
		if (!src.decomp_stage)
