...
/mob/living/carbon/human/list_ejectables()
	...
	if (src.organHolder)
		...
		if (organHolder.augmentation_nerve)
			processed += organHolder.augmentation_nerve
			if (prob(25) && organHolder.augmentation_nerve.loc == src)
				ret += organHolder.augmentation_nerve
		if (prob(50))
