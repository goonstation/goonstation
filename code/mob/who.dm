/mob/verb/who()
	...
	if (!usr.client.holder)
		logTheThing("admin", usr, "used Who and saw [whoAdmins.len] admins.")
		logTheThing("diary", usr, "used Who and saw [whoAdmins.len] admins.", "admin")
		if (whoAdmins.len < 1)
			for (var/client/C in clients)
...
/client/verb/adminwho()
	...
	if(!usr.client.holder)
		logTheThing("admin", usr, "used adminwho and saw [adwnum] admins.")
		logTheThing("diary", usr, "used adminwho and saw [adwnum] admins.", "admin")
		for(var/client/C in clients)
			if(C.holder && C.holder.adminwho_alerts && !C.player_mode)
