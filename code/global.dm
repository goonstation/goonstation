...
var/global
	...
	pod_wars_NT = image('icons/mob/antag_overlays.dmi', icon_state = "rev")
	pod_wars_NT_CMDR = image('icons/mob/antag_overlays.dmi', icon_state = "rev_head")
	pod_wars_SY = image('icons/mob/antag_overlays.dmi', icon_state = "syndicate")
	pod_wars_SY_CMDR = image('icons/mob/antag_overlays.dmi', icon_state = "vampire")
