...
var/global
	...
	"Choppy Short",
	"Einstein",
	"Einstein: Alternating",
	"Emo",
	"Emo: Highlight",
	"Flat Top",
	"Hair Streak",
	"Mohawk",
	"Mohawk: Fade from End",
	"Mohawk: Fade from Root",
	"Mohawk: Stripes",
	"Mullet",
	"Parted Hair",
	"Pompadour",
	"Pompadour: Greaser Shine",
	"Punky Flip",
	"Temsik",
	"Tonsure",
	"Trimmed",
	...
	list/moustache_styles = list("Biker",
	"Chaplin",
	"Dali",
	"Hogan",
	"Old Nick",
