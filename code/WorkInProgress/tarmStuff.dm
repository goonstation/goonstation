...
/obj/machinery/door/unpowered/wood/lily/open()
	...
	playsound(src.loc, "sound/voice/screams/fescream3.ogg", 50, 1, channel=VOLUME_CHANNEL_SCREAMFART)
	. = ..()

/obj/machinery/door/unpowered/wood/lily/close()
	playsound(src.loc, "sound/voice/screams/robot_scream.ogg", 50, 1, channel=VOLUME_CHANNEL_SCREAMFART)
	. = ..()
