...
obj/chessbutton
	...
	attack_hand(mob/user)
		if(chess_in_progress && !confirm)
			...
			logTheThing("admin", user, "has reset the chessboard. Hope nobody was playing chess.")
			logTheThing("diary", user, "has reset the chessboard. Hope nobody was playing chess.", "admin")
