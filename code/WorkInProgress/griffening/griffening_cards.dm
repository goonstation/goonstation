...
#define GRIFFENING_target_non_mobs GRIFFENING_TARGET_CREATURE | GRIFFENING_TARGET_EFFECT_ROW | GRIFFENING_TARGET_AREA
...
#define GRIFFENING_TARGET_OWN_FIELD GRIFFENING_target_non_mobs | GRIFFENING_TARGET_OWN
#define GRIFFENING_TARGET_OPPONENT_FIELD GRIFFENING_target_non_mobs | GRIFFENING_TARGET_OPPONENT
#define GRIFFENING_TARGET_ANY_FIELD GRIFFENING_target_non_mobs | GRIFFENING_TARGET_ANY_PLAYER
