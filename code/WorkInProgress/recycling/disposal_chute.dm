...
/obj/machinery/disposal
	...
	var/normal_pressure = 0.1 // for the moles pressure thanks leah - rex
	...
	process()
		...
		if(env.temperature > 0)
			var/transfer_moles = normal_pressure * pressure_delta*air_contents.volume/(env.temperature * R_IDEAL_GAS_EQUATION)
