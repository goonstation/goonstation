...
/datum/engibox_mode/spawmmetal
	...
	used(atom/user, atom/target)
		var/obj/item/sheet/iron/M = new/obj/item/sheet/iron(get_turf(target))
		M.amount = 100
		return
...
/datum/engibox_mode/grille
	...
	used(atom/user, atom/target)
		var/obj/grille/L = new/obj/grille/iron(get_turf(target))
		L.set_dir(user:dir)
		return
