...
TYPEINFO(/obj/machinery/transception_pad)
	mats = list(/datum/manufacturing_requirement/metal/dense=5,/datum/manufacturing_requirement/conductive/high=2,/datum/manufacturing_requirement/conductive=5)
