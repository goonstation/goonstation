/datum/progress
	...
	proc/set_complete()
		completed = 1
		logTheThing("debug", null, "<B>Marquesas/Progress</B>: Milestone [name] complete.")
	...
	proc/uncomplete()
		...
		logTheThing("debug", null, "<B>Marquesas/Progress</B>: Milestone [name] uncompleted.")
	...
	proc/check_uncompletion()
		...
		if (completed && !uncompletion && !is_complete)
			...
			logTheThing("debug", null, "<B>Marquesas/Progress</B>: Milestone [name] uncompleting.")
...
/datum/progress/pods
	...
	check_completion(var/turf/T)
		...
		logTheThing("debug", null, "<B>Marquesas/Progress</B>: Pod score is [pod_score].")
