...
/datum/construction_event/siege/animals
	...
	attacker_types = list(/mob/living/critter/small_animal/wasp, /mob/living/critter/small_animal/mouse, /obj/critter/goose, /obj/critter/goose/swan, /mob/living/critter/small_animal/bird/owl, /obj/critter/bat/buff, /mob/living/critter/small_animal/cat, /mob/living/critter/spider/nice, /mob/living/critter/spider/spacerachnid)
