...
/obj/machinery/ion_drive/interface/New()
		...
		SPAWN(0.5 SECONDS)
				...
				if(!src.artemis_tank||!src.artemis_tank)
						src.status |= BROKEN
/obj/machinery/ion_drive/interface/attack_ai(mob/user as mob)
				return src.Attackhand(user)
/obj/machinery/ion_drive/interface/attackby(obj/item/W, mob/user)
				..()
/obj/machinery/ion_drive/interface/ui_interact(mob/user, datum/tgui/ui)
		...
		if(!ui)
				...
				ui.open()
/obj/machinery/ion_drive/interface/ui_interact(mob/user)
		. = list(
