...
/obj/item/fish/code_worm
	...
	New()
		..()
		name = "\improper [pick("Free", "Gamer", "Xtreme", "Funny", "Ultimate", "REAL", "EXPLICIT CONTENT")]
		 [pick("cat", "puppy", "gaming", "fail", "cheat", "hax")]
		  [pick("video", "content", "game", "images", "text", "audiobook", "podcast")].worm"
