			...
			if (P.fishing_upload_blacklisted)
				...
				switch( P.rarity )
					if (ITEM_RARITY_COMMON)
						new/obj/item/currency/vendor_token/fishing(src.loc)
						JOB_XP(user, "Angler", 1)
						qdel( P )
					if (ITEM_RARITY_UNCOMMON)
						new/obj/item/currency/vendor_token/fishing/uncommon(src.loc)
						JOB_XP(user, "Angler", 2)
						qdel( P )
					if (ITEM_RARITY_RARE)
						new/obj/item/currency/vendor_token/fishing/rare(src.loc)
						JOB_XP(user, "Angler", 3)
						qdel( P )
					if (ITEM_RARITY_EPIC)
						new/obj/item/currency/vendor_token/fishing/epic(src.loc)
						JOB_XP(user, "Angler", 4)
						qdel( P )
					if (ITEM_RARITY_LEGENDARY)
						new/obj/item/currency/vendor_token/fishing/legendary(src.loc)
