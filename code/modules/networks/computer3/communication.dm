	...
	input_text(text)
		...
		switch(menu)
			...
			if(MENU_CALL)
				...
				logTheThing("admin", usr,  "attempted to call the Emergency Shuttle via COMMaster (reason: [call_reason])")
				logTheThing("diary", usr, "attempted to call the Emergency Shuttle via COMMaster (reason: [call_reason])", "admin")
			...
			if(MENU_TRANSMIT_MESSAGE)
				...
				if(transmit_type == "centcom")
					logTheThing("admin", usr,  "attempted to contanct CentCom (title: [src.transmit_title], message: [transmit_message])")
					logTheThing("diary", usr, "attempted to contanct CentCom (title: [src.transmit_title], message: [transmit_message])", "admin")
				else if(transmit_type == "station")
					logTheThing("admin", usr,  "attempted to contanct the partner space station (title: [src.transmit_title], message: [transmit_message])")
					logTheThing("diary", usr, "attempted to contanct the partner space station (title: [src.transmit_title], message: [transmit_message])", "admin")
