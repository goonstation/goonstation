...
TYPEINFO(/obj/machinery/networked/nuclear_charge)
	mats = list(/datum/manufacturing_requirement/energy/extreme = 27, /datum/manufacturing_requirement/metal/superdense = 25, /datum/manufacturing_requirement/conductive/high = 13, /datum/manufacturing_requirement/crystal/dense = 15) //haha this is a bad idea
