...
/datum/computer/file/mainframe_program/utility/mv/initialize(initparams)
	...
	if (src.signal_program(1, list("command" = DWAINE::SYSCALL::FGET, "path" = initlist[2])) == DWAINE::ERR::SIG::NOFILE)
	...
	if (src.signal_program(1, list("command" = DWAINE::SYSCALL::FWRITE, "path" = initlist[2]), copy) != DWAINE::ERR::SIG::SUCCESS)
		...
		src.signal_program(1, list("command" = DWAINE::SYSCALL::FKILL, "path" = initlist[1]))
