#ifdef SEASON_SUMMER
/datum/clothingbooth_grouping/bikini
	name = "Bikini"
	item_paths = list(
...
/datum/clothingbooth_grouping/frillyswimsuit
...
/datum/clothingbooth_grouping/swimtrunks
	name = "Swim Trunks"
	item_paths = list(
...
/datum/clothingbooth_grouping/oldswimsuit
...
/datum/clothingbooth_grouping/wetsuit
	name = "Wetsuit"
	item_paths = list(
