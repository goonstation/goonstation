...
/datum/commodity/trader/pianzi/concgloves
	...
	amount = 2
	price_boundary = list(PRICE_LUXURY_CHEAP*0.6,PRICE_LUXURY*0.5)
...
/datum/commodity/trader/pianzi/wine
	...
	amount = 8
	price_boundary = list(PRICE_RECURRING_CHEAP*0.15,PRICE_RECURRING_COSTLY*0.8)
...
/datum/commodity/trader/pianzi/artifact
	...
	price_boundary = list(PRICE_LUXURY_CHEAP*0.6,PRICE_LUXURY_COSTLY)
