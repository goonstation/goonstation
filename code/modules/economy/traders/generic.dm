...
/datum/commodity/trader/generic/monkey
	...
	amount = 4
	possible_alt_types = list(/mob/living/critter/gorilla)
	alt_type_chance = 5
	price_boundary = list(PAY::UNTRAINED, PAY::DOCTORATE)
...
/datum/commodity/trader/generic/anyore
	...
	price_boundary = list(PAY::UNTRAINED/3,PAY::TRADESMAN)
...
/datum/commodity/trader/generic/anyfood
	...
	price_boundary = list(PAY::UNTRAINED/4,PAY::UNTRAINED/2)
...
/datum/commodity/trader/generic/shoes
	...
	price_boundary = list(PAY::UNTRAINED/3,PAY::UNTRAINED)
