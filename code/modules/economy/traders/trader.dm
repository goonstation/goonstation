/datum/trader
	...
	proc/buy_from()
		...
		pdaSignal.data = list("address_1"="00000000", "command"="text_message", "sender_name"="IMPORT-MAILBOT", "group"=MGD_CARGO, "alert"=MGA_SALES, "sender"="00000000", "message"="Deal with \"[src.name]\" concluded. Total Cost: [total_price] credits")
