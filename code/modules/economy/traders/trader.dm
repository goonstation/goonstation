/datum/trader
	...
	proc/buy_from()
		...
		pdaSignal.data = list("address_1"="00000000", "command"="text_message", "sender_name"="CARGO-MAILBOT", "tag" = PDA_CARGO_ALERT_TAG, "group"=MGD_CARGO, "sender"="00000000", "message"="Deal with \"[src.name]\" concluded. Total Cost: [total_price] credits")
