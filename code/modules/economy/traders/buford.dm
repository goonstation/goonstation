...
/datum/commodity/trader/buford/alienseeds
	...
	amount = 5
	price_boundary = list(PAY::TRADESMAN/2,PAY::TRADESMAN*2)
...
/datum/commodity/trader/buford/weedseeds
	...
	price_boundary = list(PAY::UNTRAINED/20,PAY::UNTRAINED/10)
...
/datum/commodity/trader/buford/weedkiller
	...
	amount = 20
	price_boundary = list(PAY::UNTRAINED/4,PAY::UNTRAINED)
...
/datum/commodity/trader/buford/methane
	...
	amount = 1
	price_boundary = list(PAY::EXECUTIVE, PAY::EMBEZZLED) //a little expensive
...
/datum/commodity/trader/buford/vennecure
	...
	price_boundary = list(PAY::UNTRAINED/2,PAY::TRADESMAN)
...
/datum/commodity/trader/buford/megaweed
	...
	price_boundary = list(PAY::UNTRAINED/2,PAY::TRADESMAN*2)
...
/datum/commodity/trader/buford/pizza
	...
	price_boundary = list(4,20) // we can keep this joke in here, as a treat
