...
/datum/commodity/trader/buford/weedseeds
	...
	price_boundary = list(PRICE_RECURRING_CHEAP*0.08,PRICE_15)
...
/datum/commodity/trader/buford/weedkiller
	...
	amount = 20
	price_boundary = list(PRICE_37_5,PRICE_RECURRING*0.75)
...
/datum/commodity/trader/buford/vennecure
	...
	price_boundary = list(PRICE_75,PRICE_RECURRING_COSTLY)
...
/datum/commodity/trader/buford/megaweed
	...
	price_boundary = list(PRICE_75,PRICE_LUXURY_CHEAP*0.6)
