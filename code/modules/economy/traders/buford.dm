...
/datum/commodity/trader/buford/alienseeds
	...
	amount = 5
	price_boundary = list(PRICE_300/2,PRICE_300*2)
...
/datum/commodity/trader/buford/weedseeds
	...
	price_boundary = list(PRICE_150/20,PRICE_150/10)
...
/datum/commodity/trader/buford/weedkiller
	...
	amount = 20
	price_boundary = list(PRICE_150/4,PRICE_150)
...
/datum/commodity/trader/buford/methane
	...
	amount = 1
	price_boundary = list(PRICE_2400,PRICE_5000) //a little expensive
...
/datum/commodity/trader/buford/vennecure
	...
	price_boundary = list(PRICE_150/2,PRICE_300)
...
/datum/commodity/trader/buford/omegaweed
	...
	price_boundary = list(PRICE_300,PRICE_300*2)
