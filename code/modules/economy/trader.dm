...
/obj/npc/trader/robot/syndicate
	...
	New()
		...
		var/specialammo_types = concrete_typesof(/datum/commodity/contraband/specialammo)
		...
		src.goods_illegal += new /datum/commodity/contraband/muckshot(src)
		...
		for(var/i in 1 to 1)
			var/datum/commodity/contraband/specialammo/C = (pick(specialammo_types))
			specialammo_types -= C
			src.goods_illegal += new C(src, C.num_stocked)
		...
		src.goods_sell += new /datum/commodity/podparts/artillery(src, 2)
		src.goods_sell += new /datum/commodity/contraband/artillery_ammo(src, 3)
