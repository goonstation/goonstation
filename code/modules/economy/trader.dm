	...
	attackby(obj/item/W as obj, mob/living/user as mob)
		if (istype(W, /obj/item/coin/bombini))
			for(var/mob/M in AIviewers(src))
				...
				user.add_karma(15) // This line originally tried to give the karma to Bombini. Definitely a bug but I like to imagine that she just managed to pickpocket your karma or something.
			user.u_equip(W)
			qdel(W)
		else
			..()
