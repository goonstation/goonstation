...
//////////////////////////////////////////////////////////////////////
		...
		greeting= {"BOOM! You're tuned into MAD LARRY'S RING OF DEALS! Not only am I current Borgweight Space League Champion four years running, I sell antiques and KICKASS relics from across the space galaxy - and I always pay TOP CRED for anything space explorers dig up! What are ya waiting for? GET DEALIN'!"}

		portrait_setup = "<img src='[resource("images/traders/[src.picture]")]'><HR><B>[src.name]</B><HR>"

		sell_dialogue = "Check out the wanted list! I'm always looking to buy some GENUINE space crap!"
		buy_dialogue = "Here's the goods."
		successful_purchase_dialogue = list("A deal at ",
			"Going to miss that one.",
			"All sales are final. Just thought I'd remind you.",
			"Almost new. Barely used.")
