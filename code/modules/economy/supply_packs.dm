...
//NOTE: syndicate packs only show up when the computer has been emagged.
...
/datum/supply_packs/specialops
	...
	cost = PAY::EMBEZZLED*2
	containertype = /obj/storage/crate
	containername = "Special Ops Crate"
	syndicate = 1

// these are here in this specific order for category ordering on the QM Order/Request consoles
...
/datum/supply_packs/medicalfirstaid
	...
	desc = "x6 Assorted First Aid Kits"
	category = "Medical"
...
/datum/supply_packs/chemical
	...
	containertype = /obj/storage/secure/crate/research
	containername = "Chemistry Resupply Crate"
	access = access_chemistry

/datum/supply_packs/engineering
	name = "Engineering Tools Crate"
	...
	cost = PAY::DOCTORATE*2
	containertype = /obj/storage/crate
	containername = "Engineering Tools Crate"
...
/datum/supply_packs/security_resupply
	name = "Security Assistant Equipment (Locked \[Security Equipment])"
	...
	containername = "Security Assistant Equipment (Locked \[Security Equipment])"
	access = access_securitylockers

/datum/supply_packs/ID_gear
	name = "Identity Kit (Locked \[Heads])"
	...
	containername = "Identity Kit (Locked \[Heads])"
	access = access_heads
...
/datum/supply_packs/plasma_generator
...
/datum/supply_packs/complex/glass_recycler
	name = "Glass Recycler"
	desc = "x1 Glass Recycler Deployer."
	flatpack_frames = list(/obj/machinery/glass_recycler)
	cost = PAY::TRADESMAN*2
	containertype = /obj/storage/crate
...
/datum/supply_packs/security_brig_resupply
	name = "Prisoner Containment Crate (Locked \[Security Equipment])"
	...
	cost = PAY::IMPORTANT*2
	containertype = /obj/storage/secure/crate/weapon
	containername = "Prisoner Containment Crate (Locked \[Security Equipment])"
	access = access_securitylockers
...
/datum/supply_packs/forensics
	name = "Crime-Scene Investigation Resupply (Locked \[Forensics])"
	...
	containername = "CSI Supply Crate (Locked \[Forensics])"

/datum/supply_packs/evacuation
	name = "Emergency Hull Repair Equipment"
	...
	containername = "Emergency Hull Repair Equipment"
...
/datum/supply_packs/robot
	...
	cost = PAY::TRADESMAN*5
	containertype = /obj/storage/crate
	containername = "Auto-drone Crate"
...
/datum/supply_packs/restricted_medicine
	name = "Restricted Medicine Shipment (Locked \[Pharmacy])"
	...
	containertype = /obj/storage/secure/crate
	containername = "Restricted Medicine Shipment (Locked \[Pharmacy])"
...
/datum/supply_packs/microbrew
	...
	desc = "x1 Still, x2 Glass Pitchers, x6 Glass Bottles. For the posh microbrewery."
	category = "Crew Service"
...
/datum/supply_packs/singularity_generator
	name = "Singularity Generator Crate (Locked \[Chief Engineer])"
...
/datum/supply_packs/rad_collector
	...
	cost = PAY::EMBEZZLED
	containertype = /obj/storage/secure/crate
	containername = "Radiation Array Crate (Locked \[Engineering])"
	access = access_engineering
...
/datum/supply_packs/abcu
	name = "ABCU Unit Crate (Locked \[Engineering])"
	desc = "x1 ABCU Unit. For large construction projects."
	category = "Engineering"
	contains = list(/obj/machinery/abcu, /obj/item/blueprint_marker)
	cost = PAY::TRADESMAN*5
	containertype = /obj/storage/secure/crate
	containername = "ABCU Unit Crate (Locked \[Engineering])"
	access = access_engineering

/datum/supply_packs/efif1
	name = "EFIF-1 Construction System (Locked \[Engineering])"
	...
	cost = PAY::DOCTORATE*15
	containertype = /obj/storage/secure/crate
	containername = "EFIF-1 Crate (Locked \[Engineering])"
	access = access_engineering
...
/datum/supply_packs/lawrack
	name = "AI Law Rack ManuDrive Crate (Locked \[Heads])"
	...
	cost = PAY::IMPORTANT*2
	containertype = /obj/storage/secure/crate
	containername = "AI Law Rack ManuDrive Crate (Locked \[Heads])"
	access = access_heads

/datum/supply_packs/stationgravitytether
	name = "Station Gravity Tether ManuDrive Crate (Locked \[Heads])"
	...
	cost = PAY::IMPORTANT*2
	containertype = /obj/storage/secure/crate
	containername = "Station Gravity Tether ManuDrive Crate (Locked \[Heads])"
	access = access_heads
...
/datum/supply_packs/comms_dish
	name = "Communications Dish (Locked \[Heads])"
	...
	cost = PAY::IMPORTANT
	containertype = /obj/storage/secure/crate
	containername = "Communications Dish Crate (Locked \[Heads])"
	access = access_heads
...
/datum/supply_packs/complex
	...
	create(var/spawnpoint,var/mob/creator)
		...
		for (var/path in flatpack_frames)
			if (!ispath(path))
				path = text2path(path)
				if (!ispath(path))
					continue
			...
			for (amt, amt>0, amt--)
				var/obj/item/electronics/frame/flatpack/F = new /obj/item/electronics/frame/flatpack(A)
				F.name = "[template_name] deployer"
				F.store_type = path
				F.viewstat = 2
				F.secured = 2
...
/datum/supply_packs/complex/electronics_kit
	name = "Mechanics Reconstruction Kit (Locked \[Chief Engineer])"
	...
	access = access_engineering_chief
	containername = "Mechanics Reconstruction Kit (Locked \[Chief Engineer])"

/datum/supply_packs/complex/barbershop_kit
	name = "Barbershop Kit"
	desc = "x1 Barber Chair, x2 Dye Bottles, x1 Razor Blade, x1 Scissors, x1 Barber's Uniform, x1 Latex Gloves, x1 Hair Dye Dispenser Deployer."
	category = "Crew Service"
	...
	flatpack_frames = list(/obj/machinery/hair_dye_dispenser)
	cost = PAY::TRADESMAN*5
	containertype = /obj/storage/crate
...
/datum/supply_packs/complex/ai_kit
	name = "AI Reconstruction Kit (Locked \[Heads])"
	category = "Command"
	...
	hidden = 1
	containertype = /obj/storage/secure/crate
	containername = "AI Reconstruction Kit (Locked \[Heads])"
	access = access_heads
...
/datum/supply_packs/complex/mainframe_kit
	name = "Computer Core Reconstruction Kit (Locked \[Sys-Admin])"
	category = "Research"
	...
	hidden = 1
	containertype = /obj/storage/secure/crate
	containername = "Computer Core Reconstruction Kit (Locked \[Sys-Admin])"
	access = access_sysadmin

/datum/supply_packs/complex/artlab_kit
	name = "Artifact Research Reconstruction Kit (Locked \[Artifact Lab])"
	...
	cost = PAY::DOCTORATE*10
	containertype = /obj/storage/secure/crate/research
	containername = "Artifact Research Reconstruction Kit (Locked \[Artifact Lab])"
	access = access_artlab

/datum/supply_packs/complex/toilet_kit
	name = "Bathroom Kit"
	desc = "x4 Toilet Deployers, x1 Sink Deployer, x1 Shower Head Deployer, x1 Bathtub Deployer."
	flatpack_frames = list(/obj/item/storage/toilet = 4,
...
/datum/supply_packs/complex/kitchen_kit
	name = "Kitchen Reconstruction Kit"
	...
	cost = PAY::TRADESMAN*10
	containertype = /obj/storage/crate
	containername = "Kitchen Reconstruction Kit"

/datum/supply_packs/complex/bartender_kit
	name = "Bar Reconstruction Kit"
	...
	cost = PAY::TRADESMAN*10
	containertype = /obj/storage/crate
	containername = "Bar Reconstruction Kit"
...
/datum/supply_packs/complex/telescience_kit
	name = "Telescience Reconstruction Kit (Locked \[Telescience Lab])"
	...
	hidden = 1
	containertype = /obj/storage/secure/crate/research
	containername = "Telescience Reconstruction Kit (Locked \[Telescience Lab])"
	access = access_telesci
...
/datum/supply_packs/complex/security_camera
	...
	hidden = 1
	containertype = /obj/storage/crate
	containername = "Security Camera Kit"

/datum/supply_packs/complex/medical_kit
	name = "Medbay Reconstruction Kit (Locked \[Medical])"
	...
	cost = PAY::DOCTORATE*10
	containertype = /obj/storage/secure/crate/medical
	containername = "Medbay Reconstruction Kit (Locked \[Medical])"
...
/datum/supply_packs/complex/operating_kit
	...
	cost = PAY::DOCTORATE*10
	containertype = /obj/storage/secure/crate/medical
	containername = "Operating Room Reconstruction Kit (Locked \[Medical])"
	access = access_medical

/datum/supply_packs/complex/field_generator
	name = "Field Generator Crate (Locked \[Engineering])"
	...
	cost = PAY::EMBEZZLED
	containertype = /obj/storage/secure/crate
	containername = "Field Generator Crate (Locked \[Engineering])"
	access = access_engineering

/datum/supply_packs/complex/winter
	name = "Cold Weather Gear"
	desc = "x5 Winter Coats, x2 Chicken Soup, x2 Coffee, x2 Space Heater Deployers. Warm winter gear to ward off the winter chills."
	...
	flatpack_frames = list(/obj/machinery/space_heater = 2)
	cost = PAY::TRADESMAN*2
	containertype = /obj/storage/crate/wooden
...
/datum/supply_packs/complex/hydrostarter
	...
	desc = "x2 Watering Cans, x4 Compost Bags, x2 Weedkiller bottles, x2 Plant Analyzers, x4 Plant Tray Deployers."
	category = "Crew Service"
	...
	flatpack_frames = list(/obj/machinery/plantpot = 4)
	cost = PAY::TRADESMAN*2
	containertype = /obj/storage/crate
...
/datum/supply_packs/complex/robotics_kit
	name = "Robotics Reconstruction Kit (Locked \[Robotics])"
	...
	cost = PAY::DOCTORATE*10
	containertype = /obj/storage/secure/crate/medical
	containername = "Robotics Reconstruction Kit (Locked \[Robotics])"
	access = access_robotics

/datum/supply_packs/complex/genetics_kit
	name = "Genetics Reconstruction Kit (Locked \[Genetics])"
	...
	cost = PAY::DOCTORATE*10
	containertype = /obj/storage/secure/crate/medical
	containername = "Genetics Reconstruction Kit (Locked \[Genetics])"
	access = access_medlab

/datum/supply_packs/complex/cloner_kit
	name = "Cloning Reconstruction Kit (Locked \[Medical Equipment])"
	...
	cost = PAY::DOCTORATE*20
	containertype = /obj/storage/secure/crate/medical
	containername = "Cloning Reconstruction Kit Locked \[Medical Equipment])"
	access = access_medical_lockers
...
/datum/supply_packs/complex/player_piano
	...
	desc = "x1 Player Piano Deployer."
	cost = PAY::TRADESMAN*3
	containername = "Player Piano Kit"
	flatpack_frames = list(/obj/player_piano)
	containertype = /obj/storage/crate/wooden

/datum/supply_packs/complex/piano
	name = "Piano Kit"
	desc = "x1 Piano Deployer."
	cost = PAY::TRADESMAN*3
	containername = "Piano Kit"
	flatpack_frames = list(/obj/item/instrument/large/piano)
	containertype = /obj/storage/crate/wooden

/datum/supply_packs/complex/piano_grand
	name = "Grand Piano Kit"
	desc = "x1 Grand Piano Deployer."
	cost = PAY::TRADESMAN*3
	containername = "Grand Piano Kit"
	flatpack_frames = list(/obj/item/instrument/large/piano/grand)
	containertype = /obj/storage/crate/wooden
