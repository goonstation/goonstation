...
/datum/commodity/junk/pie_launcher
	...
	price = PAY::DOCTORATE/2
	baseprice = PAY::DOCTORATE/2
	upperfluc = PAY::DOCTORATE/6
	lowerfluc = -PAY::DOCTORATE/6
