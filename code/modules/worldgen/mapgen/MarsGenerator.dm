...
/datum/biome/mars/martian_area
	...
	fauna_types = list(/mob/living/critter/martian=50, /mob/living/critter/martian/soldier=10, /mob/living/critter/martian/psychic=1, /mob/living/critter/martian/psychic/weak=5, /mob/living/critter/martian/warrior=10)
	fauna_density = 1
