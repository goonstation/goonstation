...
/datum/mapPrefab/mining/space // All prefabs that can only spawn in space
	...
	pathStart = "assets/maps/prefabs/space/"

	clown
		maxNum = 1
		probability = 25
		prefabPath = "prefab_clown.dmm"
		prefabSizeX = 5
		prefabSizeY = 5
	...
	cannibal
		maxNum = 1
		probability = 25
		prefabPath = "prefab_cannibal.dmm"
		prefabSizeX = 10
		prefabSizeY = 10
	...
	sleepership
		maxNum = 1
		probability = 25
		prefabPath = "prefab_sleepership.dmm"
		prefabSizeX = 15
		prefabSizeY = 19
	...
	rockworms
		...
		probability = 100
		prefabPath = "prefab_rockworms.dmm"
		prefabSizeX = 5
		prefabSizeY = 5
	...
	smuggler // kube's smuggler thing
		maxNum = 1
		probability = 25
		prefabPath = "prefab_smuggler.dmm"
		prefabSizeX = 19
		prefabSizeY = 18
	...
	customs_shuttle // Carsontheking's Crashed Customs shuttle
		maxNum = 1
		probability = 25
		prefabPath = "prefab_customs_shuttle.dmm"
		prefabSizeX = 27
		prefabSizeY = 16
	...
	pie_ship // Urs's ship originally built for the pie eating contest event
		maxNum = 1
		probability = 20
		prefabPath = "prefab_pie_ship.dmm"
		prefabSizeX = 16
		prefabSizeY = 21
	...
	bee_sanctuary_space // Sov's Bee Sanctuary (Space Variant)
		maxNum = 1
		probability = 25
		prefabPath = "prefab_beesanctuary.dmm"
		prefabSizeX = 41
		prefabSizeY = 24
	...
	sequestered_cloner // MarkNstein's Sequestered Cloner
		maxNum = 1
		probability = 25
		prefabPath = "prefab_sequestered_cloner.dmm"
		prefabSizeX = 20
		prefabSizeY = 15
	...
	clown_nest // Gores abandoned Clown-Federation Outpost
		maxNum = 1
		probability = 30
		prefabPath = "prefab_clown_nest.dmm"
		prefabSizeX = 30
		prefabSizeY = 30
	...
	dans_asteroid // Discount Dans Delivery Asteroid featuring advanced cooling technology
		maxNum = 1
		probability = 30
		prefabPath = "prefab_dans_asteroid.dmm"
		prefabSizeX = 37
		prefabSizeY = 48
	...
	drug_den // A highly cozy hideout in space; take out the stress - eat some mice sandwiches.
		maxNum = 1
		probability = 40
		prefabPath = "prefab_drug_den.dmm"
		prefabSizeX = 32
		prefabSizeY = 27
	...
	von_ricken // One way or another - an expensive space vavaction for a physical toll.
		maxNum = 1
		probability = 30
		prefabPath = "prefab_von_ricken.dmm"
		prefabSizeX = 42
		prefabSizeY = 40
	...
	candy_shop // Ryn's store from out of time and out of place
		maxNum = 1
		probability = 25
		prefabPath = "prefab_candy_shop.dmm"
		prefabSizeX = 20
		prefabSizeY = 20
	...
	space_casino // Lythine's casino with some dubious gambling machines
		maxNum = 1
		probability = 25
		prefabPath = "prefab_space_casino.dmm"
		prefabSizeX = 31
		prefabSizeY = 23
	...
	synd_lab // Zone's Syndicate laboratory for experimenting with telecrystals
		maxNum = 1
		probability = 15
		prefabPath = "prefab_synd_lab.dmm"
		prefabSizeX = 14
		prefabSizeY = 16
	...
	shooting_range // Nef's shooting range with an experimental ray gun
		maxNum = 1
		probability = 15
		prefabPath = "prefab_gunrange.dmm"
		prefabSizeX = 19
		prefabSizeY = 22
	...
	lesbeeans // BatElite's bee-shaped farm where the bees are also lesbians
		maxNum = 1
		probability = 20
		prefabPath = "prefab_lesbeeans.dmm"
		prefabSizeX = 24
		prefabSizeY = 24
	...
	silverglass // Ill-fated entanglement research facility
		maxNum = 1
		probability = 25
		prefabPath = "prefab_silverglass.dmm"
		prefabSizeX = 35
		prefabSizeY = 26
	...
	safehouse // A seemingly abandoned safehouse
		maxNum = 1
		probability = 15
		prefabPath = "prefab_safehouse.dmm"
		prefabSizeX = 35
		prefabSizeY = 23
	...
	dreamplaza // Walp's abandoned space mall... Well, what remains of it.
		maxNum = 1
		probability = 30
		prefabPath = "prefab_dreamplaza.dmm"
		prefabSizeX = 30
		prefabSizeY = 30
	...
	secbot_academy // Danger Noodle's elite securitron school
		maxNum = 1
		probability = 15
		prefabPath = "prefab_secbot_academy.dmm"
		prefabSizeX = 34
		prefabSizeY = 37
	...
	art_workshop
		maxNum = 1
		probability = 25
		prefabPath = "prefab_artist_studio.dmm"
		prefabSizeX = 25
		prefabSizeY = 18
	...
	adrift_cargorouter
		maxNum = 1
		probability = 25
		prefabPath = "prefab_adrift_cargo_router.dmm"
		prefabSizeX = 16
		prefabSizeY = 16
	...
	larrys_laundry // Cheffie's Laundromat with port-a-laundry
		maxNum = 1
		probability = 20
		prefabPath = "prefab_larrys_laundromat.dmm"
		prefabSizeX = 17
		prefabSizeY = 20
	...
	mauxite_hideout // Cheffie's Fermid infested hideout with grenade casings
		maxNum = 1
		probability = 10
		prefabPath = "prefab_mauxite_hideout.dmm"
		prefabSizeX = 22
		prefabSizeY = 20
