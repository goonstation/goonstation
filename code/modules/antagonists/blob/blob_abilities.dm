	...
	onUse(var/turf/T)
		...
		if (istype(T, /turf/space))
			...
			if (B)
				...
				if (success)
					if (prob(16))
						playsound(T,"sound/voice/blob1.ogg", 50, 0)
					else if (prob(16))
						playsound(T,"sound/voice/blob2.ogg", 50, 0)
					else if (prob(16))
						playsound(T,"sound/voice/blob3.ogg", 50, 0)
					else if (prob(16))
						playsound(T,"sound/voice/blob4.ogg", 50, 0)
					else if (prob(16))
						playsound(T,"sound/voice/blob5.ogg", 50, 0)
					else
						playsound(T,"sound/voice/blob6.ogg", 50, 0)
