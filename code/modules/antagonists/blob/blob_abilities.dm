...
/datum/blob_ability/spread
	...
	onUse(var/turf/T)
		...
		owner.playsound_local(owner.loc, "sound/voice/blob/blobspread[rand(1, 6)].ogg", 50, 1)
		if (!owner.starter_buff)
...
/datum/blob_ability/attack
	...
	onUse(var/turf/T)
		...
		owner.playsound_local(owner.loc, "sound/voice/blob/blob[pick("deploy", "attack")].ogg", 75, 1)
		B.attack(T)
