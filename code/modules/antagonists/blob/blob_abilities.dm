	...
	onUse(var/turf/T)
		...
		if (istype(T, /turf/space))
			...
			if (B)
				...
				if (success)
					if (prob(16))
						playsound(source, "sound/voice/blob1", 50, 0)
					else if (prob(16))
						playsound(source, "sound/voice/blob2", 50, 0)
					else if (prob(16))
						playsound(source, "sound/voice/blob3", 50, 0)
					else if (prob(16))
						playsound(source, "sound/voice/blob4", 50, 0)
					else if (prob(16))
						playsound(source, "sound/voice/blob5", 50, 0)
					else
						playsound(source, "sound/voice/blob6", 50, 0)
