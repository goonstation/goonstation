/datum/antagonist/hacker
	...
	give_equipment()
		...
		H.equip_if_possible(new /obj/item/storage/backpack/studdedblack(H), SLOT_BACK)
		...
		H.equip_if_possible(new /obj/item/swords/katana(H), SLOT_R_HAND)
		H.equip_if_possible(new /obj/item/luggable_computer/techpersonal/cyber(H), SLOT_L_HAND)
		...
		var/obj/item/card/id/syndicate/ID = new /obj/item/card/id/syndicate(H)
