			...
			if(probmult(12))
				switch (rand(1, 4))
					if (1)
						...
						boutput(H, pick(SPAN_ALERT("YOU CANT THINK IN THE DARK LIKE THIS! FIND SOME LIGHT!"), SPAN_ALERT("You hate it! ALL OF IT!</span>, <span class='alert'>Your temples pound, you cant think like this!")))
					if (2)
						H.losebreath += 2
					...
					if (3)
						H.emote("panic")
						boutput(H, pick(SPAN_ALERT("THE DARK! STAY OUT OF THE DARK!"), "<span class='alert'>What the <b>FUCK</b> was THAT?"))
					if (4)
