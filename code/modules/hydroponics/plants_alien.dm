...
/datum/plant/artifact/peeker
	...
	proc/stare_extreme(var/mob/living/M, var/obj/machinery/plantpot/POT)
		...
		if(focus_level <= 1)
			M.do_disorient(10, knockdown = 0.7 SECONDS, stunned = 0, paralysis = 0, disorient = 0.7 SECONDS, remove_stamina_below_zero = 0)
		else if(focus_level <= 2)
			M.do_disorient(30, knockdown = 1.5 SECONDS, stunned = 0, paralysis = 0, disorient = 1.5 SECONDS, remove_stamina_below_zero = 0)
			M.take_brain_damage(5)
			boutput(M, SPAN_ALERT("You feel a headache."))
		else if(focus_level <= 3)
			M.do_disorient(30, knockdown = 2 SECONDS, stunned = 0, paralysis = 0, disorient = 2 SECONDS, remove_stamina_below_zero = 0)
			...
			M.do_disorient(50, knockdown = 2.5 SECONDS, stunned = 0, paralysis = 0.5 SECONDS, disorient = 2.5 SECONDS, remove_stamina_below_zero = 0)
			M.take_brain_damage(7)
			blood_slash(M, 3)
			...
			M.do_disorient(80, knockdown = 3 SECONDS, stunned = 0, paralysis = 1 SECONDS, disorient = 3 SECONDS, remove_stamina_below_zero = 0)
			blood_slash(M, 5)
