...
/datum/ore
	...
	proc/onExcavate(var/turf/simulated/wall/auto/asteroid/AST, var/mob/user, var/mining_type)
		if (!istype(AST))
			return 1
...
/datum/ore/pharosium
	...
	events = list(/datum/ore/event/gem = 100, /datum/ore/event/fossil = 30)
	gems = list(/obj/item/raw_material/gemstone,/obj/item/raw_material/uqill,/obj/item/raw_material/fibrilith)
	fossils = list(/obj/item/fossil/pharosium)
	hardness_mod = 1
	mining_health = 160
...
/datum/ore/molitz
	...
	events = list(/datum/ore/event/gem = 100,/datum/ore/event/gem/molitz_b = 200, /datum/ore/event/fossil = 25)
	gems = list(/obj/item/raw_material/gemstone,/obj/item/raw_material/uqill,/obj/item/raw_material/fibrilith)
	fossils = list(/obj/item/fossil/molitz)
	event_chance = 20
	hardness_mod = 1
	mining_health = 160
...
/datum/ore/ice
	...
	events = list(/datum/ore/event/fossil = 25)
	fossils = list(/obj/item/fossil/ice)
	hardness_mod = -2
	mining_health = 5
	event_chance = 2
...
/datum/ore/cobryl
	...
	fossils = list(/obj/item/fossil/cobryl)
...
/datum/ore/batiline
	...
	fossils = list(/obj/item/fossil/batiline)
	tiles_per_rock_min = 4
	tiles_per_rock_max = 16
	hardness_mod = 1
	rarity_tier = 2
...
/datum/ore/syreline
	...
	events = list(/datum/ore/event/gem = 100, /datum/ore/event/rare_metal = 0.5, /datum/ore/event/fossil = 35)
	gems = list(/obj/item/raw_material/gemstone,/obj/item/raw_material/telecrystal,/obj/item/raw_material/miracle)
	fossils = list(/obj/item/fossil/syreline)
	amount_per_tile_min = 2
...
/datum/ore/cerenkite
	...
	events = list(/datum/ore/event/gem = 100,/datum/ore/event/radioactive = 100, /datum/ore/event/rare_metal = 1, /datum/ore/event/fossil = 35)
	gems = list(/obj/item/raw_material/uqill,/obj/item/raw_material/miracle)
	fossils = list(/obj/item/fossil/cerenkite)
	hardness_mod = 3
	rarity_tier = 3
	event_chance = 17
...
/datum/ore/plasmastone
	...
	events = list(/datum/ore/event/gem = 100, /datum/ore/event/rare_metal = 1, /datum/ore/event/fossil = 35)
	gems = list(/obj/item/raw_material/uqill,/obj/item/raw_material/miracle)
	fossils = list(/obj/item/fossil/plasmastone)
	hardness_mod = 2
	rarity_tier = 3
	tiles_per_rock_min = 2
	tiles_per_rock_max = 8
...
/datum/ore/koshmarite
	...
	events = list(/datum/ore/event/gem = 100, /datum/ore/event/fossil = 35)
	gems = list(/obj/item/raw_material/uqill,/obj/item/raw_material/miracle)
	fossils = list(/obj/item/fossil/koshmarite)
	event_chance = 12
	tiles_per_rock_min = 4
	tiles_per_rock_max = 16
	hardness_mod = 2
...
/datum/ore/nanite
	...
	events = list(/datum/ore/event/loot_crate = 20, /datum/ore/event/fossil = 80)
	fossils = list(/obj/item/fossil/uqill)
	event_chance = 4
