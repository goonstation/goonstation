/datum/adventure_submode/decal
	...
	"Oil" = /obj/decal/cleanable/oil, "Orb of Fire" = /obj/item/orb/fire, "Orb of Lightning" = /obj/item/orb/lightning, "Pedestal" = /obj/pedestal, "Reactor core" = /obj/fakeobject/core, \
	"Rune marks" = /obj/decal/runemarks, "Showcase cover" = /obj/cover/showcase, "Skeleton" = /obj/fakeobject/skeleton, "Stalagmite" = /obj/decal/stalagmite, "Stalagtite" = /obj/decal/stalagtite, \
