...
/client/proc/cmd_customgrenade()
	...
	if(new_grenade)
		var/obj/item/explosive/old_grenade/thing_thrower/nade = new(usr.loc)
		...
		var/obj/item/explosive/old_grenade/spawner/banana/nade = new /obj/item/explosive/old_grenade/spawner/banana(usr.loc)
		nade.payload = obj_path
		nade.name = "mysterious grenade"
		nade.desc = "There could be anything inside this."
