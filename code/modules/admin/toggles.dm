...
/client/proc/toggle_ip_alerts()
	...
	IP_alerts = !IP_alerts
	logTheThing("admin", usr, "has toggled same-IP alerts [(IP_alerts ? "On" : "Off")]")
	logTheThing("diary", usr, "has toggled same-IP alerts [(IP_alerts ? "On" : "Off")]", "admin")
...
/client/proc/cmd_admin_playermode()
	...
	logTheThing("admin", usr, "has set player mode to [(player_mode ? "On" : "Off")]")
	logTheThing("diary", usr, "has set player mode to [(player_mode ? "On" : "Off")]", "admin")
...
/client/proc/cmd_admin_godmode(mob/M as mob in world)
	...
	logTheThing("admin", usr, "has toggled [constructTarget(M,"admin")]'s nodamage to [(M.nodamage ? "On" : "Off")]")
	logTheThing("diary", usr, "has toggled [constructTarget(M,"diary")]'s nodamage to [(M.nodamage ? "On" : "Off")]", "admin")
...
/client/proc/cmd_admin_godmode_self()
	...
	logTheThing("admin", usr, "has toggled their nodamage to [(usr.nodamage ? "On" : "Off")]")
	logTheThing("diary", usr, "has toggled their nodamage to [(usr.nodamage ? "On" : "Off")]", "admin")
...
/client/proc/cmd_admin_omnipresence()
	...
	logTheThing("admin", usr, "has toggled their omnipresence to [(omnipresent ? "On" : "Off")]")
	logTheThing("diary", usr, "has toggled their omnipresence to [(omnipresent ? "On" : "Off")]", "admin")
...
/client/proc/toggle_toggles()
	...
	logTheThing("admin", usr, "toggled Toggles to [toggles_enabled].")
	logTheThing("diary", usr, "toggled Toggles to [toggles_enabled].", "admin")
...
/client/proc/toggle_force_mixed_wraith()
	...
	logTheThing("admin", usr, "toggled force mixed wraith [debug_mixed_forced_wraith ? "on" : "off"]")
	logTheThing("diary", usr, "toggled force mixed wraith [debug_mixed_forced_wraith ? "on" : "off"]")
...
/client/proc/toggle_force_mixed_blob()
	...
	logTheThing("admin", usr, "toggled force mixed blob [debug_mixed_forced_blob ? "on" : "off"]")
	logTheThing("diary", usr, "toggled force mixed blob [debug_mixed_forced_blob ? "on" : "off"]")
...
/client/proc/toggle_jobban_announcements()
	...
	logTheThing("admin", usr, "toggled Jobban Alerts to [announce_jobbans].")
	logTheThing("diary", usr, "toggled Jobban Alerts to [announce_jobbans].", "admin")
...
/client/proc/toggle_banlogin_announcements()
	...
	logTheThing("admin", usr, "toggled Banned User Alerts to [announce_banlogin].")
	logTheThing("diary", usr, "toggled Banned User Alerts to [announce_banlogin].", "admin")
...
/client/proc/toggle_literal_disarm()
	...
	logTheThing("admin", usr, "toggled literal disarming to [literal_disarm].")
	logTheThing("diary", usr, "toggled literal disarming to [literal_disarm].", "admin")
...
/datum/admins/proc/toggleooc()
	...
	logTheThing("admin", usr, "toggled OOC.")
	logTheThing("diary", usr, "toggled OOC.", "admin")
...
/datum/admins/proc/togglelooc()
	...
	logTheThing("admin", usr, "toggled LOOC.")
	logTheThing("diary", usr, "toggled LOOC.", "admin")
...
/datum/admins/proc/toggletraitorscaling()
	...
	logTheThing("admin", usr, "toggled Traitor Scaling to [traitor_scaling].")
	logTheThing("diary", usr, "toggled Traitor Scaling to [traitor_scaling].", "admin")
...
/datum/admins/proc/pcap()
	...
	logTheThing("admin", usr, "toggled player cap to [player_cap].")
	logTheThing("diary", usr, "toggled player cap to [player_cap].", "admin")
...
/datum/admins/proc/toggleenter()
	...
	logTheThing("admin", usr, "toggled new player game entering.")
	logTheThing("diary", usr, "toggled new player game entering.", "admin")
...
/datum/admins/proc/toggleAI()
	...
	logTheThing("admin", usr, "toggled AI allowed.")
	logTheThing("diary", usr, "toggled AI allowed.", "admin")
	world.update_status()
...
/datum/admins/proc/toggle_soundpref_override()
	...
	logTheThing("admin", usr, "toggled Sound Preference Override [soundpref_override ? "on" : "off"].")
	logTheThing("diary", usr, "toggled Sound Preference Override [soundpref_override ? "on" : "off"].", "admin")
...
/datum/admins/proc/toggle_respawns()
	...
	logTheThing("admin", usr, "toggled respawn to [abandon_allowed ? "On" : "Off"].")
	logTheThing("diary", usr, "toggled respawn to [abandon_allowed ? "On" : "Off"].", "admin")
	world.update_status()
...
/datum/admins/proc/toggledeadchat()
	...
	logTheThing("admin", usr, "toggled Deadchat [deadchat_allowed ? "on" : "off"].")
	logTheThing("diary", usr, "toggled Deadchat [deadchat_allowed ? "on" : "off"].", "admin")
...
/datum/admins/proc/togglefarting()
	...
	logTheThing("admin", usr, "toggled Farting [farting_allowed ? "on" : "off"].")
	logTheThing("diary", usr, "toggled Farting [farting_allowed ? "on" : "off"].", "admin")
...
/datum/admins/proc/toggle_emote_cooldowns()
	...
	logTheThing("admin", usr, "toggled emote cooldowns [!no_emote_cooldowns ? "on" : "off"].")
	logTheThing("diary", usr, "toggled emote cooldowns [!no_emote_cooldowns ? "on" : "off"].", "admin")
...
/datum/admins/proc/toggle_blood_system()
	...
	logTheThing("admin", usr, "toggled the blood system [blood_system ? "on" : "off"].")
	logTheThing("diary", usr, "toggled the blood system [blood_system ? "on" : "off"].", "admin")
...
/datum/admins/proc/toggle_bone_system()
	...
	logTheThing("admin", usr, "toggled the bone system [bone_system ? "on" : "off"].")
	logTheThing("diary", usr, "toggled the bone system [bone_system ? "on" : "off"].", "admin")
...
/datum/admins/proc/togglesuicide()
	...
	logTheThing("admin", usr, "toggled Suicides [suicide_allowed ? "on" : "off"].")
	logTheThing("diary", usr, "toggled Suicides [suicide_allowed ? "on" : "off"].", "admin")
...
/datum/admins/proc/toggleaprilfools()
	...
	logTheThing("admin", usr, "turned manual breathing [manualbreathing ? "on" : "off"] and manual blinking [manualblinking ? "on" : "off"].")
	logTheThing("diary", usr, "turned manual breathing [manualbreathing ? "on" : "off"] and manual blinking [manualblinking ? "on" : "off"].", "admin")
...
/datum/admins/proc/togglespeechpopups()
	...
	logTheThing("admin", usr, "toggled speech popups [speechpopups ? "on" : "off"].")
	logTheThing("diary", usr, "toggled speech popups [speechpopups ? "on" : "off"].", "admin")
...
/datum/admins/proc/togglemonkeyspeakhuman()
	...
	logTheThing("admin", usr, "toggled Monkey/Human communication [monkeysspeakhuman ? "on" : "off"].")
	logTheThing("diary", usr, "toggled Monkey/Human communication [monkeysspeakhuman ? "on" : "off"].", "admin")
...
/datum/admins/proc/toggletraitorsseeeachother()
	...
	logTheThing("admin", usr, "toggled traitors seeing each other [traitorsseeeachother ? "on" : "off"].")
	logTheThing("diary", usr, "toggled traitors seeing each other [traitorsseeeachother ? "on" : "off"].", "admin")
...
/datum/admins/proc/toggleautoending()
	...
	NOT_IF_TOGGLES_ARE_OFF
	no_automatic_ending = !( no_automatic_ending )
	logTheThing("admin", usr, "toggled Automatic Round End [no_automatic_ending ? "off" : "on"].")
	logTheThing("diary", usr, "toggled Automatic Round End [no_automatic_ending ? "off" : "on"].", "admin")
...
/datum/admins/proc/togglelatetraitors()
	...
	NOT_IF_TOGGLES_ARE_OFF
	late_traitors = !( late_traitors )
	logTheThing("admin", usr, "toggled late antagonists [late_traitors ? "on" : "off"].")
	logTheThing("diary", usr, "toggled late antagonists [late_traitors ? "on" : "off"].", "admin")
...
/datum/admins/proc/togglesoundwaiting()
	...
	NOT_IF_TOGGLES_ARE_OFF
	sound_waiting = !( sound_waiting )
	logTheThing("admin", usr, "toggled admin sound queue [sound_waiting ? "on" : "off"].")
	logTheThing("diary", usr, "toggled admin sound queue [sound_waiting ? "on" : "off"].", "admin")
...
/datum/admins/proc/toggle_pull_slowing()
	...
	logTheThing("admin", usr, "toggled pull slowing [pull_slowing ? "on" : "off"].")
	logTheThing("diary", usr, "toggled pull slowing [pull_slowing ? "on" : "off"].", "admin")
...
/client/proc/toggle_next_click()
	...
	logTheThing("admin", usr, "toggled next_click [disable_next_click ? "off" : "on"].")
	logTheThing("diary", usr, "toggled next_click [disable_next_click ? "off" : "on"].", "admin")
...
/client/proc/narrator_mode()
	...
	logTheThing("admin", usr, "toggled narrator mode [narrator_mode ? "on" : "off"].")
	logTheThing("diary", usr, "toggled narrator mode [narrator_mode ? "on" : "off"].", "admin")
...
/client/proc/force_desussification()
	...
	logTheThing("admin", usr, "toggled de-sussification [forced_desussification ? "on" : "off"].")
	logTheThing("diary", usr, "toggled de-sussification [forced_desussification ? "on" : "off"].", "admin")
...
/client/proc/toggle_station_name_changing()
	...
	logTheThing("admin", usr, "toggled station name changing [station_name_changing ? "on" : "off"].")
	logTheThing("diary", usr, "toggled station name changing [station_name_changing ? "on" : "off"].", "admin")
...
/client/proc/toggle_map_voting()
	...
	logTheThing("admin", usr, "toggled map voting [mapSwitcher.votingAllowed ? "on" : "off"].")
	logTheThing("diary", usr, "toggled map voting [mapSwitcher.votingAllowed ? "on" : "off"].", "admin")
...
/client/proc/waddle_walking()
	...
	logTheThing("admin", usr, "toggled waddle walking [waddle_walking ? "on" : "off"].")
	logTheThing("diary", usr, "toggled waddle walking [waddle_walking ? "on" : "off"].", "admin")
...
/client/proc/toggle_respawn_arena()
	...
	logTheThing("admin", usr, "toggled the respawn arena [respawn_arena_enabled ? "on" : "off"].")
	logTheThing("diary", usr, "toggled the respawn arena [respawn_arena_enabled ? "on" : "off"].", "admin")
...
/client/proc/toggle_vpn_blacklist()
	...
	if(rank_to_level(src.holder.rank) >= LEVEL_PA)
		...
		logTheThing("admin", src, "toggled VPN and proxy blacklisting [vpn_blacklist_enabled ? "on" : "off"].")
		logTheThing("diary", src, "toggled VPN and proxy blacklisting [vpn_blacklist_enabled ? "on" : "off"].", "admin")
...
/client/proc/toggle_spooky_light_plane()
	...
	logTheThing("admin", usr, "toggled Spooky Light Mode [spooky_light_mode ? "on at threshold [inp]" : "off"]")
	logTheThing("diary", usr, "toggled Spooky Light Mode [spooky_light_mode ? "on at threshold [inp]" : "off"]")
...
/client/proc/toggle_cloning_with_records()
	...
	logTheThing("admin", usr, "toggled the cloning with records [cloning_with_records ? "on" : "off"]")
	logTheThing("diary", usr, "toggled the cloning with records [cloning_with_records ? "on" : "off"]")
