/client/proc/dsay(msg as text)
	...
	if (src.stealth || src.alt_key)
		show_other_key = 1
	var/rendered = "<span class='deadsay'>[SPAN_PREFIX("DEAD:")] [SPAN_NAME("ADMIN([show_other_key ? src.fakekey : src.key])")] says, [SPAN_MESSAGE("\"[msg]\"")]</span>"
	var/adminrendered = "<span class='deadsay'>[SPAN_PREFIX("DEAD:")] <span class='name' data-ctx='\ref[src.mob.mind]'>[show_other_key ? "ADMIN([src.key] (as [src.fakekey])" : "ADMIN([src.key]"])</span> says, [SPAN_MESSAGE("\"[msg]\"")]</span>"
