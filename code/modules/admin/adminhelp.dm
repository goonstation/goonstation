...
//	for_no_raisin(client.mob, msg)
	...
	ircmsg["name"] = client.mob.job ? "[stripTextMacros(client.mob.real_name)] \[[dead][client.mob.mind?.special_role] [client.mob.job]]" : (istype(client.mob, /mob/new_player) ? "" : "[stripTextMacros(client.mob.real_name)] \[[dead][client.mob.mind?.special_role]]")
