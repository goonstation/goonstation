...
/datum/admins/proc/showPlayerStats(ckey)
	...
	if(src.tempmin)
		logTheThing("admin", usr, "tried to access the player stats of [constructTarget(ckey,"admin")]")
		logTheThing("diary", usr, "tried to access the player stats of [constructTarget(ckey,"diary")]", "admin")
...
/datum/admins/proc/showPlayerIPs(ckey)
	if (!ckey)
		return alert("You must provide a valid ckey.")
	if(src.tempmin)
		logTheThing("admin", usr, "tried to access the player IPs of [constructTarget(ckey,"admin")]")
		logTheThing("diary", usr, "tried to access the player IPs of [constructTarget(ckey,"diary")]", "admin")
...
/datum/admins/proc/showPlayerCompIDs(ckey)
	if (!ckey)
		return alert("You must provide a valid ckey.")
	if(src.tempmin)
		logTheThing("admin", usr, "tried to access the player compIDs of [constructTarget(ckey,"admin")]")
		logTheThing("diary", usr, "tried to access the player compIDs of [constructTarget(ckey,"diary")]", "admin")
