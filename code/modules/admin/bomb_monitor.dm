	...
	Topic(href, href_list[])
		...
		if(href_list["refresh"])
			...
			if (istype(I, /obj/item/assembly/detonator) || istype(I, /obj/item/device/transfer_valve) || istype(I, /obj/item/assembly/proximity_bomb) || istype(I, /obj/item/assembly/time_bomb/) || istype(I, /obj/item/assembly/radio_bomb/))
				...
				logTheThing("admin", usr, "made \the [I] [I:force_dud ? "into a dud" : "able to explode again"] at [log_loc(I)].")
				logTheThing("diary", usr, "made \the [I] [I:force_dud ? "into a dud" : "able to explode again"] at [log_loc(I)].", "admin")
			...
			logTheThing("admin", usr, "made \the [I] at [log_loc(I)] detonate!")
			logTheThing("diary", usr, "made \the [I] at [log_loc(I)]  detonate!", "admin")
