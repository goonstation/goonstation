	...
	proc/display_ui(var/mob/user, var/force_update = 0)
		...
		for (var/obj/item/assembly/proximity_bomb/PB in ST_prox)
			...
			temp += {"<tr>
						...
						<td>
							<a href='byond://?src=\ref[src];toggle_dud=\ref[PB]'>[PB.force_dud ? SPAN_ALERT("YES") : "No"]</a>
						</td>
						<td>
		...
		for (var/obj/item/assembly/time_bomb/TB in ST_time)
			...
			temp += {"<tr>
						...
						<td>
							<a href='byond://?src=\ref[src];toggle_dud=\ref[TB]'>[TB.force_dud ? SPAN_ALERT("YES") : "No"]</a>
						</td>
						<td>
		...
		for (var/obj/item/assembly/radio_bomb/RB in ST_radio)
			...
			temp += {"<tr>
						...
						<td>
							<a href='byond://?src=\ref[src];toggle_dud=\ref[RB]'>[RB.force_dud ? SPAN_ALERT("YES") : "No"]</a>
						</td>
						<td>
