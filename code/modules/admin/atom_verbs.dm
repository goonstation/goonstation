...
/client/proc/cmd_atom_emergency_stop()
	...
	if (!atom_emergency_stop)
		...
		logTheThing("admin", usr, "used the emergency stop command for atom verbs.")
		logTheThing("diary", usr, "used the emergency stop command for atom verbs.", "admin")
...
/client/proc/cmd_transmute_type()
	...
	if (alert(src, "Are you sure you want to transmute everything of a type?", "Confirmation", "Yes", "No") == "Yes")
		...
		logTheThing("admin", usr, "transmuted all of [transmute_path] into [mat] (details: [amount_to_transmute] things/batch, [sleep_time] sleep time)")
		logTheThing("diary", usr, "transmuted all of [transmute_path] into [mat] (details: [amount_to_transmute] things/batch, [sleep_time] sleep time)", "admin")
		...
		for (var/atom/A as anything in find_all_by_type(transmute_path))
			LAGCHECK(LAG_LOW)
			if (atom_emergency_stop)
				logTheThing("admin", usr, "type transmute command terminated due to an emergency stop.")
				logTheThing("diary", usr, "type transmute command terminated due to an emergency stop.", "admin")
		...
		logTheThing("admin", usr, "transmuted [transmute_total] of [transmute_path] into [mat].")
		logTheThing("diary", usr, "transmuted [transmute_total] of [transmute_path] into [mat].", "admin")
...
/client/proc/cmd_emag_all()
	...
	if (alert(src, "Are you sure you want to emag every fucking atom?", "Confirmation", "Yes", "No") == "Yes")
		...
		logTheThing("admin", usr, "emagged every goddamn atom (details: [amount_to_emag] things/batch, [sleep_time] sleep time)")
		logTheThing("diary", usr, "emagged every goddamn atom (details: [amount_to_emag] things/batch, [sleep_time] sleep time)", "admin")
		...
		for (var/atom/A in world)
			LAGCHECK(LAG_LOW)
			if (atom_emergency_stop)
				logTheThing("admin", usr, "emagging command terminated due to an emergency stop.")
				logTheThing("diary", usr, "emagging command terminated due to an emergency stop.", "admin")
		...
		logTheThing("admin", usr, "emagged [emagged_total] atoms.")
		logTheThing("diary", usr, "emagged [emagged_total] atoms.", "admin")
...
/client/proc/cmd_emag_type()
	...
	if (alert(src, "Are you sure you want to emag everything of a type?", "Confirmation", "Yes", "No") == "Yes")
		...
		logTheThing("admin", usr, "emagged all of [emag_path] (details: [amount_to_emag] things/batch, [sleep_time] sleep time)")
		logTheThing("diary", usr, "emagged all of [emag_path] (details: [amount_to_emag] things/batch, [sleep_time] sleep time)", "admin")
		...
		for (var/atom/A as anything in find_all_by_type(emag_path))
			LAGCHECK(LAG_LOW)
			if (atom_emergency_stop)
				logTheThing("admin", usr, "type emagging command terminated due to an emergency stop.")
				logTheThing("diary", usr, "type emagging command terminated due to an emergency stop.", "admin")
		...
		logTheThing("admin", usr, "emagged [emagged_total] of [emag_path].")
		logTheThing("diary", usr, "emagged [emagged_total] of [emag_path].", "admin")
...
/client/proc/cmd_emag_target(var/atom/target as mob|obj|turf in world)
	...
	if (target?.emag_act())
		...
		logTheThing("admin", usr, "emagged [target] via Emag Target ([log_loc(target)] in [target.loc])")
		logTheThing("diary", usr, "emagged [target] via Emag Target ([log_loc(target)] in [target.loc])", "admin")
...
/client/proc/cmd_scale_all()
	...
	if (alert(src, "Are you sure you want to scale every fucking atom?", "Confirmation", "Yes", "No") == "Yes")
		...
		logTheThing("admin", usr, "scaled every goddamn atom (details: X:[scalex], Y:[scaley], [amount_to_scale] things/batch, [sleep_time] sleep time)")
		logTheThing("diary", usr, "scaled every goddamn atom (details: X:[scalex], Y:[scaley], [amount_to_scale] things/batch, [sleep_time] sleep time)", "admin")
		...
		for (var/atom/A in world)
			LAGCHECK(LAG_LOW)
			if (atom_emergency_stop)
				logTheThing("admin", usr, "scaling command terminated due to an emergency stop.")
				logTheThing("diary", usr, "scaling command terminated due to an emergency stop.", "admin")
		...
		logTheThing("admin", usr, "scaled [scaled_total] atoms.")
		logTheThing("diary", usr, "scaled [scaled_total] atoms.", "admin")
...
/client/proc/cmd_scale_type()
	...
	if (alert(src, "Are you sure you want to scale everything of a type?", "Confirmation", "Yes", "No") == "Yes")
		...
		logTheThing("admin", usr, "scaled all of [scale_path] (details: X:[scalex], Y:[scaley], [amount_to_scale] things/batch, [sleep_time] sleep time)")
		logTheThing("diary", usr, "scaled all of [scale_path] (details: X:[scalex], Y:[scaley], [amount_to_scale] things/batch, [sleep_time] sleep time)", "admin")
		...
		for (var/atom/A as anything in find_all_by_type(scale_path))
			LAGCHECK(LAG_LOW)
			if (atom_emergency_stop)
				logTheThing("admin", usr, "type scaling command terminated due to an emergency stop.")
				logTheThing("diary", usr, "type scaling command terminated due to an emergency stop.", "admin")
		...
		logTheThing("admin", usr, "scaled [scaled_total] of [scale_path].")
		logTheThing("diary", usr, "scaled [scaled_total] of [scale_path].", "admin")
...
/client/proc/cmd_scale_target(var/atom/target as mob|obj|turf in world)
	...
	logTheThing("admin", usr, "scaled [target] by X:[scalex] Y:[scaley] ([log_loc(target)] in [target.loc])")
	logTheThing("diary", usr, "scaled [target] by X:[scalex] Y:[scaley] ([log_loc(target)] in [target.loc])", "admin")
...
/client/proc/cmd_rotate_all()
	...
	if (alert(src, "Are you sure you want to rotate every fucking atom?", "Confirmation", "Yes", "No") == "Yes")
		...
		logTheThing("admin", usr, "rotated every goddamn atom (details: [rot] rotation, [amount_to_rotate] things/batch, [sleep_time] sleep time)")
		logTheThing("diary", usr, "rotated every goddamn atom (details: [rot] rotation, [amount_to_rotate] things/batch, [sleep_time] sleep time)", "admin")
		...
		for (var/atom/A in world)
			LAGCHECK(LAG_LOW)
			if (atom_emergency_stop)
				logTheThing("admin", usr, "rotating command terminated due to an emergency stop.")
				logTheThing("diary", usr, "rotating command terminated due to an emergency stop.", "admin")
		...
		logTheThing("admin", usr, "rotated [rotated_total] atoms.")
		logTheThing("diary", usr, "rotated [rotated_total] atoms.", "admin")
...
/client/proc/cmd_rotate_type()
	...
	if (alert(src, "Are you sure you want to rotate everything of a type?", "Confirmation", "Yes", "No") == "Yes")
		...
		logTheThing("admin", usr, "rotated all of [rotate_path] (details: [rot] rotation, [amount_to_rotate] things/batch, [sleep_time] sleep time)")
		logTheThing("diary", usr, "rotated all of [rotate_path] (details: [rot] rotation, [amount_to_rotate] things/batch, [sleep_time] sleep time)", "admin")
		...
		for (var/atom/A as anything in find_all_by_type(rotate_path))
			LAGCHECK(LAG_LOW)
			if (atom_emergency_stop)
				logTheThing("admin", usr, "type rotating command terminated due to an emergency stop.")
				logTheThing("diary", usr, "type rotating command terminated due to an emergency stop.", "admin")
		...
		logTheThing("admin", usr, "rotated [rotated_total] of [rotate_path].")
		logTheThing("diary", usr, "rotated [rotated_total] of [rotate_path].", "admin")
...
/client/proc/cmd_rotate_target(var/atom/target as mob|obj|turf in world)
	...
	logTheThing("admin", usr, "rotated [target] by [rot] degrees ([log_loc(target)] in [target.loc])")
	logTheThing("diary", usr, "rotated [target] by [rot] degrees ([log_loc(target)] in [target.loc])", "admin")
...
/client/proc/cmd_spin_all()
	...
	if (alert(src, "Are you sure you want to spin every fucking atom?", "Confirmation", "Yes", "No") == "Yes")
		...
		logTheThing("admin", usr, "spun every goddamn atom (details: [direction] direction, [time] animate time, [looping] looping, [amount_to_spin] atoms/batch, [sleep_time] sleep time)")
		logTheThing("diary", usr, "spun every goddamn atom (details: [direction] direction, [time] animate time, [looping] looping, [amount_to_spin] atoms/batch, [sleep_time] sleep time)", "admin")
		...
		for (var/atom/A in world)
			LAGCHECK(LAG_LOW)
			if (atom_emergency_stop)
				logTheThing("admin", usr, "spinning command terminated due to an emergency stop.")
				logTheThing("diary", usr, "spinning command terminated due to an emergency stop.", "admin")
		...
		logTheThing("admin", usr, "spun [spun_total] atoms.")
		logTheThing("diary", usr, "spun [spun_total] atoms.", "admin")
...
/client/proc/cmd_spin_type()
	...
	if (alert(src, "Are you sure you want to spin everything of a type?", "Confirmation", "Yes", "No") == "Yes")
		...
		logTheThing("admin", usr, "spun all of [spin_path] (details: [direction] direction, [time] animate time, [looping] looping, [amount_to_spin] things/batch, [sleep_time] sleep time)")
		logTheThing("diary", usr, "spun all of [spin_path] (details: [direction] direction, [time] animate time, [looping] looping, [amount_to_spin] things/batch, [sleep_time] sleep time)", "admin")
		...
		for (var/atom/A as anything in find_all_by_type(spin_path))
			LAGCHECK(LAG_LOW)
			if (atom_emergency_stop)
				logTheThing("admin", usr, "type spinning command terminated due to an emergency stop.")
				logTheThing("diary", usr, "type spinning command terminated due to an emergency stop.", "admin")
		...
		logTheThing("admin", usr, "spun [spun_total] of [spin_path].")
		logTheThing("diary", usr, "spun [spun_total] of [spin_path].", "admin")
...
/client/proc/cmd_spin_target(var/atom/target as mob|obj|turf in world)
	...
	logTheThing("admin", usr, "spun [target] (details: [direction] direction, [time] animate time, [looping] looping, [log_loc(target)] in [target.loc])")
	logTheThing("diary", usr, "spun [target] (details: [direction] direction, [time] animate time, [looping] looping, [log_loc(target)] in [target.loc]))", "admin")
...
/client/proc/cmd_get_all()
	...
	if (alert(src, "Are you sure you want to get fucking object and mob and bring it to your tile?", "YOU WILL REGRET THIS", "Yes", "No") == "Yes")
		...
		logTheThing("admin", usr, "teleported every goddamn obj/mob to them (details: [amount_to_get] things/batch, [sleep_time] sleep time)")
		logTheThing("diary", usr, "teleported every goddamn obj/mob to them (details: [amount_to_get] things/batch, [sleep_time] sleep time)", "admin")
		...
		for (var/atom/A in world)
			LAGCHECK(LAG_LOW)
			if (atom_emergency_stop)
				logTheThing("admin", usr, "teleport command terminated due to an emergency stop.")
				logTheThing("diary", usr, "teleport command terminated due to an emergency stop.", "admin")
		...
		logTheThing("admin", usr, "teleported [gotten_total] objs/mobs.")
		logTheThing("diary", usr, "teleported [gotten_total] objs/mobs.", "admin")
...
/client/proc/cmd_get_type()
	...
	if (alert(src, "Are you sure you want to teleport everything of a type to your tile?", "Confirmation", "Yes", "No") == "Yes")
		...
		logTheThing("admin", usr, "teleported all of [get_path] to themselves (details: [amount_to_get] things/batch, [sleep_time] sleep time)")
		logTheThing("diary", usr, "teleported all of [get_path] to themselves (details: [amount_to_get] things/batch, [sleep_time] sleep time)", "admin")
		...
		logTheThing("admin", usr, "teleported [gotten_total] of [get_path].")
		logTheThing("diary", usr, "teleported [gotten_total] of [get_path].", "admin")
