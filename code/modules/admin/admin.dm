				...
				switch(href_list["type"])
					if("check_antagonist")
						if (ticker?.mode && current_state >= GAME_STATE_PLAYING)
							#define isdeadantag(M) (isdead(M) || (isVRghost(M) || isghostcritter(M) || inafterlife(M) || isghostdrone(M)))
							...
							if (istype(ticker.mode, /datum/game_mode/nuclear))
								...
								for(var/datum/mind/N in NN.syndicates)
									var/mob/M = N.current
									if(!M) continue
									dat += "<tr><td><a href='?src=\ref[src];action=adminplayeropts;target=\ref[M]'>[M.real_name]</a>[M.client ? "" : " <i>(logged out)</i>"][isdeadantag(M) ? " <b><font color=red>(DEAD)</font></b>" : ""]</td>"
								...
								for(var/datum/mind/N in ticker.mode:head_revolutionaries)
									var/mob/M = N.current
									if(!M) continue
									dat += "<tr><td><a href='?src=\ref[src];action=adminplayeropts;target=\ref[M]'>[M.real_name]</a> <b>(Leader)</b>[M.client ? "" : " <i>(logged out)</i>"][isdeadantag(M) ? " <b><font color=red>(DEAD)</font></b>" : ""]</td>"
									dat += "<td><a href='?action=priv_msg&target=[M.ckey]'>PM</A></td></tr>"
								...
								if(length(spymode.leaders))
									...
									for(var/datum/mind/leader in spymode.leaders)
										...
										if(!M) continue
										dat += "<tr><td><a href='?src=\ref[src];action=adminplayeropts;target=\ref[M]'>[key_name(M)]</a>[M.client ? "" : " <i>(logged out)</i>"][isdeadantag(M) ? " <b><font color=red>(DEAD)</font></b>" : ""]</td>"
										dat += "<td><a href='?action=priv_msg&target=[M.ckey]'>PM</A></td>"
									...
									for(var/datum/mind/leader in gangmode.leaders)
										...
										for(var/datum/mind/member in gang.members)
											if(member.current != null)
												dat += "<tr><td><a href='?src=\ref[src];action=adminplayeropts;target=\ref[M]'>[key_name(member.current)]</a>[member.current.client ? "" : " <i>(logged out)</i>"][isdeadantag(member.current) ? " <b><font color=red>(DEAD)</font></b>" : ""]</td>"
