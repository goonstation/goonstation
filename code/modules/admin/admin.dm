		...
		if ("c_mode_panel") // I removed some broken/discontinued game modes here (Convair880).
			if (src.level >= LEVEL_SA)
				...
				var/list/dat = list({"
							...
							<A href='byond://?src=\ref[src];action=[cmd];type=intrigue'>Secret: Intrigue</A><br>
							"})
...
/datum/admins/proc/Game()
	...
	dat += {"<hr><div class='optionGroup' style='border-color:#77DD77'><b class='title' style='background:#77DD77'>Logs</b>
				...
				<A href='byond://?src=\ref[src];action=view_logs;type=[LOG_PATHOLOGY]_log'>Pathology Log</A>
				<A href='byond://?src=\ref[src];action=view_logs;type=[LOG_PATHOLOGY]_log_string'><small>(Search)</small></A>
				<A href='byond://?src=\ref[src];action=view_logs_pathology_strain'><small>(Find pathogen)</small></A><BR>
