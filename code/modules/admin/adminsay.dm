/client/proc/cmd_admin_say(msg as text)
	...
	logTheThing("admin", src, "ASAY: [msg]")
	logTheThing("diary", src, "ASAY: [msg]", "admin")
...
/client/proc/cmd_admin_forceallsay(msg as text)
	...
	logTheThing("admin", usr, "forced everyone to say: [msg]")
	logTheThing("diary", usr, "forced everyone to say: [msg]", "admin")
...
/client/proc/cmd_admin_murraysay(msg as text)
	...
	logTheThing("admin", usr, "forced Murray to beep: [msg]")
	logTheThing("diary", usr, "forced Murray to beep: [msg]", "admin")
...
/client/proc/cmd_admin_hssay(msg as text)
	...
	for (var/obj/machinery/bot/medbot/head_surgeon/maybeHS in machine_registry[MACHINES_BOTS])
		maybeHS.speak(msg)
		logTheThing("admin", usr, "forced HeadSurgeon to beep: [msg]")
		logTheThing("diary", usr, "forced HeadSurgeon: [msg]", "admin")
...
/client/proc/cmd_admin_bradsay(msg as text)
	...
	logTheThing("admin", usr, "forced Bradbury II to beep: [msg]")
	logTheThing("diary", usr, "forced Bradbury II to beep: [msg]", "admin")
...
/client/proc/cmd_admin_beepsay(msg as text)
	...
	logTheThing("admin", usr, "forced Beepsky to beep: [msg]")
	logTheThing("diary", usr, "forced Beepsky to beep: [msg]", "admin")
