/datum/ailment/disease/respiratory_failure
	...
	info = "The patient's respiratory system is starting to fail."
	cure_flags = (CURE_MEDICINE | CURE_ORGAN_REPLACEMENT)
	cure_desc = "Oxygen-healing drugs" // indirectly cured by filgrastim/salbutamol/perfluorodecalin via organ healing
