...
/obj/machinery/genetics_booth
	...
	proc/notify_sale(var/budget_inc, var/split_with = 0)
		...
		pdaSignal.data = list("address_1"="00000000", "command"="text_message", "sender_name"="GENEBOOTH-MAILBOT", "tag" = PDA_GENETICS_ALERT_TAG, "group"=MGD_MEDRESEACH, "sender"="00000000", "message"=string)
