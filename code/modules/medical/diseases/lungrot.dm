/datum/ailment/disease/lungrot
	...
	cure = "Robustissin application after ablation of salbutamol."
...
/datum/ailment/disease/lungrot/stage_act(var/mob/living/affected_mob, var/datum/ailment_data/affecting_ailment, mult)
	...
	if (affected_mob.reagents.get_reagent_amount("salbutamol") > 0)
		...
		affecting_ailment.recureprob = 15
	...
	switch(affecting_ailment.stage)
	...
	if (affecting_ailment.stage > 2 && !did_cough && probmult(10) && (!ON_COOLDOWN(affected_mob, "lungrot_message", 25 SECONDS)))
