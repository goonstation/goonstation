			...
			if(probmult(40))
				...
				for(var/i in 1 to 10)
					...
					if(replacing_organ in list("heart", "left_lung","right_lung","left_kidney","right_kidney","liver","spleen","pancreas","stomach","intestines","appendix"))
						...
						var/obj/item/mob_part/humanoid_part/silicon_part/O = H?.limbs.get_limb(replacing_organ)
				...
				switch(replacing_organ)
					...
					if("r_leg")
						H?.limbs.r_leg.sever()
						H?.limbs.replace_with("r_leg", /obj/item/mob_part/humanoid_part/silicon_part/leg/right/standard, null , 0)
						boutput(affected_mob, SPAN_ALERT("Your right leg falls off as a robotic version grows in its place!"))
						affected_mob.emote("scream")
					if("l_leg")
						H?.limbs.l_leg.sever()
						H?.limbs.replace_with("l_leg", /obj/item/mob_part/humanoid_part/silicon_part/leg/left/standard, null , 0)
						boutput(affected_mob, SPAN_ALERT("Your left leg falls off as a robotic version grows in its place!"))
						affected_mob.emote("scream")
					if("r_arm")
						H?.limbs.r_arm.sever()
						H?.limbs.replace_with("r_arm", /obj/item/mob_part/humanoid_part/silicon_part/arm/right/standard, null , 0)
						boutput(affected_mob, SPAN_ALERT("Your right arm falls off as a robotic version grows in its place!"))
						affected_mob.emote("scream")
					if("l_arm")
						H?.limbs.l_arm.sever()
						H?.limbs.replace_with("l_arm", /obj/item/mob_part/humanoid_part/silicon_part/arm/left/standard, null , 0)
