	...
	switch(D.stage)
		...
		if(3)
			...
			if (prob(10))
				boutput(affected_mob, "Your skin feels loose.")
			if (prob(4))
				boutput(affected_mob, "<span style=\"color:red\">You feel a stabbing pain in your abdomen.</span>")
				affected_mob.changeStatus("paralysis", 40)
			if (prob(4))
				boutput(affected_mob, "<span style=\"color:red\">You can feel something move...inside.</span>")
		if(4)
			if (prob(10))
				boutput(affected_mob, "<span style=\"color:red\">Your insides twist and squirm!</span>")
			if (prob(20))
				affected_mob.say(pick("beep, beep!", "Boop bop boop beep.", "Oh god I can feel it moving inside me", "The pain!"))
			if (prob(8))
				boutput(affected_mob, "<span style=\"color:red\">You can feel... something...inside you.</span>")
		if(5)
			boutput(affected_mob, "<span style=\"color:red\">It feels like something is stabbing you!</span>")
			if(prob(40))
				...
				switch(replacing_organ)
					if("heart")
						if(istype(affected_mob.organHolder.get_organ("heart"),/obj/item/organ/heart/cyber))
							...
							boutput(affected_mob, "<span style=\"color:red\">Your heart is painfully pushed out of your body!</span>")
					...
					if("left_lung")
						if(istype(affected_mob.organHolder.get_organ("left_lung"),/obj/item/organ/lung/cyber))
							...
							boutput(affected_mob, "<span style=\"color:red\">One of your lungs is painfully pushed out of your body!</span>")
							affected_mob.emote("scream")
					if("right_lung")
					...
					if("left_kidney")
						if(istype(affected_mob.organHolder.get_organ("left_kidney"),/obj/item/organ/kidney/cyber))
							...
							boutput(affected_mob, "<span style=\"color:red\">One of your kidneys is painfully pushed out of your body!</span>")
							affected_mob.emote("scream")
					if("right_kidney")
					...
					if("liver")
						if(istype(affected_mob.organHolder.get_organ("liver"),/obj/item/organ/liver/cyber))
							...
							boutput(affected_mob, "<span style=\"color:red\">Your liver is painfully pushed out of your body!</span>")
							affected_mob.emote("scream")
					if("spleen")
						if(istype(affected_mob.organHolder.get_organ("spleen"),/obj/item/organ/spleen/cyber))
							...
							boutput(affected_mob, "<span style=\"color:red\">Your spleen is painfully pushed out of your body!</span>")
							affected_mob.emote("scream")
					if("stomach")
						if(istype(affected_mob.organHolder.get_organ("stomach"),/obj/item/organ/stomach/cyber))
							...
							boutput(affected_mob, "<span style=\"color:red\">Your stomach is painfully pushed out of your body!</span>")
							affected_mob.emote("scream")
					if("intestines")
						if(istype(affected_mob.organHolder.get_organ("intestines"),/obj/item/organ/intestines/cyber))
							...
							boutput(affected_mob, "<span style=\"color:red\">Your intestines are painfully pushed out of your body!</span>")
							affected_mob.emote("scream")
					if("appendix")
						if(istype(affected_mob.organHolder.get_organ("appendix"),/obj/item/organ/appendix/cyber))
							...
							boutput(affected_mob, "<span style=\"color:red\">Your appendix is painfully pushed out of your body!</span>")
							affected_mob.emote("scream")
					if("butt") // lol butts
