	...
	switch(D.stage)
		...
		if(5)
			...
			if(prob(40)) //So everyone can feel like robot Seth Brundle
				...
				if (ismonkey(affected_mob) || jobban_isbanned(affected_mob, "Cyborg") || (affected_mob.traitHolder && affected_mob.traitHolder.hasTrait("electronicincompatibility") || isvirtual(affected_mob)))
