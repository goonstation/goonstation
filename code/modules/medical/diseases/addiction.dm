	...
	switch(D.stage)
		...
		if (3)
			...
			if (prob(8))
				affected_mob.emote("shiver")
			if (prob(4))
				boutput(affected_mob, "<span style='color:red'>Your head hurts.</span>")
			if (prob(4))
		...
		if (4)
			...
			if (prob(4))
				boutput(affected_mob, "<span style='color:red'>You have a pounding headache.</span>")
			if (prob(4))
		...
		if (5)
			...
			if (prob(4))
				boutput(affected_mob, "<span style='color:red'>Your head is killing you!</span>")
			if (prob(5))
