/datum/ailment/disease/royalest_bee_fever
	name = "Royalest Bee Fever"
	max_stages = 5 //bigger bee, more stages
	spread = "Non-Contagious"
	cure = "Garlic"
	associated_reagent = "royalest_be_bee"
	reagentcure = list("juice_garlic") //bees don't like garlic, apparently
	affected_species = list("Human")

/datum/ailment/disease/royalest_bee_fever/stage_act(var/mob/living/affected_mob,var/datum/ailment_data/D)
	if (..())
		return
	switch(D.stage)
		if(1)
		...
		if(5)
			boutput(affected_mob, "<span class='alert'>You feel your physical form condensing into something massive, floating, and yellow... What?</span>")
			affected_mob.visible_message("<span class='alert'><b>[affected_mob] transforms!</b></span>")
			affected_mob.unequip_all()
			affected_mob.make_critter(/mob/living/critter/small_animal/bee/queen/omega, affected_mob)
