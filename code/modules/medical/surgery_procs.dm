...
/proc/calc_screw_up_prob(var/mob/living/carbon/human/patient as mob, var/mob/surgeon as mob, var/screw_up_prob = 25)
	...
	if (surgeon.traitHolder.hasTrait("training_medical"))
		screw_up_prob = clamp(100, 0, screw_up_prob) // if they're a doctor they can have no chance to mess up
	else
		screw_up_prob = clamp(100, 5, screw_up_prob) // otherwise there'll always be a slight chance
