...
/datum/materialProc/radioactive_temp
	...
	execute(var/atom/owner, var/temp)
		...
		if (radioactive)
			I.material.setProperty(MATERIAL_PROPERTY_RADIOACTIVE, radioactive - min(radioactive, moles_to_convert/(10*I.amount)))
		else
			I.material.removeProperty(MATERIAL_PROPERTY_RADIOACTIVE)
		if (n_radioactive)
			I.material.setProperty(MATERIAL_PROPERTY_N_RADIOACTIVE, n_radioactive - min(n_radioactive, moles_to_convert/(50*I.amount)))
		else
			I.material.removeProperty(MATERIAL_PROPERTY_N_RADIOACTIVE)
