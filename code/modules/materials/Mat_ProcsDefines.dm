...
/atom/proc/onMaterialChanged()
	if(istype(src.material))
		explosion_resistance = material.hasProperty("tough") ? round(material.getProperty("tough") / 3) : explosion_resistance
		explosion_protection = material.hasProperty("tough") ? round(material.getProperty("tough") / 3) : explosion_protection
