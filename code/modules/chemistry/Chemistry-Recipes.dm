...
/*
	...
	cocktail_michelada
		...
		id = "michelada"
		result = "michelada"
		required_reagents = list("beer" = 1, "juice_tomato" = 1, "juice_chili" = 1)
		result_amount = 3
	...
	cocktail_pfire
		...
		id = "pfire"
		result = "pfire"
		required_reagents = list("tequila" = 1, "juice_chili" = 1)
		result_amount = 2
	...
	spiced_rum
		...
		id = "spicedrum"
		result = "spicedrum"
		required_reagents = list("rum" = 1, "juice_chili" = 1)
		result_amount = 2
	...
	mexicanhotchocolate
		...
		required_reagents = list("juice_chili" = 1, "chocolate_milk"= 2)
		result_amount = 3
