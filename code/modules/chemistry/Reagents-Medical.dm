...
datum
	reagent
		...
		medical/omnizine // COGWERKS CHEM REVISION PROJECT. magic drug, ought to use plasma or something
			...
			overdose = 30
			value = 22
			target_organs = list("brain", "left_eye", "right_eye", "heart", "left_lung", "right_lung", "left_kidney", "right_kidney", "liver", "stomach", "intestines", "spleen", "pancreas", "appendix", "tail", "augmentation_nerve")	//RN this is all the organs. Probably I'll remove some from this list later.
		...
		medical/cryoxadone // COGWERKS CHEM REVISION PROJECT. magic drug, but isn't working right correctly
			...
			transparency = 255
			value = 12 // 5 3 3 1
			target_organs = list("left_eye", "right_eye", "heart", "left_lung", "right_lung", "left_kidney", "right_kidney", "liver", "stomach", "intestines", "spleen", "pancreas", "appendix", "tail", "augmentation_nerve")	//RN this is all the organs. Probably I'll remove some from this list later. no "brain",  either
