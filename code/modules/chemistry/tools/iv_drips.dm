...
/obj/item/reagent_containers/iv_drip/process(mob/living/carbon/human/H)
...
/obj/item/reagent_containers/iv_drip/proc/insert_needle(mob/living/carbon/human/H, mob/living/carbon/user)
	src.patient = H
