...
/obj/item/reagent_containers/iv_drip
	...
	attack(mob/living/carbon/M, mob/living/carbon/user)
		...
		if (in_use && src.patient)
			...
			logTheThing("combat", user, "tries to hook up an IV drip [log_reagents(src)] to [constructTarget(H,"combat")] at [log_loc(user)].")
	...
	proc/insert_needle(var/mob/living/carbon/human/H as mob, mob/living/carbon/user as mob)
		...
		logTheThing("combat", user, "connects an IV drip [log_reagents(src)] to [constructTarget(H,"combat")] at [log_loc(user)].")
