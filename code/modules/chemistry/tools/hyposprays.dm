...
/obj/item/reagent_containers/hypospray
	...
	attack(mob/M, mob/user, def_zone)
		...
		logTheThing("combat", user, "uses a hypospray [log_reagents(src)] to inject [constructTarget(M,"combat")] at [log_loc(user)].")
	...
	afterattack(obj/target, mob/user, flag)
		if (isobj(target) && target.is_open_container() && target.reagents)
			...
			logTheThing("combat", user, "dumps the contents of [src] [log_reagents(src)] into [target] at [log_loc(user)].")
