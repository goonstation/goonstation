...
/proc/build_chem_structure()
	...
	logTheThing("debug", null, "<B>SpyGuy/chem_struct</B> Finished building reaction structure. Took [(world.timeofday - startTime)/10] seconds.")
...
/proc/build_reagent_cache()
	...
	logTheThing("debug", null, "<B>SpyGuy/reagents_cache</B> Finished building reagents cache. Took [(world.timeofday - startTime)/10] seconds.")
