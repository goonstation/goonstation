	...
	ui_act(action, list/params, datum/tgui/ui, datum/ui_state/state)
		switch (action)
			...
			if ("submit")
				...
				pdaSignal.data = list("address_1"="00000000", "command"="text_message", "sender_name"="CHEM-SUPPLY",  "group"=MGD_SCIENCE, "alert"=MGA_CREWREQUEST, "sender"="00000000", "message"="New chemical request received.")
