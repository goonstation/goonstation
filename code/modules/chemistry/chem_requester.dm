	...
	ui_act(action, list/params, datum/tgui/ui, datum/ui_state/state)
		switch (action)
			...
			if ("submit")
				...
				pdaSignal.data = list("address_1"="00000000", "command"="text_message", "sender_name"="CHEM-SUPPLY",  "group"=MGD_SCIENCE, "topic"=MSG_TOPIC_REQUEST, "sender"="00000000", "message"="Notification: new chemical request received.")
