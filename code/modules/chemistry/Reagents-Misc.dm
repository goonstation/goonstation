		...
		super_hairgrownium //moustache madness
			...
			on_mob_life(var/mob/M, var/mult = 1)
				...
				if (ishuman(M))
					...
					var/mob/living/carbon/human/H = M
					if (H.bioHolder.mobAppearance.customizations[1].style.id != "80s")
						H.bioHolder.mobAppearance.customizations[1].style =  new /datum/customization_style/hair/long/eighties
						somethingchanged = 1
					if (H.gender == MALE && H.bioHolder.mobAppearance.customizations[2].style.id != "longbeard")
						H.bioHolder.mobAppearance.customizations[2].style =  new /datum/customization_style/beard/longbeard
						somethingchanged = 1
