		...
		miasma
			...
			on_add()
				...
				if(holder.get_reagent_amount("lavender_essence") > 0)
					var/miasmaunits = ((holder.get_reagent_amount("miasma")/2) - holder.get_reagent_amount("lavender_essence"))
					if(miasmaunits >= 0)
						holder.del_reagent("lavender_essence")
						holder.del_reagent("miasma")
						holder.add_reagent("miasma", (miasmaunits/2))
					if(miasmaunits < 0)
						holder.del_reagent("miasma")
						holder.del_reagent("lavender_essence")
						holder.add_reagent("lavender_essence", (abs(miasmaunits)))
