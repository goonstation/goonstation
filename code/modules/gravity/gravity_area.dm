...
/area/var/gforce_minimum = GFORCE_EARTH_GRAVITY
...
/area/abandonedmedicalship/robot_trader/gforce_minimum = GFORCE_EARTH_GRAVITY // TODO: Move D.O.C. area to an ISS subtype
