...
/// Need to recalculate area quaivty .!!
/area/var/gforce_dirty = TRUE
...
/datum/infooverlay/gravity_area
	...
	GetInfo(turf/theTurf, image/debugoverlay/img)
		...
		img.app.overlays = list(
			src.makeText("<span style='font-size:6pt'>[A.gforce_minimum]+[A.gforce_tether]<br>=[A.gforce_minimum + A.gforce_tether]</span>")
		)
