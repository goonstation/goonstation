...
/obj/machinery/vending/janitor
	...
	create_products(restocked)
		...
		product_list += new/datum/data/vending_product(/obj/item/device/pda_module/alert/janitor, 2)
...
/obj/machinery/vending/jobclothing/medical
	...
	create_products(restocked)
		...
		product_list += new/datum/data/vending_product(/obj/item/device/pda_module/alert/medical, 2)
...
/obj/machinery/vending/jobclothing/engineering
	...
	create_products(restocked)
		...
		product_list += new/datum/data/vending_product(/obj/item/device/pda_module/alert/engineering, 2)
