...
/obj/machinery/vending/cola
	...
	red
		...
		create_products()
			...
			product_list += new/datum/data/vending_product(/obj/item/reagent_containers/food/drinks/cola/random, rand(1, 5), cost=PAY_UNTRAINED/10, hidden = 1) //does this even work??
