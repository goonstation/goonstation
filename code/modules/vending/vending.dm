...
/obj/machinery/vending/coffee
	...
	create_products(restocked)
		..()
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/food/drinks/coffee, 25, cost = PRICE_30)
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/food/drinks/tea, 10, cost = PRICE_30)
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/food/drinks/bottle/soda/xmas, 10, cost = PRICE_30)
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/food/snacks/ingredient/yerba, 10, cost = PRICE_50)
		...
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/food/drinks/fruitmilk, 10, cost = PRICE_30)
		...
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/food/drinks/cola, rand(1, 6), cost = PRICE_30, hidden=1)

#ifdef SEASON_AUTUMN
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/food/drinks/ddpumpkinspicelatte, 15, cost = PRICE_30)
...
/obj/machinery/vending/snack
	...
	create_products(restocked)
		...
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/food/snacks/donut, 10, cost = PRICE_15)
		...
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/food/snacks/fries, 10, cost = PRICE_20)
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/food/drinks/noodlecup, 10, cost = PRICE_18_75)
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/food/snacks/burrito, 10, cost = PRICE_18_75)
		product_list += new/datum/data/vending_product(/obj/item/popsicle, 10, cost = PRICE_18_75)
		product_list += new/datum/data/vending_product(/obj/item/kitchen/plasticpackage, 10, cost = PRICE_15)
		product_list += new/datum/data/vending_product(/obj/item/kitchen/utensil/fork/plastic, 10, cost = PRICE_15)
		product_list += new/datum/data/vending_product(/obj/item/kitchen/utensil/spoon/plastic, 10, cost = PRICE_15)
		product_list += new/datum/data/vending_product(/obj/item/kitchen/utensil/knife/plastic, 10, cost = PRICE_15)
		product_list += new/datum/data/vending_product(/obj/item/tvdinner, 10, cost = PRICE_25)
...
/obj/machinery/vending/cigarette
	...
	create_products(restocked)
		..()
		product_list += new/datum/data/vending_product(/obj/item/cigpacket, 20, cost = PRICE_30)
		product_list += new/datum/data/vending_product(/obj/item/cigpacket/nicofree, 10, cost = PRICE_30)
		product_list += new/datum/data/vending_product(/obj/item/cigpacket/menthol, 10, cost = PRICE_30)
		...
		product_list += new/datum/data/vending_product(/obj/item/device/light/zippo, 5, cost = PRICE_30)
		product_list += new/datum/data/vending_product(/obj/item/decoration/ashtray, 5, cost = PRICE_30)
		...
		product_list += new/datum/data/vending_product(/obj/item/paper, 20, cost = PRICE_15)

		product_list += new/datum/data/vending_product(/obj/item/device/igniter, rand(1, 6), hidden=1, cost = PRICE_30)
...
/obj/machinery/vending/medical_public
	...
	create_products(restocked)
		...
		product_list += new/datum/data/vending_product(/obj/item/bandage, 5, cost = PRICE_30)
		product_list += new/datum/data/vending_product(/obj/item/clothing/mask/surgical, 5, cost = PRICE_30)
		product_list += new/datum/data/vending_product(/obj/item/clothing/gloves/latex, 5, cost = PRICE_30)
		...
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/patch/mini/synthflesh, rand(0, 5), hidden=1, cost = PRICE_75)
		...
		if (prob(15))
			product_list += new/datum/data/vending_product(/obj/item/reagent_containers/food/drinks/coffee, rand(1,5), hidden=1, cost = PRICE_30)
		else
...
/obj/machinery/vending/cola
	...
	create_products(restocked)
		..()
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/food/drinks/cola, 10, cost = PRICE_15)
		product_list += new/datum/data/vending_product(/obj/item/canned_laughter, rand(1,5), cost = PRICE_30,hidden=1)
		if(prob(25))
			product_list += new/datum/data/vending_product(/obj/item/reagent_containers/food/drinks/bottle/soda/softsoft_pizza, rand(1, 3), cost = PRICE_30, hidden = 1)
	...
	red
		...
		create_products(restocked)
			..()
			product_list += new/datum/data/vending_product(/obj/item/reagent_containers/food/drinks/bottle/soda/red, 10, cost = PRICE_15)
			product_list += new/datum/data/vending_product(/obj/item/reagent_containers/food/drinks/bottle/soda/pink, 10, cost = PRICE_25)
			product_list += new/datum/data/vending_product(/obj/item/reagent_containers/food/drinks/bottle/soda/lime, 10, cost = PRICE_25)
			product_list += new/datum/data/vending_product(/obj/item/reagent_containers/food/drinks/bottle/soda/grones, 10, cost = PRICE_25)
			product_list += new/datum/data/vending_product(/obj/item/reagent_containers/food/drinks/bottle/soda/bottledwater, 10, cost = PRICE_37_5)
	...
	blue
		...
		create_products(restocked)
			..()
			product_list += new/datum/data/vending_product(/obj/item/reagent_containers/food/drinks/bottle/soda/blue, 10, cost = PRICE_15)
			product_list += new/datum/data/vending_product(/obj/item/reagent_containers/food/drinks/bottle/soda/orange, 10, cost = PRICE_25)
			product_list += new/datum/data/vending_product(/obj/item/reagent_containers/food/drinks/bottle/soda/spooky, 10, cost = PRICE_25)
			product_list += new/datum/data/vending_product(/obj/item/reagent_containers/food/drinks/bottle/soda/spooky2,10, cost = PRICE_25)
			product_list += new/datum/data/vending_product(/obj/item/reagent_containers/food/drinks/bottle/soda/bottledwater, 10, cost = PRICE_37_5)
			product_list += new/datum/data/vending_product(/obj/item/reagent_containers/food/drinks/cola/random, 10, cost = PRICE_RECURRING_CHEAP*0.1)
...
/obj/machinery/vending/floppy
	...
	create_products(restocked)
		...
		product_list += new/datum/data/vending_product(/obj/item/disk/data/floppy/read_only/terminal_os, 6, cost = PRICE_75)
		...
		product_list += new/datum/data/vending_product(/obj/item/storage/box/diskbox, rand(2,3), cost = PRICE_75)
		product_list += new/datum/data/vending_product(/obj/item/disk/data/floppy, rand(5,8), cost = PRICE_30)
...
/obj/machinery/vending/pda //cogwerks: vendor to clean up the pile of PDA carts a bit
	...
	create_products(restocked)
		...
		product_list += new/datum/data/vending_product(/obj/item/disk/data/cartridge/atmos, 5, cost = PRICE_75)
		product_list += new/datum/data/vending_product(/obj/item/disk/data/cartridge/game_codebreaker, 10, cost = PRICE_50)
		...
		product_list += new/datum/data/vending_product(/obj/item/disk/data/cartridge/ringtone, 5, cost = PRICE_50)
...
/obj/machinery/vending/book //cogwerks: eventually this oughta have some of the wiki job guides available in it
	...
	create_products(restocked)
		..()
		product_list += new/datum/data/vending_product(/obj/item/paper/engine, 2, cost = PRICE_30)
		product_list += new/datum/data/vending_product(/obj/item/paper/book/from_file/cookbook, 2, cost = PRICE_30)
		product_list += new/datum/data/vending_product(/obj/item/paper/book/from_file/dwainedummies, 2, cost = PRICE_30)
		product_list += new/datum/data/vending_product(/obj/item/paper/book/from_file/guardbot_guide, 2, cost = PRICE_30)
		product_list += new/datum/data/vending_product(/obj/item/paper/book/from_file/hydroponicsguide, 2, cost = PRICE_30)
		product_list += new/datum/data/vending_product(/obj/item/paper/book/from_file/bee_book, 2, cost = PRICE_30)
		product_list += new/datum/data/vending_product(/obj/item/paper/book/from_file/monster_manual, 2, cost = PRICE_30)
		product_list += new/datum/data/vending_product(/obj/item/paper/Cloning, 2, cost = PRICE_30)
		product_list += new/datum/data/vending_product(/obj/item/paper/book/from_file/pharmacopia, 2, cost = PRICE_30)
		product_list += new/datum/data/vending_product(/obj/item/paper/book/from_file/minerals, 2, cost = PRICE_30)
		product_list += new/datum/data/vending_product(/obj/item/paper/book/from_file/player_piano, 2, cost = PRICE_30)
		product_list += new/datum/data/vending_product(/obj/item/paper/book/from_file/DNDrulebook, 2, cost = PRICE_30)
		product_list += new/datum/data/vending_product(/obj/item/paper/book/from_file/monster_manual_revised, 2, cost = PRICE_30)
		product_list += new/datum/data/vending_product(/obj/item/paper/book/from_file/ai_programming_101, 2, cost = PRICE_30)
		product_list += new/datum/data/vending_product(/obj/item/paper/book/from_file/captaining_101, 2, cost = PRICE_30)
		product_list += new/datum/data/vending_product(/obj/item/paper/book/from_file/dealing_with_clonelieness, 2, cost = PRICE_30)
		product_list += new/datum/data/vending_product(/obj/item/paper/book/from_file/elective_prosthetics_for_dummies, 2, cost = PRICE_30)
		product_list += new/datum/data/vending_product(/obj/item/paper/book/from_file/fun_facts_about_shelterfrogs, 2, cost = PRICE_30)
		product_list += new/datum/data/vending_product(/obj/item/paper/book/from_file/teg_guide, 2, cost = PRICE_30)
		product_list += new/datum/data/vending_product(/obj/item/paper/book/from_file/gravity_tether, 2, cost = PRICE_30)
		product_list += new/datum/data/vending_product(/obj/item/paper/book/from_file/horrorcontest, 2, cost = PRICE_30)

		product_list += new/datum/data/vending_product(/obj/item/paper/book/from_file/the_trial, 1, cost = PRICE_30, hidden=1)
		product_list += new/datum/data/vending_product(/obj/item/paper/book/from_file/critter_compendium, 1, cost = PRICE_30, hidden=1)
		product_list += new/datum/data/vending_product(/obj/item/paper/book/from_file/syndies_guide/stolen, 1, cost = PRICE_30, hidden=1)
...
/obj/machinery/vending/fortune
	...
	create_products(restocked)
		..()
		product_list += new/datum/data/vending_product(/obj/item/paper/thermal/fortune, 25, cost = PRICE_15)
		product_list += new/datum/data/vending_product(/obj/item/card_box/tarot, 5, cost = PRICE_75)
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/food/snacks/fortune_cookie, 10, cost = PRICE_30, hidden=TRUE)
...
/obj/machinery/vending/cards
	...
	create_products(restocked)
		..()
		product_list += new/datum/data/vending_product(/obj/item/paper/yachtdice, 20, cost = PRICE_18_75)
		product_list += new/datum/data/vending_product(/obj/item/paper/book/from_file/grifening, 10, cost = PRICE_30)
		product_list += new/datum/data/vending_product(/obj/item/stg_box, 5, cost = PRICE_75)
		product_list += new/datum/data/vending_product(/obj/item/stg_booster, 20, cost = PRICE_15)
		product_list += new/datum/data/vending_product(/obj/item/card_box/plain, 10, cost = PRICE_30)
		product_list += new/datum/data/vending_product(/obj/item/card_box/tarot, 5, cost = PRICE_50)
		product_list += new/datum/data/vending_product(/obj/item/card_box/hanafuda, 5, cost = PRICE_RECURRING*0.75)
		product_list += new/datum/data/vending_product(/obj/item/card_box, 5, cost = PRICE_37_5)
		product_list += new/datum/data/vending_product(/obj/item/card_box/red, 5, cost = PRICE_37_5)
		product_list += new/datum/data/vending_product(/obj/item/paper/book/from_file/DNDrulebook, 2, cost = PRICE_30)
		product_list += new/datum/data/vending_product(/obj/item/paper/book/from_file/monster_manual_revised, 2, cost = PRICE_30)
		...
		product_list += new/datum/data/vending_product(/obj/item/diceholder/dicecup, 5, cost = PRICE_30)
		product_list += new/datum/data/vending_product(/obj/item/goboard, 1, cost = PRICE_RECURRING*0.75)
		product_list += new/datum/data/vending_product(/obj/item/gobowl/b, 1, cost = PRICE_75)
		product_list += new/datum/data/vending_product(/obj/item/gobowl/w, 1, cost = PRICE_75)
		...
		product_list += new/datum/data/vending_product(/obj/item/card_box/solo, 5, cost = PRICE_37_5)
		product_list += new/datum/data/vending_product(/obj/item/paper/book/from_file/solo_rules, 5, cost = PRICE_30)
		...
		product_list += new/datum/data/vending_product(/obj/item/currency/fakecash/fivehundred, 10, cost = PRICE_37_5)
		product_list += new/datum/data/vending_product(/obj/item/currency/fakecash/thousand, 10, cost = PRICE_75)
...
/obj/machinery/vending/clothing
	...
	create_products(restocked)
		...
		product_list += new/datum/data/vending_product(/obj/item/clothing/suit/poncho, 2, cost = PRICE_30)
		product_list += new/datum/data/vending_product(/obj/item/clothing/suit/lshirt, 2, cost = PRICE_30)
