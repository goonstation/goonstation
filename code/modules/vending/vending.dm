...
/obj/machinery/vending/medical
	...
	create_products()
		...
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/pill/cold_medicine, 8)
...
/obj/machinery/vending/medical_public
	...
	create_products()
		...
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/pill/cold_medicine, 5, cost=PAY_TRADESMAN/5)
