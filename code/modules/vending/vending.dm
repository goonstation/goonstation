...
/obj/machinery/vending/cola
	...
	red
		...
		create_products()
			...
			product_list += new/datum/data/vending_product(/obj/item/reagent_containers/food/drinks/cola/random, rand(1, 5), cost=PAY_UNTRAINED/10, hidden = 1)
...
/obj/machinery/vending/hydroponics
	...
	create_products()
		...
		product_list += new/datum/data/vending_product(/obj/item/clothing/suit/wintercoat/rancher_puffer, 2)
		product_list += new/datum/data/vending_product(/obj/item/clothing/suit/wintercoat/botany_puffer, 2)
...
/obj/machinery/vending/janitor
	...
	create_products()
		...
		product_list += new/datum/data/vending_product(/obj/item/clothing/suit/wintercoat/janitor_jacket, 2)
...
/obj/machinery/vending/jobclothing/security
	...
	create_products()
		...
		product_list += new/datum/data/vending_product(/obj/item/clothing/suit/wintercoat/security_puffer, 2)
...
/obj/machinery/vending/jobclothing/medical
	...
	create_products()
		...
		product_list += new/datum/data/vending_product(/obj/item/clothing/suit/wintercoat/nurse_coat, 2)
		product_list += new/datum/data/vending_product(/obj/item/clothing/suit/wintercoat/geneticist_puffer, 2)
		...
		product_list += new/datum/data/vending_product(/obj/item/clothing/suit/wintercoat/short_nurse_dress, 2)
...
/obj/machinery/vending/jobclothing/engineering
	...
	create_products()
		...
		product_list += new/datum/data/vending_product(/obj/item/clothing/suit/wintercoat/engineering_puffer, 2)
		product_list += new/datum/data/vending_product(/obj/item/clothing/suit/hi_vis, 4)
		product_list += new/datum/data/vending_product(/obj/item/clothing/suit/wintercoat/hi_vis_coat, 4)
...
/obj/machinery/vending/jobclothing/research
	...
	create_products()
		...
		product_list += new/datum/data/vending_product(/obj/item/clothing/suit/wintercoat/science_puffer, 2)
		product_list += new/datum/data/vending_product(/obj/item/clothing/suit/labcoat, 2)
