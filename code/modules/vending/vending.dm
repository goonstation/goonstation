...
/obj/machinery/vending/chemistry
	...
	create_products(restocked)
		...
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/glass/bottle/ammonia, 3)
		...
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/pill/bathsalts, amount=rand(0, 6), hidden=1)
