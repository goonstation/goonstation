/datum/data/vending_product
	...
	New(productpath, amount=0, cost=0, hidden=FALSE, logged_on_vend=FALSE, infinite=FALSE)
		..()
...
/obj/machinery/vending/jobclothing/chaplain
	...
	create_products()
		...
		product_list += new/datum/data/vending_product(/obj/item/bible/eye/dark				, 1, hidden = TRUE)
		product_list += new/datum/data/vending_product(/obj/item/bible/redwhite/dark		, 1, hidden = TRUE)
		product_list += new/datum/data/vending_product(/obj/item/bible/skeleton				, 1, hidden = TRUE)
		product_list += new/datum/data/vending_product(/obj/item/bible/sulphur				, 1, hidden = TRUE)
		product_list += new/datum/data/vending_product(/obj/item/bible/clown/cluwne			, 1, hidden = TRUE)
		product_list += new/datum/data/vending_product(/obj/item/clothing/under/weirdo		, 3, hidden = TRUE)
		product_list += new/datum/data/vending_product(/obj/item/clothing/mask/weirdomask	, 3, hidden = TRUE)
