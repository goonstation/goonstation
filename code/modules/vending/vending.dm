...
/obj/machinery/vending/mechanics
	...
	create_products(restocked)
		..()
		product_list += new/datum/data/vending_product(/obj/item/paper/book/from_file/mechanicbook, 5)
		...
		product_list += new/datum/data/vending_product(/mob/living/critter/small_animal/mechdrone, 3)
		product_list += new/datum/data/vending_product(/obj/item/mechdrone_pointer, 10)
		product_list += new/datum/data/vending_product(/obj/item/paper/book/from_file/mechdronebook, 5)
