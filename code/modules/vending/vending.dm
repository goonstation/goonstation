...
/obj/machinery/vending/security_ammo //ass jam time yes
	...
	create_products()
		..()
		product_list += new/datum/data/vending_product(/obj/item/ammo/bullets/abg, 6 * (ASS_JAM * 20))//on ass jam theres 20 times as much ammo in the ammotech
		product_list += new/datum/data/vending_product(/obj/item/ammo/bullets/a38, 2 * (ASS_JAM * 20))
		product_list += new/datum/data/vending_product(/obj/item/ammo/bullets/a38/stun, 3 * (ASS_JAM * 20))
		product_list += new/datum/data/vending_product(/obj/item/ammo/bullets/flare, 3 * (ASS_JAM * 20))
		product_list += new/datum/data/vending_product(/obj/item/ammo/bullets/smoke, 3 * (ASS_JAM * 20))
		product_list += new/datum/data/vending_product(/obj/item/ammo/bullets/tranq_darts, 3 * (ASS_JAM * 20))
