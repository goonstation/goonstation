...
/obj/machinery/vending/chapel
	...
	create_products(restocked)
		...
		product_list += new/datum/data/vending_product(/obj/item/bible/eyehb, 1 )
		product_list += new/datum/data/vending_product(/obj/item/bible/bluehb, 1 )
		product_list += new/datum/data/vending_product(/obj/item/bible/bluewhitehb, 1 )
		product_list += new/datum/data/vending_product(/obj/item/bible/burnedhb, 1 )
		product_list += new/datum/data/vending_product(/obj/item/bible/clownhb, 1 )
		product_list += new/datum/data/vending_product(/obj/item/bible/eyedarkhb, 1 )
		product_list += new/datum/data/vending_product(/obj/item/bible/greenhb, 1 )
		product_list += new/datum/data/vending_product(/obj/item/bible/purplehb, 1 )
		product_list += new/datum/data/vending_product(/obj/item/bible/redwhitehb, 1 )
		product_list += new/datum/data/vending_product(/obj/item/bible/skeletonhb, 1 )
		product_list += new/datum/data/vending_product(/obj/item/bible/xhb, 1 )
		product_list += new/datum/data/vending_product(/obj/item/paper/book/charms, 1)

		product_list += new/datum/data/vending_product(/obj/item/bible/reddarkhb, 1, hidden=1 )
		product_list += new/datum/data/vending_product(/obj/item/bible/cluwnehb, 1, hidden=1,)
		product_list += new/datum/data/vending_product(/obj/item/bible/tidehb, 1, hidden=1 )
