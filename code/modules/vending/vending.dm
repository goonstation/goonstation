...
/obj/machinery/vending/medical
	...
	create_products()
		...
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/emergency_injector/atropine, 6)
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/emergency_injector/mannitol, 10)
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/emergency_injector/salbutamol, 10)
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/emergency_injector/anti_rad, 10)
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/emergency_injector/antihistamine, 8)
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/emergency_injector/spaceacillin, 8)
		...
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/glass/bottle/heparin, 2)
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/glass/bottle/proconvertin, 2)
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/glass/bottle/filgrastim, 2)
...
/obj/machinery/vending/medical_public
	...
	create_products()
		...
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/ampoule/smelling_salts, 2, cost=PAY_TRADESMAN/10)
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/pill/salicylic_acid, 10, cost=PAY_TRADESMAN/10)
		product_list += new/datum/data/vending_product(/obj/item/clothing/mask/surgical, 10, cost=PAY_TRADESMAN/10)
		product_list += new/datum/data/vending_product(/obj/item/clothing/gloves/latex, 10, cost=PAY_TRADESMAN/10)
