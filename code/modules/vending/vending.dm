...
/obj/machinery/vending/clothing
	...
	create_products(restocked)
		...
		product_list += new/datum/data/vending_product(/obj/item/clothing/under/formal/dress, 5, cost=PAY_TRADESMAN/2)
		product_list += new/datum/data/vending_product(/obj/item/clothing/under/formal/dress/red, 5, cost=PAY_TRADESMAN/2)
		product_list += new/datum/data/vending_product(/obj/item/clothing/under/formal/dress/hawaiian, 5, cost=PAY_TRADESMAN/2)
