...
/obj/machinery/vending/coffee
	...
	create_products(restocked)
		...
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/food/drinks/chickensoup, 10, cost = PRICE_120)
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/food/drinks/weightloss_shake, 10, cost = PRICE_150)
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/food/drinks/mate, 3, cost = PRICE_200)
...
/obj/machinery/vending/snack
	...
	create_products(restocked)
		..()
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/food/snacks/candy/chocolate, 10, cost = PRICE_7_5)
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/food/snacks/chips, 10, cost = PRICE_10)
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/food/snacks/donut, 10, cost = PRICE_15)
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/food/snacks/candy/nougat, 10, cost = PRICE_10)
...
/obj/machinery/vending/cigarette
	...
	create_products(restocked)
		...
		product_list += new/datum/data/vending_product(/obj/item/cigpacket/propuffs, 10, cost = PRICE_120)
		product_list += new/datum/data/vending_product(/obj/item/cigpacket/cigarillo, 10, cost = PRICE_120)
		product_list += new/datum/data/vending_product(/obj/item/cigarbox, 1, cost = PRICE_300)
		product_list += new/datum/data/vending_product(/obj/item/matchbook, 10, cost = PRICE_7_5)
		...
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/vape, 10, cost = PRICE_150)
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/ecig_refill_cartridge, 20, cost = PRICE_120)
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/ecig_refill_cartridge/flavored, 10, cost = PRICE_100)
		product_list += new/datum/data/vending_product(/obj/item/item_box/medical_patches/nicotine, 5, cost = PRICE_120)
...
/obj/machinery/vending/medical_public
	...
	create_products(restocked)
		..()
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/patch/mini/bruise, 5, cost = PRICE_120)
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/patch/mini/burn, 5, cost = PRICE_120)
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/pill/epinephrine, 5, cost = PRICE_100)
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/pill/salicylic_acid, 5, cost = PRICE_120)
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/pill/menthol, 5, cost = PRICE_120)
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/emergency_injector/charcoal, 5, cost = PRICE_120)
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/emergency_injector/antihistamine, 2, cost = PRICE_120)
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/emergency_injector/spaceacillin, 2, cost = PRICE_150)
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/ampoule/smelling_salts, 2, cost = PRICE_120)
		product_list += new/datum/data/vending_product(/obj/item/device/analyzer/healthanalyzer, 4, cost = PRICE_100)
...
/obj/machinery/vending/cola
	...
	red
		...
		create_products(restocked)
			...
			product_list += new/datum/data/vending_product(/obj/item/reagent_containers/food/drinks/cola/random, 10, cost = PRICE_10)
...
/obj/machinery/vending/floppy
	...
	create_products(restocked)
		..()
		product_list += new/datum/data/vending_product(/obj/item/disk/data/floppy/computer3boot, 6, cost = PRICE_100)
		product_list += new/datum/data/vending_product(/obj/item/disk/data/floppy/read_only/terminal_os, 6, cost = PRICE_75)
		product_list += new/datum/data/vending_product(/obj/item/disk/data/floppy/read_only/network_progs, 4, cost = PRICE_150)
		product_list += new/datum/data/vending_product(/obj/item/disk/data/floppy/read_only/medical_progs, 2, cost = PRICE_150)

		product_list += new/datum/data/vending_product(/obj/item/disk/data/floppy/read_only/security_progs, 2, cost = PRICE_150, hidden=1)
...
/obj/machinery/vending/pda //cogwerks: vendor to clean up the pile of PDA carts a bit
	...
	create_products(restocked)
		...
		product_list += new/datum/data/vending_product(/obj/item/disk/data/cartridge/janitor, 5, cost = PRICE_100)
		product_list += new/datum/data/vending_product(/obj/item/disk/data/cartridge/genetics, 5, cost = PRICE_200)
		product_list += new/datum/data/vending_product(/obj/item/disk/data/cartridge/engineer, 5, cost = PRICE_150)
		product_list += new/datum/data/vending_product(/obj/item/disk/data/cartridge/botanist, 5, cost = PRICE_100)
		product_list += new/datum/data/vending_product(/obj/item/disk/data/cartridge/medical, 5, cost = PRICE_200)
		product_list += new/datum/data/vending_product(/obj/item/disk/data/cartridge/toxins, 5, cost = PRICE_200)
		product_list += new/datum/data/vending_product(/obj/item/disk/data/cartridge/quartermaster, 5, cost = PRICE_100)
		product_list += new/datum/data/vending_product(/obj/item/disk/data/cartridge/miner, 5, cost = PRICE_100)
		product_list += new/datum/data/vending_product(/obj/item/disk/data/cartridge/ringtone, 5, cost = PRICE_50)
		product_list += new/datum/data/vending_product(/obj/item/disk/data/cartridge/ringtone_basic, 5, cost = PRICE_100)
		product_list += new/datum/data/vending_product(/obj/item/disk/data/cartridge/ringtone_chimes, 5, cost = PRICE_100)
		product_list += new/datum/data/vending_product(/obj/item/disk/data/cartridge/ringtone_beepy, 5, cost = PRICE_100)
...
/obj/machinery/vending/fortune
	...
	create_products(restocked)
		...
		product_list += new/datum/data/vending_product(/obj/item/ghostboard, 2, cost = PRICE_300, hidden=TRUE)
...
/obj/machinery/vending/cards
	...
	create_products(restocked)
		...
		product_list += new/datum/data/vending_product(/obj/item/card_box/hanafuda, 5, cost = PRICE_150)
		...
		product_list += new/datum/data/vending_product(/obj/item/paper/book/from_file/DNDrulebook, 2, cost = PRICE_30)
		product_list += new/datum/data/vending_product(/obj/item/paper/book/from_file/monster_manual_revised, 2, cost = PRICE_30)
		product_list += new/datum/data/vending_product(/obj/item/diceholder/dicebox, 5, cost = PRICE_150)
		product_list += new/datum/data/vending_product(/obj/item/storage/dicepouch, 5, cost = PRICE_100)
		product_list += new/datum/data/vending_product(/obj/item/diceholder/dicecup, 5, cost = PRICE_30)
		product_list += new/datum/data/vending_product(/obj/item/goboard, 1, cost = PRICE_150)
		...
		product_list += new/datum/data/vending_product(/obj/item/boardgame/chess, 1, cost = PRICE_150)
		product_list += new/datum/data/vending_product(/obj/item/gameclock, 5, cost = PRICE_300)
		product_list += new/datum/data/vending_product(/obj/item/card_box/clow, 5, cost = PRICE_150) // (this is an anime joke)
		product_list += new/datum/data/vending_product(/obj/item/clow_key, 5, cost = PRICE_150)      //      (please laugh)
		...
		product_list += new/datum/data/vending_product(/obj/item/dice/weighted, rand(1,3), cost = PRICE_150, hidden=1)
		product_list += new/datum/data/vending_product(/obj/item/dice/d1, rand(0,1), cost = PRICE_100, hidden=1)
...
/obj/machinery/vending/clothing
	...
	create_products(restocked)
		...
		product_list += new/datum/data/vending_product(/obj/item/clothing/under/misc/yoga, 5, cost = PRICE_120)
		product_list += new/datum/data/vending_product(/obj/item/clothing/under/misc/yoga/red, 5, cost = PRICE_120)
		product_list += new/datum/data/vending_product(/obj/item/clothing/under/misc/dress, 5, cost = PRICE_150)
		product_list += new/datum/data/vending_product(/obj/item/clothing/under/misc/dress/red, 5, cost = PRICE_150)
		product_list += new/datum/data/vending_product(/obj/item/clothing/under/misc/dress/hawaiian, 5, cost = PRICE_150)
		product_list += new/datum/data/vending_product(/obj/item/clothing/shoes/heels/black, 5, cost = PRICE_120)
		product_list += new/datum/data/vending_product(/obj/item/clothing/shoes/heels/red, 5, cost = PRICE_120)
		...
		product_list += new/datum/data/vending_product(/obj/item/clothing/suit/dressb, 2, cost = PRICE_300)
		product_list += new/datum/data/vending_product(/obj/item/clothing/head/sunhat, 2, cost = PRICE_120)
		...
		product_list += new/datum/data/vending_product(/obj/item/clothing/head/pokervisor, 3, cost = PRICE_120)
