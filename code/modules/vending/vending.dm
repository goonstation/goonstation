...
/obj/machinery/vending/chapel
	...
	create_products(restocked)
		...
		product_list += new/datum/data/vending_product(/obj/item/scripture/bible, 1 )
		product_list += new/datum/data/vending_product(/obj/item/scripture/quran, 1 )
		product_list += new/datum/data/vending_product(/obj/item/scripture/atheist, 1 )
		product_list += new/datum/data/vending_product(/obj/item/scripture/tripitika, 1 )
		product_list += new/datum/data/vending_product(/obj/item/scripture/torah, 1 )
		product_list += new/datum/data/vending_product(/obj/item/scripture/gurugranthsahibih, 1 )
