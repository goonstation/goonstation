...
/obj/machinery/vending/medical_public
	...
	create_products(restocked)
		...
		product_list += new/datum/data/vending_product(/obj/item/device/analyzer/healthanalyzer, 4, cost=PAY_TRADESMAN/3)
		...
		product_list += new/datum/data/vending_product(/obj/item/device/analyzer/healthanalyzer_upgrade, rand(1, 3), hidden=1, cost=PAY_TRADESMAN)
...
/obj/machinery/vending/mechanics
	...
	create_products(restocked)
		..()
		product_list += new/datum/data/vending_product(/obj/item/paper/book/from_file/mechanicbook, 30) // Mechanic Components And You
		product_list += new/datum/data/vending_product(/obj/item/mechanics/andcomp, 30) // AND Component
		product_list += new/datum/data/vending_product(/obj/item/mechanics/math, 30) // Arithmetic Component
		product_list += new/datum/data/vending_product(/obj/item/mechanics/association, 30) // Association Component
		product_list += new/datum/data/vending_product(/obj/item/mechanics/interval_timer, 5) // Automatic Signaller Component
		product_list += new/datum/data/vending_product(/obj/item/mechanics/buffercomp, 30) // Buffer Component
		product_list += new/datum/data/vending_product(/obj/item/mechanics/trigger/button, 30) // Button
		product_list += new/datum/data/vending_product(/obj/item/mechanics/trigger/buttonPanel, 30) // Button Panel
		product_list += new/datum/data/vending_product(/obj/item/mechanics/clock, 30) // Clock Component
		product_list += new/datum/data/vending_product(/obj/item/mechanics/mc14500, 30) // Control Unit
		product_list += new/datum/data/vending_product(/obj/disposalconstruct/mechanics, 10) // Controlled pipe junction
		product_list += new/datum/data/vending_product(/obj/item/mechanics/counter, 30) // Counting Component
		product_list += new/datum/data/vending_product(/obj/item/mechanics/pausecomp, 30) // Delay Component
		product_list += new/datum/data/vending_product(/obj/item/mechanics/dispatchcomp, 30) // Dispatch Component
		product_list += new/datum/data/vending_product(/obj/item/mechanics/gunholder/recharging, 30) // E-Gun Component
		product_list += new/datum/data/vending_product(/obj/item/mechanics/filecomp, 30) // File Component
		product_list += new/datum/data/vending_product(/obj/item/mechanics/flushcomp, 30) // Flusher component
		product_list += new/datum/data/vending_product(/obj/item/mechanics/accelerator, 30) // Graviton accelerator
		product_list += new/datum/data/vending_product(/obj/item/mechanics/gunholder, 30) // Gun Component
		product_list += new/datum/data/vending_product(/obj/item/mechanics/hscan, 30) // Hand scanner
		product_list += new/datum/data/vending_product(/obj/item/mechanics/hangman, 10) // Hangman game component
		product_list += new/datum/data/vending_product(/obj/item/mechanics/instrumentPlayer, 10) // Instrument Player
		product_list += new/datum/data/vending_product(/obj/item/mechanics/ledcomp, 30) // LED Component
		product_list += new/datum/data/vending_product(/obj/item/mechanics/screen, 30) // Letter Display Component
		product_list += new/datum/data/vending_product(/obj/item/mechanics/message_sign, 10) // Message sign component
		product_list += new/datum/data/vending_product(/obj/item/mechanics/miccomp, 30) // Microphone Component
		product_list += new/datum/data/vending_product(/obj/item/mechanics/movement, 30) // Movement Component
		product_list += new/datum/data/vending_product(/obj/item/mechanics/orcomp, 30) // OR Component
		product_list += new/datum/data/vending_product(/obj/item/mechanics/pscan, 30) // Paper scanner
		product_list += new/datum/data/vending_product(/obj/item/mechanics/cashmoney, 30) // Payment component
		product_list += new/datum/data/vending_product(/obj/item/mechanics/screen_canvas, 30) // Pixel Display Component
		product_list += new/datum/data/vending_product(/obj/item/mechanics/networkcomp, 30) // Powernet-networking component
		product_list += new/datum/data/vending_product(/obj/item/mechanics/trigger/pressureSensor, 30) // Pressure Sensor
		product_list += new/datum/data/vending_product(/obj/item/mechanics/radioscanner, 30) // Radio Scanner Component
		product_list += new/datum/data/vending_product(/obj/item/mechanics/regfind, 30) // RegEx Find Component
		product_list += new/datum/data/vending_product(/obj/item/mechanics/regreplace, 30) // RegEx Replace Component
		product_list += new/datum/data/vending_product(/obj/item/mechanics/relaycomp, 30) // Relay Component
		product_list += new/datum/data/vending_product(/obj/item/mechanics/selectcomp, 30) // Selection Component
		product_list += new/datum/data/vending_product(/obj/disposalconstruct/mechanics_sensor, 10) // Sensor pipe
		product_list += new/datum/data/vending_product(/obj/item/mechanics/sigbuilder, 30) // Signal Builder Component
		product_list += new/datum/data/vending_product(/obj/item/mechanics/wifisplit, 30) // Signal Splitter Component
		product_list += new/datum/data/vending_product(/obj/item/mechanics/sigcheckcomp, 30) // Signal-Check Component
		product_list += new/datum/data/vending_product(/obj/item/mechanics/synthcomp, 30) // Sound Synthesizer
		product_list += new/datum/data/vending_product(/obj/item/mechanics/telecomp, 30) // Teleport Component
		product_list += new/datum/data/vending_product(/obj/item/mechanics/zapper, 10) // Tesla Coil
		product_list += new/datum/data/vending_product(/obj/item/mechanics/textmanip, 30) // Text manipulation component
		product_list += new/datum/data/vending_product(/obj/item/mechanics/text_to_music, 5) // Text to Music Component
		product_list += new/datum/data/vending_product(/obj/item/paper/book/from_file/text_to_music_com, 5) // Text to Music Component Manual
		product_list += new/datum/data/vending_product(/obj/item/mechanics/thprint, 10) // Thermal printer
		product_list += new/datum/data/vending_product(/obj/item/mechanics/togglecomp, 30) // Toggle Component
		product_list += new/datum/data/vending_product(/obj/item/mechanics/triplaser, 30) // Trip laser
		product_list += new/datum/data/vending_product(/obj/item/mechanics/wificomp, 30) // Wifi Component
