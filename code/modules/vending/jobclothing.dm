...
/obj/machinery/vending/jobclothing/security
	...
	create_products(restocked)
		...
		product_list += new/datum/data/vending_product(/obj/item/device/radio/headset/security, 2, cost = PRICE_RECURRING)
		product_list += new/datum/data/vending_product(/obj/item/device/pda2/security, 2, cost = PRICE_RECURRING)
		product_list += new/datum/data/vending_product(/obj/item/cloth/towel/security, 4, cost = PRICE_RECURRING*0.75)
...
/obj/machinery/vending/jobclothing/medical
	...
	create_products(restocked)
		...
		product_list += new/datum/data/vending_product(/obj/item/device/radio/headset/medical, 2, cost = PRICE_RECURRING_COSTLY)
		product_list += new/datum/data/vending_product(/obj/item/device/radio/headset/pharmacist, 2, cost = PRICE_RECURRING_COSTLY)
		product_list += new/datum/data/vending_product(/obj/item/device/pda2/medical, 2, cost = PRICE_RECURRING_COSTLY)
		product_list += new/datum/data/vending_product(/obj/item/device/pda2/robotics, 2, cost = PRICE_RECURRING_COSTLY)
		product_list += new/datum/data/vending_product(/obj/item/device/pda2/genetics, 2, cost = PRICE_RECURRING_COSTLY)
		product_list += new/datum/data/vending_product(/obj/item/device/pda2/pharmacist, 2, cost = PRICE_RECURRING_COSTLY)
...
/obj/machinery/vending/jobclothing/engineering
	...
	create_products(restocked)
		...
		product_list += new/datum/data/vending_product(/obj/item/device/radio/headset/engineer, 2, cost = PRICE_RECURRING)
		product_list += new/datum/data/vending_product(/obj/item/device/pda2/engine, 2, cost = PRICE_RECURRING)
		product_list += new/datum/data/vending_product(/obj/item/device/pda2/atmos, 2, cost = PRICE_RECURRING*0.75)
...
/obj/machinery/vending/jobclothing/catering
	...
	create_products(restocked)
		...
		product_list += new/datum/data/vending_product(/obj/item/device/radio/headset/civilian, 2, cost = PRICE_RECURRING)
		product_list += new/datum/data/vending_product(/obj/item/device/pda2/chef, 2, cost = PRICE_RECURRING)
		product_list += new/datum/data/vending_product(/obj/item/device/pda2/bartender, 2, cost = PRICE_RECURRING)
...
/obj/machinery/vending/jobclothing/research
	...
	create_products(restocked)
		...
		product_list += new/datum/data/vending_product(/obj/item/device/radio/headset/research, 2, cost = PRICE_RECURRING_COSTLY)
		product_list += new/datum/data/vending_product(/obj/item/device/pda2/toxins, 5, cost = PRICE_RECURRING_COSTLY)
...
/obj/machinery/vending/jobclothing/syndicate
	...
	create_products(restocked)
		...
		product_list += new/datum/data/vending_product(/obj/item/clothing/mask/gas/swat, 2, cost = PRICE_LUXURY*0.4)
		product_list += new/datum/data/vending_product(/obj/item/device/pda2/syndicate, 2, cost = PRICE_LUXURY_CHEAP*0.6)
