...
/obj/machinery/vending/jobclothing/medical
	...
	create_products(restocked)
		...
		product_list += new/datum/data/vending_product(/obj/item/clothing/head/nursehat/blue, 2)
		product_list += new/datum/data/vending_product(/obj/item/device/radio/headset/medical, 2, cost=PAY::DOCTORATE/2)
		product_list += new/datum/data/vending_product(/obj/item/device/radio/headset/pharmacist, 2, cost=PAY::DOCTORATE/2)
		product_list += new/datum/data/vending_product(/obj/item/device/pda2/medical, 2, cost=PAY::DOCTORATE/2)
		product_list += new/datum/data/vending_product(/obj/item/device/pda2/robotics, 2, cost=PAY::DOCTORATE/2)
		product_list += new/datum/data/vending_product(/obj/item/device/pda2/genetics, 2, cost=PAY::DOCTORATE/2)
		product_list += new/datum/data/vending_product(/obj/item/device/pda2/pharmacist, 2, cost=PAY::DOCTORATE/2)
...
/obj/machinery/vending/jobclothing/engineering
	...
	create_products(restocked)
		...
		product_list += new/datum/data/vending_product(/obj/item/device/radio/headset/engineer, 2, cost=PAY::TRADESMAN/1.5)
		product_list += new/datum/data/vending_product(/obj/item/device/pda2/engine, 2, cost=PAY::TRADESMAN/1.5)
		product_list += new/datum/data/vending_product(/obj/item/device/pda2/atmos, 2, cost=PAY::TRADESMAN/2)
...
/obj/machinery/vending/jobclothing/catering
	...
	create_products(restocked)
		...
		product_list += new/datum/data/vending_product(/obj/item/device/radio/headset/civilian/catering, 2, cost=PAY::TRADESMAN/1.5)
		product_list += new/datum/data/vending_product(/obj/item/device/pda2/chef, 2, cost=PAY::TRADESMAN/1.5)
		product_list += new/datum/data/vending_product(/obj/item/device/pda2/bartender, 2, cost=PAY::TRADESMAN/1.5)
...
/obj/machinery/vending/jobclothing/research
	...
	create_products(restocked)
		...
		product_list += new/datum/data/vending_product(/obj/item/clothing/under/shirt_pants_br/scitie, 5)
		...
		product_list += new/datum/data/vending_product(/obj/item/device/radio/headset/research, 2, cost=PAY::DOCTORATE/2)
		product_list += new/datum/data/vending_product(/obj/item/device/pda2/toxins, 5, cost=PAY::DOCTORATE/2)
...
/obj/machinery/vending/jobclothing/syndicate
	...
	create_products(restocked)
		...
		product_list += new/datum/data/vending_product(/obj/item/clothing/mask/gas/swat, 2, cost=PAY::IMPORTANT)
		product_list += new/datum/data/vending_product(/obj/item/device/pda2/syndicate, 2, cost=PAY::IMPORTANT/2)
