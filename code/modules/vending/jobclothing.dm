...
/obj/machinery/vending/jobclothing/medical
	...
	create_products(restocked)
		...
		product_list += new/datum/data/vending_product(/obj/item/device/radio/headset/pharmacist, 2, cost=PAY_DOCTORATE/2)
		product_list += new/datum/data/vending_product(/obj/item/device/pda2/medical, 2, cost=PAY_DOCTORATE/2)
		product_list += new/datum/data/vending_product(/obj/item/device/pda2/robotics, 2, cost=PAY_DOCTORATE/2)
