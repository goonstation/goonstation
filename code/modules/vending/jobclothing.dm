...
/obj/machinery/vending/jobclothing/security
	...
	create_products(restocked)
		...
		product_list += new/datum/data/vending_product(/obj/item/clothing/under/athletic/jersey/red, 2)
		product_list += new/datum/data/vending_product(/obj/item/clothing/under/athletic/dirty_vest, 2)
