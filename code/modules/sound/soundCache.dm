...
var/global/list/soundCache = list(
	...
	"sound/voice/blob/blob1.ogg" = 	'sound/voice/blob/blob1.ogg',\
	"sound/voice/blob/blob2.ogg" = 'sound/voice/blob/blob2.ogg',\
	"sound/voice/blob/blob3.ogg" = 'sound/voice/blob/blob3.ogg',\
	"sound/voice/blob/blob4.ogg" = 'sound/voice/blob/blob4.ogg',\
	"sound/voice/blob/blob5.ogg" = 'sound/voice/blob/blob5.ogg',\
	"sound/voice/blob/blob6.ogg" = 'sound/voice/blob/blob6.ogg',\
	"sound/voice/blob/blob7.ogg" = 'sound/voice/blob/blob7.ogg'v
