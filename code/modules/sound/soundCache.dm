...
var/global/list/soundCache = list(
	"sound/ambience/dojo/dojoambi.ogg" = 'sound/ambience/dojo/dojoambi.ogg',\
 	...
 	"sound/items/reticulator-resonator_scan.ogg" = 'sound/items/reticulator-resonator_scan.ogg',\
 	"sound/items/reticulator-tuner_scramble.ogg" = 'sound/items/reticulator-tuner_scramble.ogg',\
