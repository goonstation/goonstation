...
var/global/list/soundCache = list(
	"sound/ambience/dojo/dojoambi.ogg" = 'sound/ambience/dojo/dojoambi.ogg',\
 	...
 	"sound/items/lattice_combiner_error.ogg" = 'sound/items/lattice_combiner_error.ogg',\
 	"sound/items/lattice_combiner_transform_art.ogg" = 'sound/items/lattice_combiner_transform_art.ogg',\
