...
/obj/newmeteor
	...
	var/list/oredrops = list(/obj/item/material/rock)
	var/list/oredrops_rare = list(/obj/item/material/rock)
...
/obj/newmeteor/massive
	...
	exp_lit = 2
	exp_fsh = 3
	oredrops = list(/obj/item/material/char, /obj/item/material/mauxite, /obj/item/material/rock)
	oredrops_rare = list(/obj/item/material/starstone, /obj/item/material/syreline)
	transmute_range = 10
