...
/obj/whitehole
	...
	var/static/list/spawn_probs = list(
		...
		"teg" = list(
			...
			/obj/item/material/shard/glass = 5,
			/obj/item/rcd = 0.5,
		...
		"asteroid" = list(
			...
			/mob/living/carbon/human/normal/miner = 0.1,
			/obj/item/material/scrap_metal = 4,
		...
		"singulo" = list(
			...
			/obj/item/material/scrap_metal = 4,
			/obj/item/material/shard/glass = 5,
			/obj/item/material/shard/plasmacrystal = 3,
			/obj/item/paper = 3,
		),
		"plasma" = list(
			"plasma" = 100,
			/obj/critter/spore = 3,
			/obj/item/material/shard/plasmacrystal = 1,
			/obj/item/material/plasmastone = 1,
		),
		"nukies" = list(
		...
		"ore" = list(
			...
			/obj/item/material/ice = 50,

			/obj/item/material/mauxite = 20,
			/obj/item/material/pharosium = 20,
			/obj/item/material/uqill = 0.5,
			/obj/item/material/fibrilith = 3,
			/obj/item/material/molitz = 20,
			/obj/item/material/char = 5,
			/obj/item/material/cobryl = 3,
			/obj/item/material/bohrum = 2,
			/obj/item/material/claretine = 5,
			/obj/item/material/martian = 5,
			/obj/item/material/syreline = 2,
			/obj/item/material/cerenkite = 1,
			/obj/item/material/plasmastone = 1,
			/obj/item/material/eldritch = 1,
			/obj/item/material/gold = 2,
			/obj/item/material/miracle = 1,
			/obj/item/material/erebite = 0.5,
			/obj/item/material/starstone = 0.01,
			/obj/item/material/cloth/carbon = 0.02,
			/obj/item/material/gemstone = 3,
		),
