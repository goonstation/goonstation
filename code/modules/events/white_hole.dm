...
/obj/whitehole
	...
	var/static/list/spawn_probs = list(
		"artlab" = list(
			...
			/obj/item/mob_part/humanoid_part/silicon_part/arm/right/light = 20,
		...
		"ai" = list(
			...
			/obj/item/mob_part/humanoid_part/silicon_part/robot_frame = 1,
			/obj/ai_core_frame = 1,
			/obj/item/mob_part/humanoid_part/silicon_part/chest/standard = 1,
			/obj/item/mob_part/humanoid_part/silicon_part/head/standard = 1,
			/obj/item/organ/brain/latejoin = 1,
			/obj/item/cell/supercell/charged = 1,
			/obj/item/mob_part/humanoid_part/silicon_part/arm/left/standard = 1,
			/obj/item/mob_part/humanoid_part/silicon_part/arm/right/standard = 1,
			/obj/item/mob_part/humanoid_part/silicon_part/leg/left/standard = 1,
			/obj/item/mob_part/humanoid_part/silicon_part/leg/right/standard = 1,
