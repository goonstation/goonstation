...
/obj/whitehole
	...
	var/static/list/spawn_probs = list(
		...
		"ai" = list(
			...
			/obj/item/parts/robot_parts/drone_frame/complete_shell = 5,
			/obj/item/parts/robot_parts/drone_frame/complete_shell_choosable = 5,
			/mob/living/silicon/robot/spawnable/light = 2,
			/mob/living/silicon/robot/spawnable/standard = 1,
