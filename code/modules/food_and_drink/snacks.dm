...
/obj/item/reagent_containers/food/snacks/soup/mint_chutney
	...
	heal_amt = 2
	food_color = "#2DAB1F"
	initial_reagents = list("mint"=20,"juice_chili"=10)
...
/obj/item/reagent_containers/food/snacks/soup/chili
	...
	bites_left = 6
	heal_amt = 2
	initial_reagents = list("juice_chili"=20)
...
/obj/item/reagent_containers/food/snacks/soup/queso
	...
	heal_amt = 2
	food_color = "#FF8C00"
	initial_reagents = list("cheese"=10,"juice_chili"=10)
...
/obj/item/reagent_containers/food/snacks/spaghetti/spicy
	...
	bites_left = 5
	initial_volume = 60
	initial_reagents = list("juice_chili"=50,"omnizine"=5,"synaptizine"=5)
	food_effects = list("food_energized","food_brute","food_burn")
	meal_time_flags = MEAL_TIME_DINNER
...
/obj/item/reagent_containers/food/snacks/tandoorichicken
	...
	bites_left = 4
	initial_volume = 20
	initial_reagents = list("currypowder"=10, "juice_chili"=5, "water_holy"=5)
...
/obj/item/reagent_containers/food/snacks/chickenpineapplecurry
	...
	bites_left = 5
	initial_volume = 25
	initial_reagents = list("currypowder"=10, "juice_chili"=5, "salicylic_acid"=10)
