...
/obj/item/reagent_containers/food/snacks/pizza/random
	...
	proc/filter_food(food_type)
		if (ispath(food_type) in src.blacklist)
			return FALSE
		.= TRUE
	proc/randomize_pizza(var/foodprob,var/list/blacklist,var/list/altfoodlist,var/list/foodwhitelist)
		...
		var/num_ingredients =  pick(16;1, 4;2, 1;3)
