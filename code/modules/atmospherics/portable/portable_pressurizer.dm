...
TYPEINFO(/obj/machinery/portable_atmospherics/pressurizer)
	mats = list(/datum/manufacturing_requirement/metal = 15, /datum/manufacturing_requirement/metal/dense = 3, /datum/manufacturing_requirement/insulated = 3, /datum/manufacturing_requirement/conductive = 10)
