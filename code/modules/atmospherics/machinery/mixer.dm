...
/obj/machinery/atmospherics/mixer/update_icon()
...
/obj/machinery/atmospherics/mixer/network_disposing(datum/pipe_network/reference)
...
/obj/machinery/atmospherics/mixer/New()
	..()
	switch(dir)
		if(NORTH)
			if(flipped)
...
/obj/machinery/atmospherics/mixer/disposing()
...
/obj/machinery/atmospherics/mixer/proc/report_status() // Report the status of this mixer over the radio.
...
/obj/machinery/atmospherics/mixer/process()
	..()
	...
	if(network_in1 && transfer_moles1)
		network_in1.update = TRUE

	if(network_in2 && transfer_moles2)
		network_in2.update = TRUE

	network_out?.update = TRUE

	return TRUE

/obj/machinery/atmospherics/mixer/receive_signal(datum/signal/signal)
...
/obj/machinery/atmospherics/mixer/network_expand(datum/pipe_network/new_network, obj/machinery/atmospherics/pipe/reference)
...
/obj/machinery/atmospherics/mixer/initialize()
...
/obj/machinery/atmospherics/mixer/build_network()
...
/obj/machinery/atmospherics/mixer/return_network(obj/machinery/atmospherics/reference)
	build_network()
...
/obj/machinery/atmospherics/mixer/reassign_network(datum/pipe_network/old_network, datum/pipe_network/new_network)
...
/obj/machinery/atmospherics/mixer/return_network_air(datum/pipe_network/reference)
...
/obj/machinery/atmospherics/mixer/disconnect(obj/machinery/atmospherics/reference)
	if(reference==node_in1)
		if (network_in1)
			network_in1.dispose()
			network_in1 = null
