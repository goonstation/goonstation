				...
				if (module)
					if (module.loc != src)
						...
						switch (moduleId)
							...
							if ("civilian_d")
								moduleResetType = /obj/item/robot_module/drone/civilian
							if ("engineering_d")
								moduleResetType = /obj/item/robot_module/drone/engineering
							if ("medical_d")
								moduleResetType = /obj/item/robot_module/drone/medical
						if (moduleResetType)
