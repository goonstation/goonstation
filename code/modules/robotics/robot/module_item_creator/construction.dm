...
/datum/robot/module_item_creator/item_type/amount/cable_coil/setup(obj/item/cable_coil/I)
	..()
	if (!isnull(I))
		I.updateicon()
	return I
...
/datum/robot/module_item_creator/item_type/amount/steel_rod/setup(obj/item/rods/steel/I)
	..()
	if (!isnull(I))
		I.update_icon()
	return I
