			...
			if (prob(80))
				...
				if (prob(25))
					...
					SPAWN_DBG(0.6 SECONDS)
						if (H.gender == "female")
							playsound(src.loc, "sound/voice/screams/female_scream.ogg", 30, 1, channel=VOLUME_CHANNEL_SCREAMFART)
						else
							playsound(src.loc, "sound/voice/screams/male_scream.ogg", 30, 1, channel=VOLUME_CHANNEL_SCREAMFART)
