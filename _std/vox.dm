...
/client/proc/cmd_admin_intercom_announce()
	...
	if(output)
		logTheThing("admin", src, "has created an intercom announcement: [output]")
		logTheThing("diary", src, "has created an intercom announcement: [output]", "admin")
...
/client/proc/cmd_admin_intercom_announce_freq()
	...
	if(output)
		logTheThing("admin", src, "has created an intercom announcement: [output] : With frequency [freq_input]")
		logTheThing("diary", src, "has created an intercom announcement: [output] : With frequency [freq_input]", "admin")
