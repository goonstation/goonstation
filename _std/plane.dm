...
#define PLANE_PARALLAX_STARS -114 // parallax planes, between the station and space
#define PLANE_PARALLAX_GIANT -113
#define PLANE_PARALLAX_PLANETS -112
#define PLANE_PARALLAX_STATIONS -111
