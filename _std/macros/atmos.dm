...
#define SIMPLE_CONCENTRATION_REPORT(MIXTURE, SEP) (APPLY_TO_GASES(_SIMPLE_CONCENTRATION_REPORT, MIXTURE, SEP) _LOGGING_UNKNOWN_CONCENTRATION_REPORT(MIXTURE, SEP))
