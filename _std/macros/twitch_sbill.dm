...
#define TWITCH_BOT_INTERACT_BLOCK(X) (istype(X,/obj/item/hand_labeler) || istype(X,/obj/item/paper) || istype(X,/obj/storage/crate/loot) || istype(X,/obj/machinery/dispensing/vending) || istype(X,/obj/submachine/ATM) || istype(X,/obj/item/pen/crayon))
