...
#define PROP_MOB_ACTING_INTANGIBLE(x) x("acting_intangible", APPLY_ATOM_PROPERTY_SIMPLE, REMOVE_ATOM_PROPERTY_SIMPLE)
...
#define PROP_MOB_INTELLECT_COLLECTED(x) x("mind_intellect_collected", APPLY_ATOM_PROPERTY_SUM, REMOVE_ATOM_PROPERTY_SUM)
