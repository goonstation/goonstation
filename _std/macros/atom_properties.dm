...
#define PROP_MOB_LAW_VISION(x) x("ailawvision", APPLY_ATOM_PROPERTY_SIMPLE, REMOVE_ATOM_PROPERTY_SIMPLE, PROP_UPDATE_SIGHT) // see linked lawrack + laws of examined silicons
