...
#define PROB_MOB_UNSHOVEABLE(x) x("noshove", APPLY_ATOM_PROPERTY_SIMPLE, REMOVE_ATOM_PROPERTY_SIMPLE) // still effected by disarm, just can't be displaced
#define PROP_MOB_UNBUMPABLE(x) x("nobump", APPLY_ATOM_PROPERTY_SIMPLE, REMOVE_ATOM_PROPERTY_SIMPLE) // getting pushed by things moving onto your tile
#define PROP_MOB_UNGRABBABLE(x) x("nograb", APPLY_ATOM_PROPERTY_SIMPLE, REMOVE_ATOM_PROPERTY_SIMPLE)
...
#define PROP_MOB_GOOPIMMUNE(x) x("gooimmune", APPLY_ATOM_PROPERTY_SIMPLE, REMOVE_ATOM_PROPERTY_SIMPLE) // goo piles on fatuus
