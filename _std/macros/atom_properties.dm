...
#define SYNDICATE_HEALTH_VISION 1
#define NORMAL_HEALTH_VISION 0
#define PROP_MOB_EXAMINE_HEALTH(x) x("healthvison", APPLY_ATOM_PROPERTY_MAX, REMOVE_ATOM_PROPERTY_MAX)
//movement properties
...
#define PROP_MOB_RADPROT(x) x("radprot", APPLY_ATOM_PROPERTY_SUM, REMOVE_ATOM_PROPERTY_SUM)
