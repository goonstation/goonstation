...
#define PROP_VAULT_SPEED(x) x("vaultspeed", APPLY_MOB_PROPERTY_SUM, REMOVE_MOB_PROPERTY_SUM)
//armour properties
...
//stunresist props
#define PROP_STUN_RESIST(x) x("stun_resist", APPLY_MOB_PROPERTY_SUM, REMOVE_MOB_PROPERTY_SUM)
#define PROP_STUN_RESIST_MAX(x) x("stun_resist_max", APPLY_MOB_PROPERTY_MAX, REMOVE_MOB_PROPERTY_MAX)
