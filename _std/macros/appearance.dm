...
#define DETAIL_OVERSUIT_1		(1<<7)		// Has a detail that goes over the suit, like a cute little enormous cow muzzle
#define DETAIL_OVERSUIT_IS_COLORFUL		(1<<8)		// The oversuit is colorful, otherwise don't color it. Defaults to first customization color
