...
#define isnukeopai(x) (x:mind && x:mind:get_antagonist(ROLE_NUKEOP_AI))
#define istrainedsyndie(x) (istraitor(x) || isnukeop(x) || issleeperagent(x) || issyndicateagent(x) || isnukeopgunbot(x) || isnukeopai(x) || isomnitraitor(x))
