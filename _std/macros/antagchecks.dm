...
#define isgrinch(x) (istype(x, /mob/living/carbon/human) && x:mutantrace && istype(x:mutantrace, /datum/mutantrace/grinch))
#define isgrinchmind(x) (istype(x, /mob/living/carbon/human) && x:mind && (x:mind:get_antagonist(ROLE_GRINCH)))
#define issanta(x) (istype(x, /mob/living/carbon/human/santa) && x:mind)
