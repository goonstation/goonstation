...
#define SPEECH_MODIFIER_PRIORITY_ACCENTS -5
#define SPEECH_MODIFIER_PRIORITY_MUTANTRACES -10
...
//------------ Listen Inputs ------------//
#define LISTEN_INPUT_PRIORITY_VERY_HIGH 100
...
//------------ Listen Modifiers ------------//
#define LISTEN_MODIFIER_PRIORITY_PROCESS_FIRST 1000
