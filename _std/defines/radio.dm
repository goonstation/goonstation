...
#define RADIOC_CORPORATE "#bfc200"
...
#define RADIOCL_CORPORATE "rcorporate"
...
#define R_FREQ_BLACKLIST list(R_FREQ_DEFAULT, R_FREQ_CORPORATE, R_FREQ_COMMAND, R_FREQ_SECURITY, R_FREQ_DETECTIVE, R_FREQ_ENGINEERING, R_FREQ_RESEARCH, R_FREQ_MEDICAL,\
