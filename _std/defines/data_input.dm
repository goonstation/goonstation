// Types of data input we might want to pass to something. String values are displayed to the user during selection. Ordering is completely arbitrary.
#define DATA_INPUT_NUM "Number"
...
#define DATA_INPUTMOB_REFERENCE "Mob Reference"
