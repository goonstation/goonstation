...
#define OMNI_MODE_PLANTING 8
#define OMNI_MODE_SHEARING 9
#define OMNI_MODE_SPINDLING 10
#define OMNI_MODE_NEEDLING 11
#define OMNI_MODE_MOPPING 12
#define OMNI_MODE_SHAKING 13
