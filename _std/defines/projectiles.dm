...
//ammo categories
#define AMMO_SHOTGUN_SCRAP "shotgun_scrap"
#define AMMO_SHOTGUN_LOW "shotgun_low"
#define AMMO_SHOTGUN_HIGH "shotgun_high"
#define AMMO_SHOTGUN_NORMAL AMMO_SHOTGUN_LOW, AMMO_SHOTGUN_HIGH
#define AMMO_SHOTGUN_ALL AMMO_SHOTGUN_LOW, AMMO_SHOTGUN_HIGH, AMMO_SHOTGUN_SCRAP
