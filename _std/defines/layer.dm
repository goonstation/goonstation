...
#define MOB_BACK_SUIT_LAYER (MOB_OVERLAY_BASE - 0.1)	///! For capes and scarves and stuff. Technically on back, but we want to layer over everything else
#define MOB_FULL_COVERAGE_LAYER	 (MOB_OVERLAY_BASE - 0.2) ///! For things which fully cover the body, like sheets and boxes
