...
#define LIGHTING_LAYER_ROBUST (TURF_LAYER+0.01)
#define LIGHTING_LAYER_BASE (TURF_LAYER+0.02)
#define LIGHTING_LAYER_FULLBRIGHT (TURF_LAYER+0.03)
#define LIGHTING_LAYER_DARKNESS_EFFECTS (TURF_LAYER+0.04)
