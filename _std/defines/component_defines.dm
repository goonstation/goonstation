...
/// Success
#define RETURN_SUCCESS 32
/// Failure
#define RETURN_FAILURE 64
/// return early (don't complete rest of proc)
#define RETURN_EARLY 128
...
/// When the atom is mousedropped into
...
// when an AM is EMP'd
#define COMSIG_MOVABLE_EMP_ACT "mov_emp_act"
...
/// When an item is used to attack an atom
...
/// When an item is used in-hand by user
