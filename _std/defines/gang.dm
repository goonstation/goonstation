...
#define GANG_CRATE_DROP_TIME 300 SECONDS //! How long it takes for gang crates to arrive after being announced, in seconds
#define GANG_CRATE_LOCK_TIME 10 SECONDS //! How long it takes for gang crates to arrive after being announced, in seconds
