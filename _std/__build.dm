...
#define I_WANNA_BE_THE_JOB  "Nanotrasen Emergency Paramedic"  // Spawn as a 'imcoder' job. Gives CE belt, captain ID, etc. Change string to different job ID as needed
