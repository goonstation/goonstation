...
export const buildColumnConfigs = (
  ...
  },
  {
    ...
    renderContents: ({ value }) => (
      <a href={`https://tomato.goonhub.com/admin/bans/${value}`}>{value}</a>
    ),
    basis: 4,
  },
  {
    ...
    renderContents: ({ value }) => (
      <a href={`https://tomato.goonhub.com/admin/players/${value}`}>{value}</a>
    ),
  ...
  },
  {
    ...
    renderContents: ({ value }) => (
      <a
        href={`https://tomato.goonhub.com/admin/game-admins/${value.id}`}
        className="NoColor"
      >
        {value.name}
      </a>
