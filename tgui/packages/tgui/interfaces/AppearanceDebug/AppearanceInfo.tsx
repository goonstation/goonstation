      ...
      <Section title="Information">
        <LabeledList>
          ...
          <LabeledList.Item label="blend_mode">
            {Object.entries(blendToText).find(
              (x) => appearance.data.blend_mode.toString() === x[0],
            )?.[1] || 'ERROR'}
          </LabeledList.Item>
          ...
          {!!appearance.data.maptext && (
            <>
              ...
              <LabeledList.Item label="maptext_x/y">
                [{appearance.data.maptext_x}, {appearance.data.maptext_y}]
              </LabeledList.Item>
            </>
          )}
          <LabeledList.Item label="mouse_opacity">
            {Object.entries(MOUSE_OPACITY).find(
              (x) => appearance.data.mouse_opacity === x[1],
            )?.[0] || 'ERROR'}
          </LabeledList.Item>
          <LabeledList.Item label="pixel_x/y/w/z">
            [{appearance.data.pixel_x}, {appearance.data.pixel_y},{' '}
            {appearance.data.pixel_w}, {appearance.data.pixel_z}]
          </LabeledList.Item>
