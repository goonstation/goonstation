...
type ColorBlindCategoryProps = {
  category: string;
};

const ColorBlindCategory = (props: ColorBlindCategoryProps) => {
  ...
  return (
    <Section
      ...
      title={category}
      buttons={
        <Button icon="times" color="bad" onClick={() => act('clear_matrix')}>
          Clear
        </Button>
      }
    >
