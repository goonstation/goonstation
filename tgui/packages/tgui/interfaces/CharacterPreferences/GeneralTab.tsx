        ...
        <LabeledList>
          <LabeledList.Item
            ...
            buttons={
              <Button.Checkbox
                ...
                onClick={() => act("update", { randomName: 1 })}
              >
                Random
              </Button.Checkbox>
            }
          >
            <Button onClick={() => act("update", { nameFirst: 1 })}>
              {data.nameFirst}
            </Button>
            <Button onClick={() => act("update", { nameMiddle: 1 })}>
              {data.nameMiddle}
            </Button>
            <Button onClick={() => act("update", { nameLast: 1 })}>
              {data.nameLast}
            </Button>
          </LabeledList.Item>
          <LabeledList.Item label="Gender">
            <Button onClick={() => act("update", { gender: 1 })}>
              {data.gender}
            </Button>
          </LabeledList.Item>
          <LabeledList.Item label="Age">
            <Button onClick={() => act("update", { age: 1 })}>
              {data.age}
            </Button>
          </LabeledList.Item>
          ...
          <LabeledList.Item
            ...
            buttons={
              <Button.Checkbox
                checked={!data.pin}
                onClick={() => act("update", { pin: data.pin ? "random" : 1 })}
              >
                Random
              </Button.Checkbox>
            }
          ...
          <LabeledList.Item
            ...
            buttons={
              <Button
                onClick={() => act("update", { flavorText: 1 })}
                icon="wrench"
              >
                Edit
              </Button>
          ...
          <LabeledList.Item
            ...
            buttons={
              <Button
                onClick={() => act("update", { securityNote: 1 })}
                icon="wrench"
              >
                Edit
              </Button>
          ...
          <LabeledList.Item
            ...
            buttons={
              <Button
                onClick={() => act("update", { medicalNote: 1 })}
                icon="wrench"
              >
                Edit
              </Button>
      ...
      <Section title="PDA">
        <LabeledList>
          <LabeledList.Item label="Ringtone">
            <Button onClick={() => act("update", { pdaRingtone: 1 })}>
              {data.pdaRingtone}
            </Button>
            <Button
