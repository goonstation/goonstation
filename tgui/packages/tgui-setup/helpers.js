...
(function () {
  ...
  Byond.BYOND_MAJOR = parseMetaTag('tgui:byondMajor'); // |GOONSTATION-ADD|
  Byond.BYOND_MINOR = parseMetaTag('tgui:byondMinor'); // |GOONSTATION-ADD|
  ...
  var loadAsset = function (options) {
    ...
    if (type === 'css') {
      ...
      node.onload = function () {
        ...
        // 515: Legacy IE doesn't use onerror so we reload here instead
        removeNodeAndRetry();
      };
      injectNode(node);
      return;
