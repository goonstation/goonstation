...
(function () {
	...
	var emailChecker = function emailChecker(str) {
	...
	var ipChecker = function ipChecker(str) {
  ...
  **/
	...
	var urlChecker = function urlChecker(str) {
		// basic validations
	...
	var identify = function identify(inputArr, options) {
	...
	var transform = function transform(str, options) {
